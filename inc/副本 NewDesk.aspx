<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 NewDesk.aspx.cs" Inherits="NewDesk"
    Title="" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <div id="vtbusy_homeinfo" style="display: none;">
        <img src="../themes/softed/images/vtbusy.gif" border="0"></div>
    <div>
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" width="10%" class="moduleName"
                    nowrap>
                    工作台&gt; <a class="hdrLink" href="NewDesk.aspx">工作台</a>
                </td>
                <td width="40%" nowrap>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-right: 5px">
                                            <div id="vtbusy_info" style="display: none;">
                                                <img src="../themes/softed/images/status.gif" border="0"></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr>
                <td width="100%" align="center" valign="top" height="300">
                    <div id="MainMatrix" style="padding: 5px; width: 100%;">
                        <div id="weekreport" class="portlet" runat="server" style="overflow-y: auto;
                            overflow-x: hidden; height=280px; width: 98%; float: left; position: relative;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                                ...
                                <tr id="Tr4">
                                    <td>
                                        <div id="Div5" style="overflow-y: auto; overflow-x: hidden;
                    ...
                    <div id="Div1" style="padding: 5px; width: 100%;">
                        <div id="CgMonth" class="portlet" runat="server" style="overflow-y: auto;
                            overflow-x: hidden; height=280px; width: 98%; float: left; position: relative;">
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="Tr1">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                                ...
                                <tr id="Tr2">
                                    <td>
                                        <div id="Div3" style="overflow-y: auto; overflow-x: hidden;
                                            width: 100%; height: 100%; cursor: auto;">
                          ...
                          <div id="stuff_SalesMonthTotal1" runat="server" style="overflow-y: auto;
                            overflow-x: hidden;  height=500px; width: 98%;  float: left; position: relative;">
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper" 
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="headerrow_SalesMonthTotal1">
                                    <td align="left" style="height: 20px;" nowrap width="60%">
                                        <b>&nbsp;重点客户月销售排名</b>
                                    </td>
                                    <td align="right" style="height: 20px;" width="5%">
                                        <span id="refresh_SalesMonthTotal1" style="position: relative;">&nbsp;&nbsp;</span>
                                    </td>
                                    <td align="right" style="height: 20px;" width="35%" nowrap>
                                        <input type="hidden" id="portlet_stuffid_SalesMonthTotal1" value="1" />
                                        <input type="hidden" id="portlet_stufftype_SalesMonthTotal1" value="SalesYearTotal" />
                                        <input type="hidden" id="Hidden13" value="SalesMonthTotal1" class="portlet_stufftype_value" />
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="maincont_row_SalesMonthTotal1">
                                    <td>
                                        <div id="stuffcont_SalesMonthTotal1" style="overflow-y: auto; overflow-x: hidden;
                                            width: 100%; height: 100%; cursor: auto;">
                                            <cc1:Chartlet ID="Chat_SalesMonthTotal1" runat="server" AppearanceStyle="Bar_3D_Breeze_NoCrystal_NoGlow_NoBorder"
                                                ChartType="Histogram" Colorful="False" Dimension="Chart2D" GroupSize="10" AutoBarWidth="True"
                        ...
                        <div id="stuff_Account" class="portlet" runat="server" style="overflow-y: auto;
                        overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                            <tr id="Tr5">
                                <td align="left" style="height: 20px;" nowrap width="60%">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                            ...
                            <tr id="maincont_row_Account">
                                <td>
                                    <div id="stuffcont_Account" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                        ...
                        <div id="stuff_Receive" class="portlet" runat="server" style="overflow-y: auto;
                        overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                            <tr id="Tr8">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                            ...
                            <tr id="maincont_row_Receive">
                                <td>
                                    <div id="stuffcont_Receive" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                                        height: 100%; cursor: auto;">
                        ...
                        <div id="stuff_Report" class="portlet" runat="server" style="overflow-y: auto;
                        overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                            ...
                            <tr id="maincont_row_Report">
                                <td>
                                    <div id="stuffcont_Report" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                                        height: 100%; cursor: auto;">
                        ...
                        <div id="stuff_SalesYearTotal1" class="portlet" runat="server" style="overflow-y: auto;
                            overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="headerrow_SalesYearTotal1">
                                    <td align="left" style="height: 20px;" nowrap width="60%">
                                        <b>&nbsp;年客户销售排名</b>
                                    </td>
                                    <td align="right" style="height: 20px;" width="5%">
                                        <span id="refresh_SalesYearTotal1" style="position: relative;">&nbsp;&nbsp;</span>
                                    </td>
                                    <td align="right" style="height: 20px;" width="35%" nowrap>
                                        <input type="hidden" id="portlet_stuffid_SalesYearTotal1" value="1" />
                                        <input type="hidden" id="portlet_stufftype_SalesYearTotal1" value="SalesYearTotal" />
                                        <input type="hidden" id="portlet_stufftype_value" value="SalesYearTotal1" class="portlet_stufftype_value" />
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="maincont_row_SalesYearTotal1">
                                    <td>
                                        <div id="stuffcont_SalesYearTotal1" style="overflow-y: auto; overflow-x: hidden;
                                            width: 100%; height: 100%; cursor: auto;">
                        ...
                        <div id="stuff_OrderOEM1" runat="server" class="portlet" style="overflow-y: auto;
                            overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="headerrow_OrderOEM1">
                                    <td align="left" style="height: 20px;" nowrap width="60%">
                                        <b>&nbsp;年加工厂采购金额排行</b>
                                    </td>
                                    <td align="right" style="height: 20px;" width="5%">
                                        <span id="refresh_OrderOEM1" style="position: relative;">&nbsp;&nbsp;</span>
                                    </td>
                                    <td align="right" style="height: 20px;" width="35%" nowrap>
                                        <input type="hidden" id="portlet_stuffid_OrderOEM1" value="1" />
                                        <input type="hidden" id="portlet_stufftype_OrderOEM1" value="OrderOEM" />
                                        <input type="hidden" id="portlet_stufftype_value" value="OrderOEM1" class="portlet_stufftype_value" />
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                                style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                                <tr id="maincont_row_OrderOEM1">
                                    <td>
                                        <div id="stuffcont_OrderOEM1" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                                            height: 100%; cursor: auto;">
                            ...
                            <script language="javascript">
                                window.onresize = function () { positionDivInAccord('stuff_OrderOEM1', '32%'); };
                                positionDivInAccord('stuff_OrderOEM1', '32%');
                            </script>
                        </div>
                    <div id="stuff_OrderOther1" class="portlet" runat="server" style="overflow-y: auto;
                        overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                            <tr id="headerrow_OrderOther1">
                                ...
                                <td align="right" style="height: 20px;" width="35%" nowrap>
                                    ...
                                    <input type="hidden" id="Hidden1" value="OrderOther1" class="portlet_stufftype_value" />
                                </td>
                            </tr>
                        </table>
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                            ...
                            <tr id="maincont_row_OrderOther1">
                                <td>
                                    <div id="stuffcont_OrderOther1" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                                        height: 100%; cursor: auto;">
                                        <cc1:Chartlet ID="OrderOther" runat="server" AppearanceStyle="Bar_3D_Breeze_NoCrystal_NoGlow_NoBorder"
                                            ChartType="Histogram" Colorful="False" Dimension="Chart2D" GroupSize="2" AutoBarWidth="True"
                                            Width="500px" Alpha3D="170" Height="500px"></cc1:Chartlet>
                                    </div>
                                </td>
                        ...
                        <script language="javascript">
                            window.onresize = function () { positionDivInAccord('stuff_OrderOther1', '32%'); };
                            positionDivInAccord('stuff_OrderOther1', '32%');
                        </script>
                    </div>
                    <div id="stuff_SalesOpp1" class="portlet" runat="server" style="overflow-y: auto;
                        overflow-x: hidden; height=280px; width: 32%; float: left; position: relative;">
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_topper"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                            <tr id="headerrow_SalesOpp1">
                                <td align="left" style="height: 20px;" nowrap width="60%">
                                    <b>&nbsp;各销售阶段销售机会数量</b>
                                </td>
                                <td align="right" style="height: 20px;" width="5%">
                                    <span id="refresh_SalesOpp1" style="position: relative;">&nbsp;&nbsp;</span>
                                </td>
                                <td align="right" style="height: 20px;" width="35%" nowrap>
                                    <input type="hidden" id="portlet_stuffid_SalesOpp1" value="1" />
                                    <input type="hidden" id="portlet_stufftype_SalesOpp1" value="SalesOpp" />
                                    <input type="hidden" id="Hidden2" value="SalesOpp1" class="portlet_stufftype_value" />
                                </td>
                            </tr>
                        </table>
                        <table width="100%" cellpadding="0" cellspacing="0" class="small portlet_content"
                            style="padding-right: 0px; padding-left: 0px; padding-top: 0px;">
                            <tr id="maincont_row_SalesOpp1">
                                <td>
                                    <div id="stuffcont_SalesOpp1" style="overflow-y: auto; overflow-x: hidden; width: 100%;
                                        height: 100%; cursor: auto;">
                                        <cc1:Chartlet ID="SalesOpp" runat="server" AppearanceStyle="Bar_3D_Breeze_NoCrystal_NoGlow_NoBorder"
                                            ChartType="Histogram" Colorful="False" Dimension="Chart2D" GroupSize="2" AutoBarWidth="True"
                                            Width="500px" Alpha3D="170" Height="500px"></cc1:Chartlet>
                                    </div>
                                </td>
                        ...
                        <script language="javascript">
                            window.onresize = function () { positionDivInAccord('stuff_SalesOpp1', '32%'); };
                            positionDivInAccord('stuff_SalesOpp1', '32%');
                        </script>
                    </div>
                    </div>
                </td>
