<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Products_MakeMoney.aspx.cs"
    Inherits="Web_Report_Bill_List_Products_MakeMoney" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link rel="stylesheet" href="../../../themes/softed/style.css" type="text/css">
    <title>成品入库制造费用</title>
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "成品入库制造费用单");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("成品入库制造费用单.xls");
	};
    </script>
