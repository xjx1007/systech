<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_DbWw_Details.aspx.cs" Inherits="Report_Ww_Details" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'Procure_DbWw_Details_View.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
            s_URL += '&Type=' + Type + '';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>单据 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">委外加工调拨发料明细</a>
                </td>
