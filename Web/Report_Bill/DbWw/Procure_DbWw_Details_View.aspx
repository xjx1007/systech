<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_DbWw_Details_View.aspx.cs"
    Inherits="Procure_DbWw_Details_View" %>
...
.Custom_Hidden
{
	...
	function CreateOneFormPage(){
		...
		LODOP.PRINT_INIT("原材料委外加工调拨发料明细");
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "原材料委外加工调拨发料明细");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("原材料委外加工调拨发料明细.xls");
	};	       
    </script>
