...
public partial class Web_Report_Xs_List_CkList : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            string s_HouseNo1 = Request.QueryString["HouseNo"] == null ? "" : Request.QueryString["HouseNo"].ToString();
            ...
            s_Details += "<td align=right class='thstyleLeftDetails' colspan=6 noWrap>&nbsp;</td>\n";//单价
            s_Details += " </tr>";
