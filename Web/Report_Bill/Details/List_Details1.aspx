<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Details1.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "期末金额调整");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("期末金额调整.xls");
        };
    </script>
...
<body>
    ...
    <div>
        ...
        <input type="button" value="导出Excel" onclick="javascript: OutToFileMoreSheet()" id="Button2" />
                                            ...
                                            <asp:Button ID="Button3" runat="server" Text="删 除" AccessKey="X" title="删除 [Alt+X]" style="width: 55px;height: 33px;"
                                                class="crmbutton small cancel" OnClick="Button3_Click"  />
    ...
    <asp:TextBox  runat="server" ID="Tbx_StartDate" CssClass="Custom_Hidden"></asp:TextBox>
    <asp:TextBox  runat="server" ID="Tbx_EndDate" CssClass="Custom_Hidden"></asp:TextBox>
    </form>
</body>
</html>
