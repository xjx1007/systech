<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Products_ElseMateMoney.aspx.cs" Inherits="Web_Report_Bill_List_Products_ElseMateMoney" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
	    ...
	    var s_Body = document.getElementById("tableContainer").innerHTML.replace("fixedHeader", "''");
	    var strFormHtml = "<body>" + s_Body + "</body>" + strBodyStyle;
	...
	function OutToFileMoreSheet() {
	    var s_Body = document.getElementById("tableContainer").innerHTML.replace("fixedHeader", "");
	    var strBodyStyle = "<style>" + document.getElementById("style1").innerHTML + "</style>";
	    var strFormHtml = strBodyStyle + "<body>" + s_Body + "</body>";
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "成品入库其他材料费用");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("成品入库其他材料费用.xls");
	};
    </script>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Btn_Save" runat="server" Text="导出Excel" AccessKey="S" title="导出Excel"
                class="crmbutton small save" OnClick="Btn_Save_OnClick" />
