<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_Xh_Details_View.aspx.cs"
    Inherits="Web_Procure_Xh_View" %>

<html xmlns="http://Xhw.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>原材料委外加工耗料明细</title>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "原材料委外加工耗料明细");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("原材料委外加工耗料明细.xls");		
	};	       
    </script>
