...
public partial class List_CkList2 : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            s_Sql += " b.DirectOutAmount*b.KWD_SalesUnitPrice ,a.DirectOutStaffNo,a.DirectOutCheckStaffNo,b.ProductsBarCode,b.ID,isnull(b.DirectOutAmount,0) KWD_BNumber,KWD_PrintNums,isnull(KWD_WwPrice,0) KWD_WwPrice,isnull(KWD_WwMoney,0) KWD_WwMoney,a.DirectOutRemarks,KWD_Project,d.KSP_Code,KWD_LyType from KNet_WareHouse_DirectOutList a ";
            ...
            s_Head += "<tr>\n<th colspan=\"16\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>成品领料明细</th></tr>\n";
            ...
            s_Details += " <tr >\n";
            s_Details += "<td  class='thstyleLeftDetails' align=left noWrap colspan=10>合计:" + (Dtb_Table.Rows.Count).ToString() + "</td>\n";
    ...
    protected void Btn_SaveOnClick(object sender, EventArgs e)
    {
        ...
        Excel.HtmlToExcel(this.Lbl_Details.Text, "成品领料");
    }
}
