...
public partial class Web_Report_Bill_List_Products_HandMoney : BasePage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Dtb_Table.Rows.Count > 0)
            {
                for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                {
                    ...
                    s_Details += "<td  class='thstyleLeftDetails'align=center noWrap>" + Dtb_Table.Rows[i]["SER_ScManPrice"].ToString() + "</td>\n";


                    //s_Details += "<td class='thstyleLeftDetails' align=center noWrap>&nbsp;</td>\n";

                    s_Details += "<td  class='thstyleLeftDetails' align=right  noWrap>" + Dtb_Table.Rows[i]["SER_ScManMoney"].ToString() + "</td>\n";
            ...
            s_Head += "<tr>\n<th colspan=\"12\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>生产入库人工费用</th></tr>\n";
            ...
            s_Head += "<th class=\"thstyle\"  align=center >单位人工费用</th>\n";

            s_Head += "<th class=\"thstyle\" align=center >总人工费用</th>\n";
