    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (s_Type == "1")
            {
                ...
                if (s_HouseNo != "")
                {
                    s_Sql1 += " and  SED_HouseNo='" + s_HouseNo + "'";
                }
                if (s_ProductsBarCode != "")
                {
                    s_Sql1 += " and  SED_ProductsBarCode='" + s_ProductsBarCode + "'";
                }
            ...
            else
            {
                ...
                if (s_HouseNo != "")
                {
                    s_Sql += " and  SED_HouseNo='" + s_HouseNo + "'";
                }
                if (s_ProductsBarCode != "")
                {
                    s_Sql += " and  SED_ProductsBarCode='" + s_ProductsBarCode + "'";
                }
                if (s_ProductsEdition != "")
                {
                    s_Sql += " and  SED_ProductsBarCode in (Select ProductsBarCode From KNet_Sys_Products where ProductsEdition like '%" + s_ProductsEdition + "%')";
