<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_CkList2.aspx.cs" Inherits="List_CkList2" %>
...
.Custom_Hidden
{
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "生产领料明细");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("生产领料明细.xls");
        };
        function Print(ID, Num) {
            ...
            var temp = window.showModalDialog("/Web/SalesOut/Sales_ShipWareOut_Print_Cw.aspx?ID=" + ID + "&Num=" + Num + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
        ...
        function prrintALL() {
            ...
            for (var i = 0; i < s_ID.length; i++) {
                ...
                var temp = window.showModalDialog("/Web/SalesOut/Sales_ShipWareOut_Print_Cw.aspx?ID=" + s_ID[i] + "&Num=" + Num + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
            }
            window.location.reload();
        }
    </script>
...
<body>
    ...
    <div>
                                    <asp:Button ID="Button2" runat="server" Text="打印预览" AccessKey="S" title="导出Excel"
                                        class="crmbutton small create"  OnClientClick="javascript:prn1_preview()"  />
                                    <asp:Button ID="Btn_Save" runat="server" Text="导出Excel" AccessKey="S" title="导出Excel"
