<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_CustomerPayTime.aspx.cs"
    Inherits="Web_List_CustomerPayTime" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "客户帐期统计");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("客户帐期统计.xls");		
	};	       
    </script>
