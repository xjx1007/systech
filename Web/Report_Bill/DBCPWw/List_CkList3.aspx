<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_CkList3.aspx.cs" Inherits="List_CkList3" %>
...
.Custom_Hidden
{
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "成品委外明细");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("成品委外明细.xls");
        };
...
<body>
    ...
    <div>
        ...
        <input type="button" value="打印全部" onclick="javascript:prrintALL()" id="Button3" Style="width: 70px; height: 30px;" />
