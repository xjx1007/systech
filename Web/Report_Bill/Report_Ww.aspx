<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Ww.aspx.cs" Inherits="Web_Report_Ww" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                委外加工发料单 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">委外加工发料单</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="16%" align="right" class="dvtCellLabel">
                                                        ...
                                                        <td align="left" class="dvtCellInfo">
                                                           <asp:DropDownList ID="HouseNo" runat="server"></asp:DropDownList>(<font
                                                                    color="red">*</font>)<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                                                        ErrorMessage="仓库非空" ControlToValidate="HouseNo" Display="Dynamic"></asp:RequiredFieldValidator>
                                                           </td> 
