...
public partial class Procure_Ww_Details_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (s_Type == "0")//明细
            {
                s_Sql = "Select b.COD_ProductsBarCode,a.COC_SuppNo,d.WareHouseDateTime,b.COD_Dznumber,b.COD_Details,d.HouseNo,b.COD_wuliu,";
            ...
            {
                s_Sql += "Group by  b.COD_ProductsBarCode,a.COC_SuppNo,d.HouseNo Order by d.HouseNo,b.COD_ProductsBarCode ";
            ...
            s_Head += "<tr>\n<th colspan=\"9\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>原材料委外加工发料明细</th></tr>\n";
            s_Head += "<tr>\n<th colspan=\"4\" class=\"thstyleleft\"  >" + s_HouseNo + "</th><th colspan=\"5\" class=\"thstyleRight\" >" + s_Time + "</th></tr>\n";
            ...
            else
            {
                s_Head += "<div class=\"tableContainer\" id=\"tableContainer\" >\n";
                s_Head += "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"scrollTable\">\n<thead class=\"fixedHeader\"> \n";
                s_Head += "<tr>\n<th colspan=\"7\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>原材料委外加工发料汇总</th></tr>\n";
                s_Head += "<tr>\n<th colspan=\"4\" class=\"thstyleleft\"  ></th><th colspan=\"3\" class=\"thstyleRight\" >" + s_Time + "</th></tr>\n";
                s_Head += "<th class=\"thstyle\" >项次</th>\n";
                s_Head += "<th class=\"thstyle\" align=center>供应商</th>\n";
                s_Head += "<th class=\"thstyle\" align=center>委外厂商</th>\n";
                s_Head += "<th class=\"thstyle\" align=center>品名</th>\n";
