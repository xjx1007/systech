<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_RC.aspx.cs" Inherits="Web_Report_RC" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'Procure_Rc_View.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>成品入库单 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">成品入库单</a>
                </td>
