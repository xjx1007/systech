<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_CostsMoney.aspx.cs" Inherits="Web_Report_Bill_Product_CostsMoney" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'List_Products_CostsMoney.aspx?';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>生产入库成本费用报表 > <a class="hdrLink" href="Product_CostsMoney.aspx">生产入库成本费用报表</a>
                </td>
