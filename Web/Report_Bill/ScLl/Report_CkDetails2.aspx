<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_CkDetails2.aspx.cs"
    Inherits="Web_Report_Xs_Report_CkDetails2" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'List_CkList2.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
            s_URL += '&State=' + State + '';
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                    单据报表 > <a class="hdrLink" href="Report_CkDetails2.aspx">原材料领料明细</a>
                </td>
                <td width="100%" nowrap>
                </td>
            </tr>
