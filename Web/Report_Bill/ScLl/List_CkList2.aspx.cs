...
public partial class List_CkList2 : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if(!IsPostBack)
        {
            ...
            s_Sql += " b.DirectOutAmount*b.KWD_SalesUnitPrice ,a.DirectOutStaffNo,a.DirectOutCheckStaffNo,b.ProductsBarCode,b.ID,isnull(b.DirectOutAmount,0) KWD_BNumber,KWD_PrintNums from KNet_WareHouse_DirectOutList a ";
            ...
            s_Head += "<tr>\n<th colspan=\"13\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>原材料领料明细</th></tr>\n";
