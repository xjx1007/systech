<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Products_CostsMoney.aspx.cs" Inherits="Web_Report_Bill_List_Products_CostsMoney" %>
...
<head id="Head1" runat="server">
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "成品入库成本费用单");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("成品入库成本费用单.xls");
	};
    </script>
