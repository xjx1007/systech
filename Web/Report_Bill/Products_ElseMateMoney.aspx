<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Products_ElseMateMoney.aspx.cs" Inherits="Web_Report_Bill_Products_ElseMateMoney" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'List_Products_MakeMoney.aspx?';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>其他材料费用报表 > <a class="hdrLink" href="Products_ElseMateMoney.aspx">其他材料费用报表</a>
                </td>
