...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                //如果是汇总
                string s_Sql1 = " select Count(*) as Row1,SER_ProductsBarCode,SED_HouseNo from (Select a.SED_HouseNo,a.SED_ProductsBarCode,Sum(a.SED_RkNumber) as SED_RkNumber,a.SED_FromHouseNo,d.SER_ProductsBarCode";
                s_Sql1 += " from Sc_Expend_Manage_MaterDetails  a join Sc_Expend_Manage b on a.SED_SEMID=b.SEM_ID ";
                s_Sql1 += " join Knet_Sys_Products c on c.ProductsBarCode=a.SED_ProductsBarCode ";
                s_Sql1 += " join Sc_Expend_Manage_RCDetails d on d.SER_SEMID=b.SEM_ID ";

                s_Sql1 += " join Xs_Products_Prodocts f on f.XPP_FaterBarCode=d.SER_ProductsBarCode and f.XPP_ProductsBarCode=a.SED_ProductsBarCode";
                s_Sql1 += "  Where SED_Type='5' ";
                if (s_StartDate != "")
                {
                ...
                s_Sql1 += " Group by a.SED_HouseNo,a.SED_ProductsBarCode,a.SED_FromHouseNo,c.ProductsName,d.SER_ProductsBarCode) aa ";
                ...
                {
                    s_Sql = "Select a.SED_HouseNo,a.SED_ProductsBarCode,Sum(a.SED_RkNumber) as SED_RkNumber,a.SED_FromHouseNo,d.SER_ProductsBarCode";
                    s_Sql += " from Sc_Expend_Manage_MaterDetails  a join Sc_Expend_Manage b on a.SED_SEMID=b.SEM_ID ";
                    s_Sql += " join Knet_Sys_Products c on c.ProductsBarCode=a.SED_ProductsBarCode ";
                    s_Sql += " join Sc_Expend_Manage_RCDetails d on d.SER_SEMID=b.SEM_ID   ";

                    s_Sql += " join Xs_Products_Prodocts f on f.XPP_FaterBarCode=d.SER_ProductsBarCode and f.XPP_ProductsBarCode=a.SED_ProductsBarCode";

                    s_Sql += "  Where SED_Type='5' and XPP_Number*SER_SCNumber=SED_RkNumber ";
                    ...
                    {
                        s_Sql += " and  d.SER_ProductsBarCode='" + s_FProductsBarCode + "'";
                    }
                    if (s_ProductsEdition != "")
                    {
                    ...
                    s_Sql += " Group by a.SED_HouseNo,a.SED_ProductsBarCode,a.SED_FromHouseNo,c.ProductsName,d.SER_ProductsBarCode  ";
                    s_Sql += " Order by d.SER_ProductsBarCode,c.ProductsName";
                    ...
                    for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                    {
                        ...
                        s_Details += "<td  class='thstyleLeftDetails' align=right  noWrap>&nbsp;" + base.FormatNumber(Dtb_Table.Rows[i]["SED_RkNumber"].ToString(), 0) + "</td>\n";
                        if (i == 0)
                        {
            ...
            {
                //明细
                s_Sql = "Select a.SED_HouseNo,a.SED_RkTime,a.SED_ProductsBarCode,a.SED_RkNumber,a.SED_Remarks,a.SED_FromHouseNo";
                s_Sql += " ";
                s_Sql += " from Sc_Expend_Manage_MaterDetails  a join Sc_Expend_Manage b on a.SED_SEMID=b.SEM_ID ";
            ...
            s_Head += "<tr>\n<th colspan=\"7\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>原材料委外加工耗料单</th></tr>\n";
