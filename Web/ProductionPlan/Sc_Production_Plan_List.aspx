<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sc_Production_Plan_List.aspx.cs" Inherits="Web_Sales_Sc_Production_Plan_List" %>
...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>生产计划 >
	<a class="hdrLink" href="Sc_Production_Plan_List.aspx">生产计划</a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Sc_Production_Plan_Add.aspx')"><img src="../../themes/softed/images/btnL3Add.gif" alt="创建 生产计划..." title="创建 生产计划..." border=0></a></td>
				...
				<td style="padding-right:10px"><a href="javascript:;" onClick="ShowDiv()" ><img src="../../themes/softed/images/btnL3Search.gif" alt="查找 生产计划..." title="查找 生产计划..." border=0></a></td>
				<td style="padding-right:0px;padding-left:10px;"><img src="../../themes/softed/images/tbarImport.gif" alt="*导入 生产计划" title="*导入 生产计划" border="0"></td>	
				<td style="padding-right:10px"><img src="../../themes/softed/images/tbarExport.gif" alt="*导出 生产计划" title="*导出 生产计划" border="0"></td>
				</tr>
				</table>
			</td>
			</tr>
...
<tr>
 <td>
    <%=base.Base_BindView("Sc_Production_Plan", "Sc_Production_Plan_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
</td>
</tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("Sc_Production_Plan")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
...
<Columns>
        ...
        <asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="生产计划编号"  SortExpression="XSQ_Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <a href="Sc_Production_Plan_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSQ_ID") %>"><%# DataBinder.Eval(Container.DataItem, "XSQ_Code").ToString()%></a>
               
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="生产计划阶段"  SortExpression="XSQ_Step" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
      ...
      <asp:TemplateField HeaderText="负责人"  SortExpression="XSQ_DutyPerson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Sc_Production_Plan_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSQ_ID") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="../../images/Edit.gif" border=0  ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
</Columns>
