                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('Sc_Production_Plan_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 生产计划..." title="创建 生产计划..." border="0"></a></td>
                                                    ...
                                                    <td style="padding-right: 10px"><a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 生产计划..." title="查找 生产计划..." border="0"></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 生产计划" title="*导入 生产计划" border="0"></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 生产计划" title="*导出 生产计划" border="0"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Sc_Production_Plan_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSQ_ID") %>">
