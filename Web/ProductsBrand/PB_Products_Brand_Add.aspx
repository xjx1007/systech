        ...
        function SetReturnValueInOpenner_ProductsDemo1(tempd) {
            if (tempd != undefined) {
                ...
                for (var i = 0; i < ss.length - 1; i++) {
                    ...
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '&nbsp;<input type=input Name=\"ProductsBarCode_' + v_newNum + '\" style=\"display:none;\" value=' + s_Value[0] + ' ><A onclick=\"deleteRow2(this)\" href=\"#\"><img src="/themes/softed/images/delete.gif" alt="CRMone" title="CRMone" border=0></a>';
                    objCel.className = "ListHeadDetails";
