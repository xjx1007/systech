...
/// 库存管理-----直接出库单 管理
/// </summary>
public partial class Knet_Web_WareHouse_KNet_WareHouse_DirectOut_Manage : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            base.Base_DropBindSearch(this.bas_searchfield, "KNet_WareHouse_DirectOut");
            base.Base_DropBindSearch(this.Fields, "KNet_WareHouse_DirectOut");
            this.DataShows();
            this.RowOverYN();
        }
    ...
    protected void DataShows()
    {
        ...
        string SqlWhere = " 1=1  and DirectOutDateTime>='2014-01-01' ";
    ...
    protected void GridView1_DataRowBinding(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            KNet.Model.KNet_WareHouse_DirectOutList Model = Bll.GetModelB(DirectInNo);
