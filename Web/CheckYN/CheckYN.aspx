<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckYN.aspx.cs" Inherits="Knet_CheckYN" %>
                        ...
                        <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                            <tr>
                                <td class="dvtTabCache" style="width: 10px" nowrap>&nbsp;
                                    ...
                                    <asp:TextBox runat="server" ID="Tbx_State" CssClass="Custom_Hidden"></asp:TextBox>
                                    <asp:TextBox runat="server" ID="Tbx_Type" CssClass="Custom_Hidden"></asp:TextBox>
                                </td>
                                <td class="dvtSelectedCell" align="center" nowrap>基本信息
                                </td>
