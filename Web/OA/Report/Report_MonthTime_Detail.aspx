<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_MonthTime_Detail.aspx.cs" Inherits="Web_OA_Report_Report_MonthTime_Detail" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'Report_Month_View.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
            s_URL += '&Preson=' + Preson + '';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>月报报表 > <a class="hdrLink" href="Report_MonthTime_Detail.aspx">月报考勤报表</a>
                </td>
