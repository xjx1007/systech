...
public partial class Report_Today_View : BasePage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Dts_Table.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
                {
                    ...
                    s_Details += " <tr>";
                    s_Details += "<td  class='thstyleLeftDetails' align=center noWrap>&nbsp;" + Dts_Table.Tables[0].Rows[i]["StaffName"].ToString() + "</td>\n";//money
            ...
            s_Head += "<tr>\n<th colspan=\"" + i_Weeks + 1 + "\" class=\"MaterTitle\"  style='height:14.25pt'>杭州士腾科技有限公司<br/>周报  " + DateTime.Parse(StartTime).Year + "年度状态</th></tr>\n";
            s_Head += "<tr>\n<th colspan=\"" + i_Weeks + 1 + "\" class=\"MaterTitle\"  style='height:14.25pt'>状态说明：空白：未交周报;+N:N天后上交报告;√:当日交报告</th></tr>\n";
            s_Head += "<tr><th class=\"thstyle\"  align=center rowspan=2 nowrap>姓名</th>\n";
    ...
    protected void Button2_OnServerClick(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("周报-月度状态.xls", System.Text.Encoding.UTF8).ToString());
