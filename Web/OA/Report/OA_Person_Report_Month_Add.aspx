<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="OA_Person_Report_Month_Add.aspx.cs"
    Inherits="OA_Person_Report_Month_Add" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function AddDetails(aa, cc) {
            ...
            v_Htm = "<a href=\"#\" onclick=\"AddDetails(this," + cc + ")\">添加</a>&nbsp;&nbsp;";
            v_Htm += "<input type=\"hidden\" name=\"Tbx_FID_" + v_DNum + "\"  Id=\"Tbx_FID_" + v_DNum + "\"  value=" + cc + "  style=\"width: 20px\">&nbsp;<textarea  name=\"Tbx_ProjectDetails_" + v_DNum + "\" id=\"Tbx_ProjectDetails_" + v_DNum + "\"   rows=\"5\" style=\"width: 70%\" warp=\"virtual\" >" + parseInt(i_row + 1) + ".</textarea>";
            objCel.innerHTML = v_Htm;
            objCel.className = "ListHeadDetails";
            objCel.style.width = "33%";
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="OA_Person_Report_List.aspx">月报</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>月报
                                            </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvtContentSpace">
                                                ...
                                                <table class="ListDetails" id="This_Project" width="100%">
                                                    ...
                                                    <tr runat="server" id="Tr_ThisReport">
                                                        ...
                                                        <td class="ListHeadDetails" width="25%" nowrap>
                                                           ...
                                                           <%-- <input type="text" name="Tbx_Project_0" id="Tbx_Project_0" runat="server" style="width: 70%;height: 70px" value="1." />--%>
                                                            <textarea name="Tbx_Project_0" id="Tbx_Project_0" runat="server"  rows="5" style="width: 80%" warp="virtual" >1.</textarea>
                                                        </td>
                                                                ...
                                                                <tr>
                                                                    <td class="ListHeadDetails" width="24%">
                                                                        ...
                                                                        <input type="hidden" name="Tbx_FID_0" id="Tbx_FID_0" value="1">
                                                                         <textarea name="Tbx_ProjectDetails_0" id="Tbx_ProjectDetails_0" runat="server"  rows="5" style="width: 80%" warp="virtual" >1.</textarea>
                                                                    ...
                                                                    <td class="ListHeadDetails" width="24%">
                                                                        <input type="text" name="Tbx_Time_0" id="Tbx_Time_0" runat="server" onFocus="WdatePicker()" style="width: 80%" value="" />
                                                ...
                                                <table class="ListDetails" id="Table1" width="100%">
                                                    ...
                                                    <tr runat="server" id="Tr_NextReport">
                                                        ...
                                                        <td class="ListHeadDetails" width="25%" nowrap>
                                                            ...
                                                            <textarea name="Tbx_Project1_0" id="Tbx_Project1_0" runat="server"  rows="5" style="width: 80%" warp="virtual" >1.</textarea>
                                                           <%-- <input type="text" name="Tbx_Project1_0" id="Tbx_Project1_0" runat="server" style="width: 70%;height: 70px" value="1." />--%>
                                                        </td>
                                                        <td class="ListHeadDetails" colspan="3" width="72%" nowrap>
                                                            <table width="100%" class="ListDetails">
                                                                <tr>
                                                                    <td class="ListHeadDetails" width="24%">
                                                                        ...
                                                                        <textarea name="Tbx_ProjectDetails1_0" id="Tbx_ProjectDetails1_0" runat="server"  rows="5" style="width: 80%" warp="virtual" >1.</textarea>
                                                                    ...
                                                                    <td class="ListHeadDetails" width="24%">
                                                                        <input type="text" name="Tbx_Time1_0" id="Tbx_Time1_0" runat="server" onFocus="WdatePicker()" style="width: 80%" value="" />
                                                                        <a onclick="deleteRow(this)" href="#">
                                                                            <img src="../../../themes/softed/images/delete.gif" border="0"></a>
                                                                    </td>
                                       ...
                                       <%-- <tr>
                                            <td colspan="4">
                                                <uc2:CommentList ID="CommentList2" runat="server" CommentFID="0" CommentType="MonthFile" />
                                            </td>
                                        </tr>--%>
                                        <tr>
                                            <td colspan="8" class="detailedViewHeader">
