...
public partial class Web_OA_Report_SelectDeptPerson : BasePage
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string Phone = "";
        string aa = Request.QueryString["aa"] == null ? "" : Request.QueryString["aa"].ToString();
