<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectDeptPerson.aspx.cs" Inherits="Web_OA_Report_SelectDeptPerson" %>
                    ...
                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                        <tr>
                            ...
                            <td class="dvtTabCache" align="right" style="width: 100%">&nbsp;
                                            <asp:Button ID="Button2" runat="server" CssClass="crmbutton small save" Text="确定选择" OnClick="Button1_Click" Style="width: 80px; height: 30px;" />
                                <input name="button2" type="button" value="关闭窗口" class="crmbutton small cancel" onclick="closeWindow();" style="width: 80px; height: 30px;">
                            </td>
                        </tr>
                    </table>
                </td>
