<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Today_View.aspx.cs"
    Inherits="Report_Today_View" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "日报-月度状态");
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("日报-月度状态.xls");
	};	       
    </script>
