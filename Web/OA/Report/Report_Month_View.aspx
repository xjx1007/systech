<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Month_View.aspx.cs"
    Inherits="Report_Month_View" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "月报-年度状态");
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("月报-年度状态.xls");
	};	       
    </script>
