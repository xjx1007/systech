<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_DayTime_Detail.aspx.cs" Inherits="Web_OA_Report_Report_DayTime_Detail" %>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            if (StartDate == "" || EndDate == "") {
                ...
                var s_URL = 'Report_Today_View.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
                s_URL += '&Preson=' + Preson + '';
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>日报报表 > <a class="hdrLink" href="Report_DayTime_Detail.aspx">日报考勤报表</a>
                </td>
                            ...
                            <tr>
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">                               
                                        ...
                                        <tr>
                                            <td width="16%" align="right" class="dvtCellLabel">(请选择月初和月末)日期:
                                            </td>
