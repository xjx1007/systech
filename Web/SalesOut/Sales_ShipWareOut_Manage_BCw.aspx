<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_ShipWareOut_Manage_BCw.aspx.cs"
    Inherits="Sales_ShipWareOut_Manage_BCw" %>
...
<script type="text/javascript" >
    function Print(ID) {
        ...
        var temp = window.showModalDialog("Procure_Xh_View1.aspx?ID=" + ID + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                成品领料单 > <a class="hdrLink" href="Sales_ShipWareOut_Manage.aspx">成品领料单</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Sales_ShipWareOut_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 成品领料单信息..." title="创建 成品领料单信息..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 成品领料单信息..." title="查找 成品领料单信息..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 成品领料单信息" title="*导入 成品领料单信息"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 成品领料单信息" title="*导出 成品领料单信息"
                                                        border="0">
                                                </td>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><%=base.Base_BindViewByTitle("月份","KNet_WareHouse_DirectOutList_Ll", "Sales_ShipWareOut_Manage_BCw.aspx","and PBW_Order  in ('100','99')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <%=base.Base_BindViewByTitle("其他","KNet_WareHouse_DirectOutList_Ll", "Sales_ShipWareOut_Manage_BCw.aspx","and PBW_Order not in ('100','99')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                        </td>
                    </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                            ...
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="出库单号" SortExpression="DirectOutNo">
                                        <ItemTemplate>
                                            <a href="Sales_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>&DType=1"
                                                target="_self">
               ...
               <%# base.Base_GetProductsEdition_Link(DataBinder.Eval(Container.DataItem, "ProductsBarCode").ToString())%>
                                        ...
                                        <asp:TemplateField HeaderText="备品数量" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <itemtemplate>
               <%# DataBinder.Eval(Container.DataItem, "KWD_BNumber").ToString()%>
          </itemtemplate>
                                        </asp:TemplateField>
               ...
               <%# GetOrderCheckYN(DataBinder.Eval(Container.DataItem, "DirectOutNo"))%>
                                        ...
                                        <asp:TemplateField HeaderText="领料单" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                             ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>   
                                            <a href="#"  onclick="Print('<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>')"><asp:Image ID="Image4" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "KWD_BPrintNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
                                </Columns>
