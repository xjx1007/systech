...
public partial class Web_Procure_Xh_View1 : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s_HouseName = "领料仓库：" + base.Base_GetHouseName(Model_HouseNo.SuppNo);
            ...
            s_Head += "<tr>\n<th colspan=\"10\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>成品领料单</th></tr>\n";
            s_Head += "<tr>\n<th colspan=\"5\" class=\"thstyleleft\"  >" + s_WareHouseDateTime + "</th><th colspan=\"3\" class=\"thstyleRight\" >" + s_HouseName + "</th></tr>\n";
            s_Head += "<tr>\n<th colspan=\"5\" class=\"thstyleleft\"  >" + s_DirectOutNo + "</th><th colspan=\"3\" class=\"thstyleRight\" ></th></tr>\n";
