    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                发货出库管理 > <a class="hdrLink" href="Sales_ShipWareOut_Manage.aspx">发货出库管理</a>
            </td>
            <td width="100%" nowrap>
        ...
        <tr>
           ...
           <%# GetKDSateName1(DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString())%>
                                        ...
                                        <asp:TemplateField HeaderText="电池" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                            ...
                                            <itemtemplate>   
                                            <a href="#"  onclick="GPrint('<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>')"><asp:Image ID="Image4" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "KWD_PintBatteryNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="其他" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                             ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>   
                                            <a href="#"  onclick="Print1('<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>')"><asp:Image ID="Image6" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "KWD_PrintNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
               ...
               <%# GetOrderCheckYN(DataBinder.Eval(Container.DataItem, "DirectOutNo"))%>
                                        ...
                                        <asp:TemplateField HeaderText="应收款" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>
               <%# base.Base_GetBasicCodeName("212", DataBinder.Eval(Container.DataItem, "v_State").ToString(), "../Receive/Cw_Accounting_Payment_Add.aspx?OutWareNo=" + DataBinder.Eval(Container.DataItem, "KWD_ShipNo").ToString())%>
          </itemtemplate>
                                        </asp:TemplateField>
                                </Columns>
