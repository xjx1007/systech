...
public partial class Sales_ShipWareOut_Print_BCw : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                string sql = "Update KNet_WareHouse_DirectOutList set KWD_BPrintNums=KWD_BPrintNums+1 where DirectOutNo='" + this.Tbx_DID.Text + "'";
    ...
    private void DataShow()
    {
        ...
        this.BeginQuery("Select *,isnull(KWD_BNumber,0) as TotalNumber From KNet_WareHouse_DirectOutList a join KNet_WareHouse_DirectOutList_Details b on a.DirectOutNo=b.DirectOutNo where KWD_ShipNo='" + this.Tbx_ID.Text + "' and a.DirectOutNO='" + this.Tbx_DID.Text + "' ");
