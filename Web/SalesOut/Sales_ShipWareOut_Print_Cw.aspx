<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_ShipWareOut_Print_Cw.aspx.cs"
    Inherits="Sales_ShipWareOut_Print_Cw" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function printPage() {
            ...
            LODOP.SET_PRINT_MODE("PRINT_PAGE_PERCENT", "75%");
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="Table" width="96%">
        ...
        <tr>
            ...
            <td colspan="3" align="left">
                发货单号：<asp:Label ID="Lbl_Code" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="6" align="left" height="30">
        ...
        <tr>
            ...
            发货人：<asp:Label ID="Lbl_FPerson" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="48">
            <td class="style13" height="30" nowrap>
                项次
            </td>
            <td class="style5" nowrap>
                品名
            </td>
            <td class="style7" nowrap>
                型号
            </td>
            <td class="style9" nowrap>
                数量
            </td>
