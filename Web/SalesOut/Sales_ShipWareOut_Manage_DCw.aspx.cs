...
public partial class Sales_ShipWareOut_Manage_DCw : BasePage
{
    ...
    private void DataGridBind()
    {
        ...
        string s_Type = "";
        string SqlWhere = " KWD_Del='0' and KWD_Type='101' and (KWD_ShipNo in( select OutWareNo from KNet_Sales_OutWareList where KSO_Type='1')) ";
