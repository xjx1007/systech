...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            s_Sql = "Select DirectOutAmount+isnull(KWD_BNumber,0) DirectOutAmount,*,case when a.KWD_Type='102' then '部门领用' when  isnull(b.KWD_SalesUnitPrice, '0') = '0' then '生产领用' else '销售出库' end as TypeName";
            ...
            s_Sql += "  Where a.DirectOutNo='" + s_ID + "' and c.ProductsType = 'M130704050932527' ";
            string s_TypeName = "";
