    ...
    protected void Btn_SaveOnClick(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (Chk.Checked)
            {
                ...
                s_Return += s_ProductsName + "," + s_ProductsBarCode + "," + s_ProductsPattern + "," + s_ProductsEdition + "," + s_Number + "," + s_Remark + "," + s_BNumber + "," + s_ID + "," + s_OrderNo.Trim() + "," + s_MaterNo.Trim() + "," + s_CustomerProductsName + "," + s_PlanNo.Trim() + "," + s_IsFollow + "|";
            }
        }
