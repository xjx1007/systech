                                        ...
                                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="创建发货通知" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" 
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <a href="../SalesShip/Knet_Sales_Ship_Manage_Add.aspx?CustomerValue=<%# DataBinder.Eval(Container.DataItem, "CustomerValue").ToString()%>&ProductsBarCode=<%# DataBinder.Eval(Container.DataItem, "ProductsBarCode").ToString()%>">创建</a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
