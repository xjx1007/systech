...
<head>
    ...
    <script language="JAVASCRIPT">
        function btnGetReturnValue_onclick() {
            ...
            var tempd = window.showModalDialog("SelectSalesClientList.aspx?sID=" + intSeconds + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=900px;dialogHeight=500px");
            if (tempd != undefined) {
                var ss;
                ss = tempd.split("|");
        ...
        function btnGetBaoPriceValue_onclick() {
            ...
            var temaap = window.showModalDialog("../Common/SelectBaoPriceList.aspx?sdID=" + secondssss + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
            if (temaap != undefined) {
                var sws;
                sws = temaap.split("|");
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                            ...
                                            <tr>
                                                ...
                                                <asp:TextBox ID="ContractEndtDateTime" runat="server" MaxLength="20" Visible="false"
                                                    CssClass="Wdate" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'ContractStarDateTime\')}'})"></asp:TextBox></tr>
                                            <tr>
                                                <td class="dvtCellLabel">
                                                    合同分类:
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="dvtCellInfo">
                                                    常规：<asp:DropDownList ID="Drop_RoutineTransport" runat="server" Width="150px">
                                                    </asp:DropDownList>
