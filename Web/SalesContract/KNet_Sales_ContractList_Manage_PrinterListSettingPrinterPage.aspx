<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false"   CodeFile="KNet_Sales_ContractList_Manage_PrinterListSettingPrinterPage.aspx.cs" Inherits="Knet_Sales_KNet_Sales_ContractList_Manage_PrinterListSettingPrinterPage" %>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td background="../../images/ktxt1.gif" style="background-color:#F5F5F5; height:28px; width:130px;padding-left:20px;"><div class="TP2">打印合同单</div></td>
    <td background="../../images/ktxt2.gif">
    
<table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0" >
<tr>
 <td height="20" align="right">友情提示:合同项目内容双击可手动编辑文字内容&nbsp;&nbsp;&nbsp;&nbsp;<Input  Type="Button" id="Button1" class="Btt"  onclick="printPage()"  value="打印输出合同单" size="10">&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="返回合同单列表" CausesValidation="false" CssClass="Btt" OnClick="Button2_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
</table>
...
<table width="820" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top:0px solid #A3B2CC;">
  <tr>
    <td height="28" > &nbsp;<Input  Type="Button" id="Button1aaa" class="Btt"  onclick="printPage()"  value="打印输出合同单" size="10">&nbsp;</td>
</tr>
</table>
<!--分页-->
