<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_MaterialDBIn_List.aspx.cs"
    Inherits="Procure_MaterialDbIN_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>单据 > <a class="hdrLink" href="Procure_MaterialIn_List.aspx">原材料调拨入库单</a>
                </td>
                <td width="100%" nowrap>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><%=base.Base_BindViewByTitle("月份","Cg_Order_MaterialDbIN", "Procure_MaterialDbIn_List.aspx","and PBW_Order  in ('0')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <%=base.Base_BindViewByTitle("其他","Cg_Order_MaterialDbIN", "Procure_MaterialDbIn_List.aspx","and PBW_Order not in ('0')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                    ...
                                    <td>
                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="日期" DataField="AllocateDateTime" DataFormatString="{0:yyyy-MM-dd}"
                                                    SortExpression="AllocateDateTime">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:TemplateField HeaderText="入库仓库" SortExpression="HouseNo_int" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetHouseName(DataBinder.Eval(Container.DataItem, "HouseNo_int").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="出库仓库" SortExpression="HouseNo1" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="产品" SortExpression="ProductsBarCode" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetProductsEdition(DataBinder.Eval(Container.DataItem, "ProductsBarCode").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="数量" DataField="allocateAmount"
                                                    SortExpression="allocateAmount">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="单价" DataField="allocate_WwPrice"
                                                    SortExpression="allocate_WwPrice">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="金额" DataField="allocate_WwMoney"
                                                    SortExpression="allocate_WwMoney">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
