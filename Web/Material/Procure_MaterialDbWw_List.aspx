<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_MaterialDbWw_List.aspx.cs"
    Inherits="Procure_MaterialDbWw_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>单据 > <a class="hdrLink" href="Procure_MaterialDbWw_List.aspx">原材料调拨单</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td><%=base.Base_BindViewByTitle("月份","Cg_Order_MaterialDbIN", "Procure_MaterialDbWw_List.aspx","and PBW_Order  in ('0')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                </td>
            </tr>
            <tr>
                <td>
                    <%=base.Base_BindViewByTitle("其他","Cg_Order_MaterialDbIN", "Procure_MaterialDbWw_List.aspx","and PBW_Order not in ('0')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                </td>
            </tr>
            <tr>
                <td>
