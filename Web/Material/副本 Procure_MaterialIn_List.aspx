<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 Procure_MaterialIn_List.aspx.cs"
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <%=base.Base_BindView("Procure_MaterialIn", "Procure_MaterialIn_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="单号" SortExpression="WareHouseNo" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "WareHouseNo")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="对账日期" SortExpression="COC_Stime">
                                                    <ItemTemplate>
                                                        <%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "COC_Stime").ToString()).ToShortDateString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="入库仓库" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                          <%# base.Base_GetHouseName(DataBinder.Eval(Container.DataItem, "COD_CustomerValue").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="产品型号" SortExpression="COD_ProductsBarCOde">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetProductsPattern(DataBinder.Eval(Container.DataItem, "COD_ProductsBarCOde").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="数量" SortExpression="COD_DzNumber">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COD_DzNumber").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="单价" SortExpression="COD_Price">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COD_Price").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="金额" SortExpression="COD_Money">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COD_Money").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="次数" SortExpression="COD_NoTaxLag">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COD_NoTaxLag").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="不含税金额" SortExpression="COD_SMoney">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="Tbx_Money" runat="server" CssClass="detailedViewTextBox" MaxLength="40" Text='<%# DataBinder.Eval(Container.DataItem, "COD_SMoney").ToString() %>' Width="100px"></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COD_SMoney").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="日期" SortExpression="COC_CTime">
                                                    <ItemTemplate>
                                                        <%# DataBinder.Eval(Container.DataItem, "COC_CTime").ToString() %>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
