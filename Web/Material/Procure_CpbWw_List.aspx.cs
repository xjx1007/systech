...
public partial class Procure_CpbWw_List : BasePage
{
    ...
    private void DataShow()
    {
        ...
        string SqlWhere = " 1=1 and a.AllocateNo not like 'FX%' and e.KSP_code  like '01%'  ";
        AdminloginMess AM = new AdminloginMess();
        ...
        if (s_WhereID1 != "")
        {
            SqlWhere += Base_GetBasicWhere(s_WhereID1);
        }
