                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            ...
                            <td style="padding-right: 20px" align="left" nowrap>查看范围:
                                <asp:DropDownList runat="server" ID="Ddl_House" AutoPostBack="true" OnTextChanged="Ddl_House_TextChanged"></asp:DropDownList>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="料号" SortExpression="COD_ProductsBarCOde">
                                            <ItemTemplate>
