<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cw_Account_Expense_List.aspx.cs" Inherits="Cw_Account_Expense_List" %>
...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>费用报销 >
	<a class="hdrLink" href="Cw_Account_Bill_List.aspx">费用报销</a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Cw_Account_Bill_Add.aspx')"><img src="../../themes/softed/images/btnL3Add.gif" alt="创建 费用报销..." title="创建 费用报销..." border=0></a></td>
				...
				<td style="padding-right:10px"><a href="javascript:;" onClick="ShowDiv()" ><img src="../../themes/softed/images/btnL3Search.gif" alt="查找 费用报销..." title="查找 费用报销..." border=0></a></td>
				<td style="padding-right:0px;padding-left:10px;"><img src="../../themes/softed/images/tbarImport.gif" alt="*导入 费用报销" title="*导入 费用报销" border="0"></td>	
				<td style="padding-right:10px"><img src="../../themes/softed/images/tbarExport.gif" alt="*导出 费用报销" title="*导出 费用报销" border="0"></td>
				</tr>
				</table>
			</td>
			</tr>
