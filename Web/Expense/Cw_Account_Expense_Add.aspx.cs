    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (s_ReceiveID != "")
            {
                ...
                this.Tbx_Money.Text = Model.cap_wKpmoney.ToString();
    ...
    protected void Btn_SaveOnClick(object sender, EventArgs e)
    {
        ...
        if (s_ID == "")//新增
        {
            try
            {
                ...
                AlertAndRedirect("新增成功！", "Cw_Account_Bill_List.aspx");
            }
            catch { }
        }
        else
        ...
        try
        {
           ...
           if (s_ReveiveID != "")
           {
               ...
               if (Dtb_Table.Rows.Count > 0)
               {
                   ...
                   {
                       decimal d_LMoney=decimal.Parse(s_Money==""?"0":s_Money)*decimal.Parse(Dtb_Table.Rows[i]["PBP_Percent"].ToString());
                       ...
                       s_Return += "<td class=\"dvtCellInfo\" nowrap><input type=\"text\" class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"this.className=\'detailedViewTextBox\'\" style=\"width:150px;\" Name=\"D_Money_" + i.ToString() + "\" value=" + d_LMoney.ToString() + "></td>";
                       s_Return += "<td class=\"dvtCellInfo\" nowrap><input type=\"text\" class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"this.className=\'detailedViewTextBox\';ChgDays()\" style=\"width:150px;\"  Name=\"D_OutDays_" + i.ToString() + "\" value=" + i_Days.ToString() + "></td>";
                       s_Return += "<td class=\"dvtCellInfo\" nowrap><input type=\"text\" class=\"Wdate\" OnFocus=\"WdatePicker()\" style=\"width:200px;\" Name=\"D_OutTime_" + i.ToString() + "\" value=" + D_Time.ToShortDateString() + " ></td>";
                       s_Return += "<td  class=\"dvtCellInfo\" nowrap><input type=\"text\" class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"this.className=\'detailedViewTextBox\'\" style=\"width:150px;\" Name=\"D_Remarks_" + i.ToString() + "\" ></td></tr>";
                   }
