<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cw_Account_Bill_List.aspx.cs" Inherits="Cw_Account_Bill_List" %>
...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>发票管理 >
	<a class="hdrLink" href="Cw_Account_Bill_List.aspx">发票管理</a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Cw_Account_Bill_Add.aspx')"><img src="../../themes/softed/images/btnL3Add.gif" alt="创建 发票管理..." title="创建 发票管理..." border=0></a></td>
				...
				<td style="padding-right:10px"><a href="javascript:;" onClick="ShowDiv()" ><img src="../../themes/softed/images/btnL3Search.gif" alt="查找 发票管理..." title="查找 发票管理..." border=0></a></td>
				<td style="padding-right:0px;padding-left:10px;"><img src="../../themes/softed/images/tbarImport.gif" alt="*导入 发票管理" title="*导入 发票管理" border="0"></td>	
				<td style="padding-right:10px"><img src="../../themes/softed/images/tbarExport.gif" alt="*导出 发票管理" title="*导出 发票管理" border="0"></td>
				</tr>
				</table>
			</td>
			</tr>
...
<tr>
 <td>
    <%=base.Base_BindView("Cw_Account_Bill", "Cw_Account_Bill_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
</td>
</tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("Cw_Account_Bill")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
...
<Columns>
         ...
         <asp:TemplateField HeaderText="编号"  SortExpression="CAB_Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="应收款编号" SortExpression="CAP_Code" ItemStyle-HorizontalAlign="center"
                ...
                <ItemTemplate>
                    <a href="../receive/Cw_Accounting_Payment_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "CAP_ID") %>">
      ...
      <asp:TemplateField HeaderText="出库单号"  SortExpression="CAB_ID" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# GetDirectOutNo(DataBinder.Eval(Container.DataItem, "CAB_ID").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
         ...
         <asp:BoundField  HeaderText="发票编号"  DataField="CAB_BillNumber"  SortExpression="CAB_Day"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
            <ItemStyle HorizontalAlign="Left"   Font-Size="12px"   />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
      <asp:TemplateField HeaderText="负责人"  SortExpression="CAB_DutyPerson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Cw_Account_Bill_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "CAB_ID") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="../../images/Edit.gif" border=0 ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
</Columns>
