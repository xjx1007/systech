...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                //明细
                s_Sql = "Select a.SED_HouseNo,a.SED_RkTime,a.SED_ProductsBarCode,a.SED_RkNumber,a.SED_FromHouseNo,isnull(SED_WwPrice,0) SED_WwPrice,isnull(SED_WwMoney,0) SED_WwMoney,SED_ID";
                s_Sql += " ";
                s_Sql += " from v_Sc_Expend_Manage_MaterDetails_1  a ";
                s_Sql += "  Where 1=1 ";
                if (s_StartDate != "")
                ...
                if (Dtb_Table.Rows.Count > 0)
                {
                    for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                    {
                        ...
                        if (s_ID == "")
                        {
                            try
                            {
                                if (s_Type == "0")
                                {
                                    s_Details += "<td  class='thstyleLeftDetails'align=center noWrap>" + Dtb_Table.Rows[i]["SED_ID"].ToString()+ "</td>\n";
                                    s_Details += "<td  class='thstyleLeftDetails'align=center noWrap>" + DateTime.Parse(Dtb_Table.Rows[i][1].ToString()).ToShortDateString() + "</td>\n";
                                }
                            }
                            catch
                    ...
                    s_Details += "<td  class='thstyleLeftDetails' align=right noWrap colspan=3>&nbsp;</td>\n";//money
            ...
            s_HouseName = "仓库:" + base.Base_GetHouseName(s_House);
            ...
            s_Head += "<tr>\n<th colspan=\"5\" class=\"thstyleleft\"  >" + s_HouseName + "</th><th colspan=\"5\" class=\"thstyleRight\" >" + s_Time + "</th></tr>\n";
