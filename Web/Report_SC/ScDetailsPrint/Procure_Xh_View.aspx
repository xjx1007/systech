<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_Xh_View.aspx.cs"
    Inherits="Web_Procure_Xh_View" %>
...
.Custom_Hidden
{
	...
	function CreateOneFormPage(){
	  ...
	  //  LODOP.ADD_PRINT_HTM(30, 0, "100%", "100%","<table width=\"100%\"><tr><td class=\"ListHeadDetails\" align=\"center\"><font color ='black' size ='6'>士腾与供应商对账确认单</font></td></tr></table>"); 
		...
		var strBodyStyle = "<style>" + document.getElementById("style2").innerHTML + "</style>";
