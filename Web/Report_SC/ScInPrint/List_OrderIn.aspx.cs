...
public partial class Web_List_OrderIn : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s_Sql = "Select a.SER_HouseNo,c.SuppNo,c.OrderType,b.SEM_STime,d.ProductsBarCode,d.OrderAmount,a.SER_scNumber,0,b.SEM_Remarks,b.SEM_ID,c.OrderNo,a.SER_HouseNo,0,a.SER_ScPrice,a.SER_ScMoney,isnull(d.OrderUnitPrice,0) as OrderMoney,isnull(d.HandPrice,0) as HandMoney,isnull(d.OrderUnitPrice,0)*SER_ScMoney+isnull(d.HandPrice,0)*SER_ScMoney as TotalMoney ";
            ...
            if (Dtb_Table.Rows.Count > 0)
            {
                for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                {
                    ...
                    s_Details += "<td  class='thstyleLeftDetails' >&nbsp;" + Dtb_Table.Rows[i][9].ToString() + "</td>\n";
                        ...
                        s_Details += "<td class='thstyleLeftDetails'  nowrap width=\"60px\" >" + base.Base_GetHouseName(Dtb_Table.Rows[i][11].ToString()) + "</td>\n";
                        s_Details += "<td class='thstyleLeftDetails' width=\"60px\" >" + base.Base_GetProductsCode(Dtb_Table.Rows[i][4].ToString()) + "</td>\n";
                        s_Details += "<td class='thstyleLeftDetails' nowrap width=\"70px\" >" + base.Base_GetProdutsName(Dtb_Table.Rows[i][4].ToString()) + "</td>\n";
                        s_Details += "<td  class='thstyleLeftDetails'align=left nowrap >" + base.Base_GetProductsPattern(Dtb_Table.Rows[i][4].ToString()) + "</td>\n";
                        ...
                        s_Details += "<td  class='thstyleLeftDetails' align=left  >&nbsp;" + Dtb_Table.Rows[i][8].ToString() + "</td>\n";
            ...
            s_Head += "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"scrollTable\" id=\"scrollTable\">\n<thead class=\"fixedHeader\"> \n";
            s_Head += "<tr>\n<th colspan=\"10\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>生产入库明细单</th></tr>\n";
            s_Head += "<tr>\n<th colspan=\"5\" class=\"thstyleleft\"  ></th><th colspan=\"5\" class=\"thstyleRight\" align=right   >" + s_Time + "</th></tr>\n";
            s_Head += "<th class=\"thstyle\" >项次</th>\n";
            s_Head += "<th class=\"thstyle\" align=center>入库编号</th>\n";
            s_Head += "<th class=\"thstyle\" align=center>发货日期</th>\n";
            s_Head += "<th class=\"thstyle\" align=center  width=\"60px\" >入库仓库</th>\n";
            s_Head += "<th class=\"thstyle\" align=left>产品编码</th>\n";
            s_Head += "<th class=\"thstyle\" align=left>品名</th>\n";
            s_Head += "<th class=\"thstyle\" align=left>型号</th>\n";
            s_Head += "<th class=\"thstyle\" align=left>版本号</th>\n";
            s_Head += "<th class=\"thstyle\"  align=right>生产数量</th>\n";
            s_Head += "<th class=\"thstyle\"  align=left>备注</th>\n";
