<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_WareHouse_DirectInto_Manage.aspx.cs" Inherits="Knet_Web_WareHouse_KNet_WareHouse_DirectInto_Manage" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>入库管理 > <a class="hdrLink" href="KNet_WareHouse_DirectInto_Manage.aspx">入库管理</a>
                </td>
                <td width="100%" nowrap>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="返修品单号" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="../SalesReturn/Knet_Sales_Retrun_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "KWD_ReturnNo")%>" target="_self"><%# DataBinder.Eval(Container.DataItem, "KWD_ReturnNo")%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField HeaderText="快递" DataField="KWD_KDName" SortExpression="KWD_KDName"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="单号" DataField="KWD_KDCode" SortExpression="KWD_KDCode"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="快递状态" SortExpression="KWD_State" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# GetKDSateNameByDirectInto(DataBinder.Eval(Container.DataItem, "DirectInNo").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="打印" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="#" onclick="GPrint('<%# DataBinder.Eval(Container.DataItem, "DirectInNo")%>')">
