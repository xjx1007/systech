    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <asp:TemplateField HeaderText="经手人"  SortExpression="DirectInStaffNo" HeaderStyle-Font-Size="12px"    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
        ...
        <asp:TemplateField HeaderText="打印" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
            ...
            <itemtemplate>   
            <a href="#"  onclick="GPrint('<%# DataBinder.Eval(Container.DataItem, "DirectInNo")%>')"><asp:Image ID="Image4" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "KWD_BPrintNums")%>)
            </itemtemplate>
        </asp:TemplateField>
