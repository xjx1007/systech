...
<script language="JAVASCRIPT">
    ...
    function btnGetReturnValue_onclick1() {
        ...
        var temp = window.open("SelectSalesOpp.aspx?sID=" + intSeconds + "", "选择客户", "width=850px, height=500,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
    }
                                    ...
                                    <td>
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                            ...
                                            <tr>
                                                ...
                                                <td class="dvtCellInfo">
                                                    <asp:DropDownList ID="Ddl_Steps" CssClass="detailedViewTextBox" runat="server" Width="100px">
                                                    </asp:DropDownList>
                                                    (<font color="red">*</font>)
                                                ...
                                                <td class="dvtCellInfo">
                                                    <asp:DropDownList ID="Ddl_State" CssClass="detailedViewTextBox" runat="server" Width="100px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="dvtCellInfo">
                                                    <asp:TextBox ID="Tbx_NextAskTime" runat="server" CssClass="Wdate" onFocus="WdatePicker()"></asp:TextBox>
                                                </td>
                                                <td width="17%" class="dvtCellLabel">
                                                    销售机会:
                                                </td>
                                                <td class="dvtCellInfo">
                                                    ...
                                                    <pc:PTextBox ID="Tbx_SalesChanceName" runat="server" CssClass="detailedViewTextBox"
                                                        OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"
                                                        Width="178px" ReadOnly="true"></pc:PTextBox>
                                                    <img tabindex="8" src="/themes/softed/images/select.gif" alt="选择" title="选择"
