<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_Sales_Content_List.aspx.cs" Inherits="Web_Sales_Xs_Sales_Content_List" %>
...
<tr>
	...
	<a class="hdrLink" href="Xs_Sales_Content_List.aspx"><asp:Label runat="server" ID="Lbl_Title"></asp:Label></a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Xs_Sales_Content_Add.aspx')"><img src="/themes/softed/images/btnL3Add.gif" alt="创建 联系记录..." title="创建 联系记录..." border=0></a></td>
				<td style="padding-right:0px;">
                                                        <asp:ImageButton runat="server" ID="Btn_Del" ImageUrl="/themes/softed/images/btnL3Delete.gif"
                                                            OnClick="Btn_Del_Click" /></td>
				<td style="padding-right:10px"><a href="javascript:;" onClick="ShowDiv()" ><img src="/themes/softed/images/btnL3Search.gif" alt="查找 联系记录..." title="查找 联系记录..." border=0></a></td>
				<td style="padding-right:0px;padding-left:10px;"><img src="/themes/softed/images/tbarImport.gif" alt="*导入 联系记录" title="*导入 联系记录" border="0"></td>	
				<td style="padding-right:10px"><img src="/themes/softed/images/tbarExport.gif" alt="*导出 联系记录" title="*导出 联系记录" border="0"></td>
				</tr>
				</table>
			</td>
			</tr>
...
<tr>
 <td>
    <%=base.Base_BindView("Xs_Sales_Content", "Xs_Sales_Content_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
</td>
</tr>
  <tr>
    <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                        ...
                        <tr>
                            <td align="left" width="40%">
                                <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("Xs_Sales_Content")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
...
<Columns>
        ...
        <asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="主题"  SortExpression="XSC_Topic" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <a href="Xs_Sales_Content_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSC_ID") %>"><%# DataBinder.Eval(Container.DataItem, "XSC_Topic").ToString()%></a>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="销售机会" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <a href="/Web/SalesOpp/Xs_Sales_Opp_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSC_SalesChance") %>"><%# DataBinder.Eval(Container.DataItem, "XSO_Name").ToString()%></a>
          </ItemTemplate>
        </asp:TemplateField>
      <asp:TemplateField HeaderText="客户名称"  SortExpression="XSC_CustomerValue" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "XSC_CustomerValue").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="联系人"  SortExpression="XSC_LinkMan" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetLinkManValue(DataBinder.Eval(Container.DataItem, "XSC_LinkMan").ToString(),"XOL_Name")%>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="联系类型"  SortExpression="XSC_Types" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetBasicCodeName("117",DataBinder.Eval(Container.DataItem, "XSC_Types").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
         <asp:BoundField  HeaderText="联系日期"  DataField="XSC_Stime"  SortExpression="XSC_Stime" DataFormatString="{0:yyyy-MM-dd}"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
            <ItemStyle HorizontalAlign="Left"   Font-Size="12px"   />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
      <asp:TemplateField HeaderText="负责人"  SortExpression="XSC_DutyPerson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "XSC_DutyPerson").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="创建人"  SortExpression="XSC_Creator" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Xs_Sales_Content_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XSC_ID") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="/images/Edit.gif" border=0   ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
</Columns>
