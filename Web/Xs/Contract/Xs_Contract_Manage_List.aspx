<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_Contract_Manage_List.aspx.cs" Inherits="Xs_Contract_Manage_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="Xs_Contract_Manage_List.aspx">合同档案</a>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('Xs_Contract_Manage_Add.aspx')">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
            <tr>
                <td>
                    <%=base.Base_BindView("Xs_Contract_Manage", "Xs_Contract_Manage_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("Xs_Contract_Manage")%>    ','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="编码" SortExpression="XCM_ID" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Xs_Contract_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XCM_ID") %>"><%# DataBinder.Eval(Container.DataItem, "XCM_Code").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="标题" DataField="XCM_Title" SortExpression="XCM_Title" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="客户" SortExpression="XCM_CustomerValue" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%#base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "XCM_CustomerValue").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="签订日期" DataField="XCM_Stime" SortExpression="XCM_Stime" DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="负责人" SortExpression="XCM_CustomerValue" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%#base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "XCM_DutyPerson").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="类型" SortExpression="XCM_Type" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%#base.Base_GetBasicCodeName("216", DataBinder.Eval(Container.DataItem, "XCM_Type").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="开票类型" SortExpression="XCM_KpType" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%#base.Base_GetBasicCodeName("768", DataBinder.Eval(Container.DataItem, "XCM_KpType").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="产品" SortExpression="XCM_KpType" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                        <%# GetContractProductsPatten(DataBinder.Eval(Container.DataItem, "XCM_Code").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="合同数量" SortExpression="XCM_KpType" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                        <%# GetContractContractNumber(DataBinder.Eval(Container.DataItem, "XCM_Code").ToString())%>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="订单数量" SortExpression="XCM_KpType" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                        <%# GetContractOrderNumber(DataBinder.Eval(Container.DataItem, "XCM_Code").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="修改日期" DataField="XCM_MTime" SortExpression="XCM_MTime" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Xs_Contract_Manage_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XCM_ID") %>">
                                        ...
                                        <asp:TemplateField HeaderText="审核" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# GetCheckYN(DataBinder.Eval(Container.DataItem, "XCM_ID"))%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
