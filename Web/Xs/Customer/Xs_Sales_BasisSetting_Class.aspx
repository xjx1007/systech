    ...
    <form id="form2" runat="server">
        <div>
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>市场 > <a class="hdrLink" href="KNet_Sales_ClientList_Manger.aspx">
            ...
            <table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" class="ListDetails" >
                <tr>
                    ...
                    <td width="80" align="right" class="ListHeadDetails">编码:</td>
                    <td width="160" align="left" class="ListHeadDetails">
                        <asp:TextBox ID="Tbx_Code" Width="50px" runat="server" CssClass="detailedViewTextBox"></asp:TextBox></td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            PageSize="10" BorderColor="#4974C2" OnRowUpdating="GridView1_RowUpdating" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_Editing" OnRowDataBound="GridView1_DataRowBinding">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Client_Name" HeaderText="分类名称" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="Client_Name">
                                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    </asp:BoundField>

                                                    <asp:TemplateField HeaderText="上级名称" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="Client_FaterNo">
                                                        <EditItemTemplate>
