<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_Sales_ClientList_Manger.aspx.cs"
    Inherits="Knet_Web_Sales_KNet_Sales_ClientList_Manger" %>
                                    ...
                                    <td>
                                        ...
                                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="客户级别" SortExpression="KSC_Level" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetBasicCodeName("112", DataBinder.Eval(Container.DataItem, "KSC_Level").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="客户状态" SortExpression="KSC_State" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="付款方式" SortExpression="KSC_PayMent" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetBasicCodeName("104", DataBinder.Eval(Container.DataItem, "KSC_PayMent").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                
                                                <asp:TemplateField HeaderText="开票方式" SortExpression="KSC_KPType" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                ...
                                                <asp:BoundField HeaderText="移动电话" DataField="CustomerMobile" ItemStyle-Font-Size="12px"
                                                    ItemStyle-Width="90px" HeaderStyle-Font-Size="12px" SortExpression="CustomerMobile">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="信誉额度" DataField="PlayCycleMoney" ItemStyle-Font-Size="12px"
                                                    ItemStyle-Width="90px" HeaderStyle-Font-Size="12px" SortExpression="PlayCycleMoney">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="应收款" DataField="receiveMoney" ItemStyle-Font-Size="12px"
                                                    ItemStyle-Width="90px" HeaderStyle-Font-Size="12px" SortExpression="receiveMoney">
                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="添加时间" DataField="CustomerAddtime" SortExpression="CustomerAddtime"
