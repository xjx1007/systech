...
public partial class Knet_Common_SelectCustomer : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        if (s_Type == "1")
        {
            KNet.BLL.Knet_Procure_Suppliers bll1 = new KNet.BLL.Knet_Procure_Suppliers();
            SqlWhere = " 1=1 ";
            ...
            DataSet ds1 = bll1.GetList(SqlWhere);
            MyGridView1.DataSource = ds1;
            MyGridView1.DataKeyNames = new string[] { "SuppNo" };
    ...
    public string LinMan_Bind(string s_CustomerValue)
    {
        ...
        try
        {
            ...
            s_Return +=  Model.CustomerProvinces + "|" + Model.CustomerCity;
            return s_Return;
        }
        catch
        {
    ...
    [Ajax.AjaxMethod()]
    public string LinMan_Bind1(string s_SuppNO)
    {
        string s_Return = "";
        try
        {
    ...
    public string GetSupp(string s_ID)
    {
        ...
        try
        {
            ...
            string s_Province = Model_Supp.SuppProvince;
            string s_City =Model_Supp.SuppCity;
            s_Return += "<a href=\"javascript:window.close();\" onclick='GetReturn(\"" + s_ID + "\", \"" + base.Base_GetSupplierName(s_ID) + "\", \"" + s_Province + "\", \"" + s_City + "\");'>" + base.Base_GetSupplierName(s_ID) + "</a>";
        }
        catch { }
        return s_Return;
    }
