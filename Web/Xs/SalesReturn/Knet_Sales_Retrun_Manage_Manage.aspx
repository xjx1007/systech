    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                销售退货管理 > <a class="hdrLink" href="Knet_Sales_Retrun_Manage_Manage.aspx">销售退货管理</a>
            </td>
            <td width="100%" nowrap>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" HeaderStyle-Width="30px">
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl="/images/Edit.gif"  CssClass="display:inline-block;border-width:0px;border-style:None;" 
                 NavigateUrl='<%# string.Format("Knet_Sales_Retrun_Manage_Add.aspx?ID={0}",DataBinder.Eval(Container.DataItem,"ReturnNo"))%>' Target="_self"></asp:HyperLink>           </ItemTemplate>
        </asp:TemplateField>
