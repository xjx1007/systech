...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>销售 > <a class="hdrLink" href="Knet_Sales_Retrun_Manage_Manage.aspx">销售退货管理</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("KNet_Sales_ReturnList", "Knet_Sales_Retrun_Manage_Manage.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="退货单号" SortExpression="ReturnNo" HeaderStyle-Font-Size="12px"
                                            ...
                                            <ItemTemplate>
                                                <a href="Knet_Sales_Retrun_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ReturnNo")%>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "ReturnNo").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="发货单号" SortExpression="OutWareNo" HeaderStyle-Font-Size="12px"
                                            ItemStyle-Width="28px" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="/Web/Xs/SalesShip/Knet_Sales_Ship_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "OutWareNo")%>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "OutWareNo").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
