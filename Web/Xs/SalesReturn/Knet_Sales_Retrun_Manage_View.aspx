    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                发货退货 > <a class="hdrLink" href="Knet_Sales_Retrun_Manage_Manage.aspx">发货退货</a>
            </td>
            <td width="100%" nowrap>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td <%=s_OrderStyle%> align="center" nowrap>
                                                <a href="Knet_Sales_Retrun_Manage_View.aspx?Type=0&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                    发货退货单信息</a>
                                            </td>
                                            ...
                                            <td <%=s_DetailsStyle%> align="center" nowrap>
                                                <a href="Knet_Sales_Retrun_Manage_View.aspx?Type=1&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                    相关信息</a>
                                            </td>
