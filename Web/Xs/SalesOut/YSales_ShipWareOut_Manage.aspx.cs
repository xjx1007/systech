...
public partial class YSales_ShipWareOut_Manage : BasePage
{
    ...
    private void DataGridBind()
    {
        ...
        string s_Type = "";
        string SqlWhere = " KWD_Del='0' and KWD_Type='101' and len(DirectOutNo)=12  ";
    ...
    protected string GetDirectOutListfollowup(object DirectOutNo, object DirectOutCheckYN)
    {
        ...
        if (Dtb_Table.Rows.Count > 0)
        {
            s_Return += "<br><font color=red>运费已添加</font>";

        }
        else
        {
            s_Return += "<br><a href=\"#\"  target=\"_self\" ><font color=blue>未添加运费</font></a>";
