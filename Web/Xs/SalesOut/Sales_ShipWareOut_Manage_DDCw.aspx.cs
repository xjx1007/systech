...
public partial class Sales_ShipWareOut_Manage_DDCw : BasePage
{
    ...
    private void DataGridBind()
    {
        ...
        string s_Type = "";
        string SqlWhere = " KWD_Del='0' and KWD_Type='101' and KWD_ShipNo='' ";
        ...
        SqlWhere += "Order by a.KWD_CwOutTime desc";
    ...
    public string Base_GetShipDetailBNumbers(string s_DirectOutNo, bool b_Battry)
    {
        ...
        if (b_Battry == false)
        {
            string s_Sql = "Select Sum(Isnull(KWD_BNumber,0)+Isnull(DirectOutAmount,0)) as DirectOutAmount from KNet_WareHouse_DirectOutList_Details a join KNet_Sys_Products b on a.ProductsBarCode=b.ProductsBarCode Where DirectOutNo='" + s_DirectOutNo + "'";
    ...
    protected string GetOrderCheckYN(object aa)
    {
        using (SqlConnection conn = DBClass.GetConnection("KNetERP"))
        {
            ...
            if (dr.Read())
            {
                ...
                {
                    return "<a href=\"Sales_ShipWareOut_Manage_Cw.aspx?ID="+aa+"\"><font color=Green>仓库已审</font></a>";
                }
