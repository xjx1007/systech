<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 Sales_ShipWareOut_Manage.aspx.cs"
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>发货出库管理 > <a class="hdrLink" href="Sales_ShipWareOut_Manage.aspx">发货出库管理</a>
                </td>
                <td width="100%" nowrap>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><%=base.Base_BindViewByTitle("月份","KNet_WareHouse_DirectOutList", "Sales_ShipWareOut_Manage.aspx","and PBW_Order  in ('100','99')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <%=base.Base_BindViewByTitle("其他","KNet_WareHouse_DirectOutList", "Sales_ShipWareOut_Manage.aspx","and PBW_Order not in ('100','99')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
               ...
               <%# GetPrint(DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString())%>
                                                ...
                                                <asp:TemplateField HeaderText="其他" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <a href="#" onclick="Print1('<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>')">
                                                            <asp:Image ID="Image6" runat="server" ImageUrl="/images/Print1.gif" border="0" ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "KWD_PrintNums")%>)
                                                    </ItemTemplate>
                                                </asp:TemplateField>
