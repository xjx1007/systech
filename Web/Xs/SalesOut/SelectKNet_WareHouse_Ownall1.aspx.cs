...
/// 选择指定仓库产品
/// </summary>
public partial class SelectKNet_WareHouse_Ownall1 : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        s_HouseNo = "131429356506502002";
        string s_Sql = "";
        if (s_OutWareNo != "")
        {
            s_Sql = " Select a.ID,a.ProductsBarCode,a.KSO_Battery,a.KSO_Manual,a.OutWareAmount-Isnull(aa.Number,0) as OutWareAmount,b.HouseNo,isNull(b.Number,0) as Number,isNull(b.TotalNet,0) as TotalNet,a.KSD_BNumber,RCOrderNo as OrderNo,RCMNo as MaterNo,MaterOrderNo,MaterMNo,KSO_IsFollow from KNet_Sales_OutWareList_Details a Left join v_ProdutsStore b on a.ProductsBarCode=b.ProductsBarCode ";
            if (s_HouseNo != "")
            {
                s_Sql += " and b.HouseNo='" + s_HouseNo + "' ";
            }
            s_Sql += "join KNet_Sales_OutWareList d on d.OutWareNo=a.OutWareNo and HouseType=0 ";
