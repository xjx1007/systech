<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_ShipWareOut_Print_DCw.aspx.cs"
    Inherits="Sales_ShipWareOut_Print_DCw" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "成品调拨单");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("成品调拨单.xls");
        };
        function printPage() {
...
<body topmargin="0" leftmargin="0" rightmargin="0" id="Body1" onload="printPage()">
    ...
    <!--startprint-->
    <table border="0" cellpadding="0" cellspacing="0" id="Table" width="90%">
        <colgroup>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left" rowspan="2" valign="top">
                            <img alt="logo中1-2" height="29" src="/Web/../images/士兰微芯片订单_22424_image003.png" v:shapes="Picture_x0020_5" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20">
                        ...
                        <td align="left" valign="top">
                            <img alt="logo英1-2" height="20" src="/Web/../images/士兰微芯片订单_22424_image004.png" v:shapes="Picture_x0020_3" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td colspan="3" align="left">
                成品调拨单号：<asp:Label ID="Lbl_Code" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="6" align="left" height="30">
            ...
            <td colspan="3" align="left">
                调拨日期：<asp:Label ID="Lbl_CKTime" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="6" align="left" height="30">
            ...
            <td colspan="3" align="left">
                调拨仓库：<asp:Label ID="Lbl_HoseNo" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="48">
