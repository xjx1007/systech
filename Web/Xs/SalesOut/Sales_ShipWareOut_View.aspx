                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" id="Table_Btn" runat="server">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:Button ID="btn_Chcek1" runat="server" class="crmbutton small edit" Text="回签单审批"
                                                        OnClick="btn_Chcek_Click1" />&nbsp;
                                                    <asp:Button ID="Button1" runat="server" class="crmbutton small edit" Text="重新生成PDF" OnClick="Button1_Click"
                                                       />&nbsp;
                                                    <asp:Button ID="Button2" runat="server" class="crmbutton small edit" Text="编辑运费信息" OnClick="Button2_Click"
                                                       />&nbsp;
                                                </td>
                                                <td align="right">
                                    ...
                                    <td>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                       <asp:Label ID="DirectOutNO" runat="server"></asp:Label>&nbsp; <asp:Label ID="KWd_CwCode" runat="server"></asp:Label>&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_KyType" runat="server"></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="dvtCellLabel">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_WuliuCode" runat="server"
                                                   >
                                                </asp:Label>&nbsp;
                                            </td>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_WuliuStime" runat="server">
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo">
                                                <asp:DropDownList ID="Drop_KD" runat="server" Width="150px" Enabled="false"></asp:DropDownList>
                                            </td>
                                            <td class="dvtCellLabel">单号:</td>
                                            <td class="dvtCellInfo">
                                                <asp:Label runat="server" ID="Tbx_KDCode" 
                                                ...
                                                <table id="Table_Feight" width="100%" border="0" align="center" cellpadding="5" cellspacing="0"
                                                    ...
                                                    <tr valign="top">
                                                        <td class="ListHeadDetails" style="width: 10%;" nowrap>
                                                            <asp:Label runat="server" ID="Ddl_FSupp" 
                                                                 ></asp:Label>&nbsp;

                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 10%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_PriceID" CssClass="Custom_Hidden"></asp:Label>&nbsp;
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_Type" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_Price" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_Money" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_Time" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_MinMoney" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_PickUpCost" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>

                                                            <asp:Label runat="server" ID="Tbx_Wuliu_DeliveryFee" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_UpstairsCost" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_UpstairsCostMoney" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_WareHouseEntry150Low" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_Insured" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" style="width: 6%;" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_InsuredMoney" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_SignBill" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="ListHeadDetails" nowrap>
                                                            <asp:Label runat="server" ID="Tbx_Wuliu_BigLateTime" 
                                                                 ></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_Weight" runat="server"
                                                     OnBlur=";Calculation(1)">
                                                </asp:Label>&nbsp;
                                            </td>
                                            <td width="35%" class="dvtCellInfo" align="left" colspan="2">
                                                <asp:Label ID="Tbx_WeightDetails" runat="server" TextMode="MultiLine"
                                                      >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_Volume" runat="server"
                                                     OnBlur=";Calculation(1)">
                                                </asp:Label>&nbsp;
                                            </td>
                                            <td width="35%" class="dvtCellInfo" align="left" colspan="2">
                                                <asp:Label ID="Tbx_VolumeDetails" runat="server" TextMode="MultiLine"
                                                      >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_TotalNumber" runat="server"
                                                     OnBlur=";Calculation(1)">
                                                </asp:Label>&nbsp;
                                            </td>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_Price" runat="server" ReadOnly="true"
                                                     >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_TotalMoney" runat="server"
                                                     >
                                                </asp:Label>&nbsp;
                                            </td>

                                            <td width="35%" class="dvtCellInfo" align="left" colspan="2">
                                                <asp:Label ID="Tbx_TotalMoneyDetails" runat="server" TextMode="MultiLine"
                                                      >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" colspan="3" align="left">
                                                <asp:Label ID="Tbx_Description" runat="server" TextMode="MultiLine"
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_FPercent" runat="server"
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_FMoney" runat="server"
                                                     >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_Percent" runat="server"
                                                     >
                                                </asp:Label>&nbsp;
                                            </td>
                                            <td width="15%" height="25" align="right" class="dvtCellLabel">承担金额：
                                            ...
                                            <td width="35%" class="dvtCellInfo" align="left">
                                                <asp:Label ID="Tbx_Money" runat="server"
                                                     >
                                                </asp:Label>&nbsp;
                                            </td>
                                        </tr>
                                                        ...
                                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Tbx_Number" runat="server" OnBlur="ChangPrice(this.value);"
                                                                            Width="150px"  Text='<%#DataBinder.Eval(Container.DataItem, "TotalNumber").ToString() %>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="Left"
                                                                    HeaderText="单价" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Tbx_Price" runat="server" 
                                                                            Width="150px"  Text='<%#base.base_GetCGRKPrice(DataBinder.Eval(Container.DataItem, "ID").ToString()) %>'></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="Left"
                                                                ...
                                                                <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Tbx_Remarks" runat="server" 
                                                        ...
                                                        <cc1:MyGridView ID="MyGridView2" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="Left"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Tbx_Number" runat="server" 
                                                                             Text='<%# DataBinder.Eval(Container.DataItem, "Number").ToString() %>'
                            ...
                            <asp:Panel ID="Pan_Detail" runat="server">
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="入库单号" SortExpression="SEM_ID" HeaderStyle-Font-Size="12px"
                                            ...
                                            <ItemTemplate>
                                                <a href="/Web/Store/CK_Store_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_ID")%>">
                                        ...
                                        <asp:TemplateField HeaderText="发货单" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <a href="Sales_ShipWareOut_Print_Cw.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>"
                                                    target="_blank">
                                                    <asp:Image ID="Image2" runat="server" ImageUrl="/Web/images/Printer.gif" border="0"
                                                        ToolTip="打印" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="成品入库单" SortExpression="SEM_Creator" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="/Web/Report_Bill/Procure_RC_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>"
                                                    target="_blank">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="/Web/images/Printer.gif" border="0"
                                                        ToolTip="打印" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="委外加工耗料单" SortExpression="SEM_Creator" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="/Web/Report_Bill/Procure_Xh_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>"
                                                    target="_blank">
                                                    <asp:Image ID="Image3" runat="server" ImageUrl="/Web/images/Printer.gif" border="0"
                                                        ToolTip="打印" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ID" SortExpression="PBM_Code" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="/Web/mail/PB_Basic_Mail_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBM_ID") %>">
