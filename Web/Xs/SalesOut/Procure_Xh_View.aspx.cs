...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            s_Sql = "Select DirectOutAmount DirectOutAmount,*,case when a.KWD_Type='102' then '部门领用' when  isnull(b.KWD_SalesUnitPrice, '0') = '0' then '生产领用' else '销售出库' end as TypeName";
