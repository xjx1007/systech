<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YSales_ShipWareOut_Manage.aspx.cs"
    Inherits="YSales_ShipWareOut_Manage" %>
...
<script type="text/javascript">
    ...
    function GPrint1(ID) {
        //window.open('Sales_ShipWareOut_Print_Cw.aspx?ID=' + ID, '查看详细', 'top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500')
        var temp = window.showModalDialog("Procure_Xh_View2.aspx?ID=" + ID + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
        // window.location.reload(); 
    }
    function Print1(ID) {
        //window.open('Sales_ShipWareOut_Print_Cw.aspx?ID=' + ID, '查看详细', 'top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500')
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>发货出库管理 > <a class="hdrLink" href="YSales_ShipWareOut_Manage.aspx">未开票应收款</a>
                </td>
                <td width="100%" nowrap>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td><%=base.Base_BindViewByTitle("月份","KNet_WareHouse_DirectOutList", "YSales_ShipWareOut_Manage.aspx","and PBW_Order  in ('100','99')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <%=base.Base_BindViewByTitle("其他","KNet_WareHouse_DirectOutList", "YSales_ShipWareOut_Manage.aspx","and PBW_Order not in ('100','99')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="通知单号" SortExpression="KWD_Custmoer">
                                                    <ItemTemplate>
                                                        <a href="/Web/Xs/SalesShip/Knet_Sales_Ship_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "KWD_ShipNo")%>"
                                                            target="_self">
                                                ...
                                                <asp:TemplateField HeaderText="客户名称" SortExpression="KWD_Custmoer" ItemStyle-Width="60px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:BoundField HeaderText="发货日期" DataField="DirectOutDateTime" DataFormatString="{0:yyyy-MM-dd}"
                                                ...
                                                <asp:TemplateField HeaderText="付款方式" HeaderStyle-Font-Size="12px" ItemStyle-Width="130px" SortExpression="Payment" 
                                                    ...
                                                    <ItemTemplate>
                                                        <%# base.Base_GetBasicCodeName("104",DataBinder.Eval(Container.DataItem, "KWD_Payment").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="开票方式" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" SortExpression="KSC_KpType" 
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                       <a href="Sales_ShipWareOut_Add.aspx?Type=1&ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString()%>" target="_blank"><%# base.Base_GetBasicCodeName("768",DataBinder.Eval(Container.DataItem, "KWD_KpType").ToString())%></a> 
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="状态" SortExpression="DirectOutNo" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# GetKDSateName1(DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="查看" SortExpression="CustomerValue" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-Width="28px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="开票通知" HeaderStyle-Font-Size="12px"
                                                    ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <%# base.GetReceive(DataBinder.Eval(Container.DataItem, "v_State").ToString(), DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
