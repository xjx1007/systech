...
<link rel="stylesheet" href="/Web/../themes/softed/style.css" type="text/css">
...
<script language="javascript" type="text/javascript" src="/Web/../include/js/ListView.js"></script>
                                                ...
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Sales_ShipWareOut_Add.aspx')">
                                                            <img src="/Web/../themes/softed/images/btnL3Add.gif" alt="创建 发货通知信息..." title="创建 发货通知信息..."
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="/Web/../themes/softed/images/btnL3Search.gif" alt="查找 发货通知信息..." title="查找 发货通知信息..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="/Web/../themes/softed/images/tbarImport.gif" alt="*导入 发货通知信息" title="*导入 发货通知信息"
                                                            border="0">
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="/Web/../themes/softed/images/tbarExport.gif" alt="*导出 发货通知信息" title="*导出 发货通知信息"
                                                            border="0">
                                                    </td>
                                ...
                                <table border="0" cellpadding="2" cellspacing="0" class="small" width="100%">
                                    <tr>
                                        ...
                                        <td align="left" nowrap style="padding-right: 20px">查看范围:<asp:DropDownList ID="Ddl_Batch" runat="server" AutoPostBack="True" OnTextChanged="Ddl_Batch_TextChanged1">
                                            ...
                                            <img border="0" src="/Web/../themes/images/collapse.gif">
                                        ...
                                        <td>
                                                ...
                                                <table border="0" cellpadding="3" cellspacing="0" class="layerHeadingULine" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="right" width="40%">
                                                            <img align="absmiddle" alt="关闭" border="0" onclick="fninvsh('changeowner');" src="/Web/../themes/softed/images/close.gif" style="cursor: pointer;" title="关闭"> </img>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="Custom_DgMain" EmptyDataText="&lt;div align=center&gt;&lt;font color=red&gt;&lt;br/&gt;&lt;br/&gt;&lt;B&gt;没有找到相关记录&lt;/B&gt;&lt;br/&gt;&lt;br/&gt;&lt;/font&gt;&lt;/div&gt;" IsShowEmptyTemplate="true" PageSize="10" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="DirectOutAmount" HeaderText="数量" SortExpression="DirectOutAmount">
                                                        <ItemStyle Font-Size="12px" HorizontalAlign="Left" />
                                                        <HeaderStyle Font-Size="12px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    
                                                    <asp:BoundField DataField="KWD_SalesUnitPrice" HeaderText="单价" SortExpression="KWD_SalesUnitPrice">
                                                        <ItemStyle Font-Size="12px" HorizontalAlign="Left" />
                                                        <HeaderStyle Font-Size="12px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    
                                                    <asp:BoundField DataField="KWD_SalesTotalNet" HeaderText="金额" SortExpression="KWD_SalesTotalNet">
                                                        <ItemStyle Font-Size="12px" HorizontalAlign="Left" />
                                                        <HeaderStyle Font-Size="12px" HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="center" HeaderText="回签单" ItemStyle-HorizontalAlign="center" SortExpression="DirectOutCheckYN">
                                                        <ItemTemplate>
                                                            <%# GetHqState(DataBinder.Eval(Container.DataItem, "DirectOutNo").ToString())%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Font-Size="12px" HeaderStyle-HorizontalAlign="center" HeaderText="出库单" ItemStyle-HorizontalAlign="center" SortExpression="DirectOutCheckYN">
                                                        <ItemTemplate>
                                                            <a href="#" onclick='Print(<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>)'>
                                                                <asp:Image ID="Image4" runat="server" border="0" ImageUrl="/Web/../images/Print1.gif" ToolTip="查看发货详细信息" />
