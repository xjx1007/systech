<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cw_Sales_ShipWareOut_Manage.aspx.cs"
    Inherits="Web_Sales_Cw_Sales_ShipWareOut_Manage" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                成品出库单 > <a class="hdrLink" href="Cw_Sales_ShipWareOut_Manage.aspx">成品出库单</a>
            </td>
            <td width="100%" nowrap>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindView("KNet_WareHouse_DirectOutList", "Cw_Sales_ShipWareOut_Manage.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
                        ...
                        <td>
                            ...
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="单号" SortExpression="KWD_Custmoer">
                                        <ItemTemplate>
                                            <a href="Sales_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>"
                                                target="_self">
                                                <%# DataBinder.Eval(Container.DataItem, "KWD_CWCode").ToString()%></a>
                                        </ItemTemplate>
                                        </asp:TemplateField>
           ...
           <%# GetKDSateName(DataBinder.Eval(Container.DataItem, "KWD_ShipNo").ToString())%>
                                        ...
                                        <asp:TemplateField HeaderText="发货单" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="center"
                                            ...
                                            <itemtemplate>
             <a href="#"  onclick="javascript:window.open('Sales_ShipWareOut_Print.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "KWD_ShipNo")%>&DID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');"><asp:Image ID="Image5" runat="server"  ImageUrl="/images/View.gif" border=0  ToolTip="查看发货详细信息" /></a>
          </itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="查看" HeaderStyle-Font-Size="12px" ItemStyle-Width="28px"
                                            ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>
             <a href="#"  onclick="javascript:window.open('Xs_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');"><asp:Image ID="Image3" runat="server"  ImageUrl="/images/View.gif" border=0  ToolTip="查看发货详细信息" /></a>
          </itemtemplate>
                                        </asp:TemplateField>
