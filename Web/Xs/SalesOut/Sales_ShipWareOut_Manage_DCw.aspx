<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_ShipWareOut_Manage_DCw.aspx.cs"
    Inherits="Sales_ShipWareOut_Manage_DCw" %>
                                    ...
                                    <td>
                                        ...
                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="出库仓库" SortExpression="HouseNo" ItemStyle-Width="100px">
                                                    <ItemTemplate>
