...
public partial class Sales_ShipWareOut_Print_Cw : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                string sql = "Update KNet_WareHouse_DirectOutList set KWD_PrintNums=KWD_PrintNums+1 where DirectOutNo='" + this.Tbx_DID.Text + "'";
    ...
    private void DataShow()
    {
        ...
        this.BeginQuery("Select *,DirectOutAmount as TotalNumber From KNet_WareHouse_DirectOutList a join KNet_WareHouse_DirectOutList_Details b on a.DirectOutNo=b.DirectOutNo  join KNet_Sys_Products c on c.ProductsBarCode=b.ProductsBarCode where KWD_ShipNo='" + this.Tbx_ID.Text + "' and c.ProductsType<>'M130704050932527' and a.DirectOutNO='" + this.Tbx_DID.Text + "' ");
        ...
        if (Dtb_Table.Rows.Count > 0)
        {
            for (int i = 0; i < Dtb_Table.Rows.Count; i++)
            {
                ...
                string s_Number=  Dtb_Table.Rows[i]["DirectOutAmount"] == null ? "" : Dtb_Table.Rows[i]["DirectOutAmount"].ToString();
                if (s_Price == "")
                {
                ...
                this.Lbl_Details.Text += "<td class=\"style9\" >" + d_LeftTotal.ToString() + "</td>";
