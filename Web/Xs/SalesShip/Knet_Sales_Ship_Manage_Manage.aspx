    ...
    <script>
        function changsheng(va) {
            if (va != '0') {
                ...
                city.disabled = false;
                var url = "/Web/Web/Js/Handler.ashx?type=sheng&id=" + va;
                                    ...
                                    <td>
                                        ...
                                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="付款方式" SortExpression="CustomerValue" HeaderStyle-Font-Size="12px" ItemStyle-Width="130px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# base.Base_GetBasicCodeName("104",DataBinder.Eval(Container.DataItem, "KSO_PayMent").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="已发" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <a href="/Web/SalesShip/Knet_Sales_Ship_Manage_View.aspx?Type=1&ID=<%# DataBinder.Eval(Container.DataItem, "OutWareNo").ToString()%>"
                                                            target="_blank">
