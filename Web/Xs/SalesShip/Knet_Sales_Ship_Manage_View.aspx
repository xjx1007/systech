                                                        ...
                                                        <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="出库单号" SortExpression="KWD_Custmoer">
                                                                    <ItemTemplate>
                                                                        <a href="/Web/SalesOut/Sales_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>"
                                                                            target="_self">
                                                                ...
                                                                <asp:TemplateField HeaderText="发货单" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="center"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <a href="#" onclick="javascript:window.open('/Web/Xs/SalesOut/Sales_ShipWareOut_Print.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "KWD_ShipNo")%>&DID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');">
                                                                ...
                                                                <asp:TemplateField HeaderText="查看" HeaderStyle-Font-Size="12px" ItemStyle-Width="28px"
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <a href="#" onclick="javascript:window.open('/Web/Xs/SalesOut/Xs_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');">
