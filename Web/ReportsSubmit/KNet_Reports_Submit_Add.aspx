...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="KNet_Reports_Submit_List.aspx">报表上传</a>
                                ...
                                <table border="0" cellspacing="3" cellpadding="3" width="100%" class="dvtContentSpace">
                                    ...
                                    <tr>
                                        <td class="dvtCellInfo" colspan="4">
                                            <asp:LinkButton ID="Lbl_Spce" runat="server" OnClick="Lbl_Spce_Click"></asp:LinkButton>
                                            <asp:TextBox runat="server" CssClass="Custom_Hidden" ID="Tbx_Type"></asp:TextBox></td>

                                    </tr>
                                    <tr>
                                        <td class="dvtCellInfo" colspan="4">
                                            <asp:LinkButton ID="Lbl_Spce1" runat="server" OnClick="Lbl_Spce1_Click"></asp:LinkButton><asp:TextBox runat="server" CssClass="Custom_Hidden" ID="Tbx_Type1"></asp:TextBox></td>

                                    </tr>
                                    <tr>
                                        <td class="dvtCellInfo" colspan="4">
                                            <asp:LinkButton ID="Lbl_Spce2" runat="server" OnClick="Lbl_Spce2_Click"></asp:LinkButton>
                                            <asp:TextBox runat="server" CssClass="Custom_Hidden" ID="Tbx_Type2"></asp:TextBox>
        ...
        <input id="button" type="button" value="上传文档" runat="server" class="crmbutton small create" onserverclick="button_ServerClick" causesvalidation="false" style="width: 85px; height: 19px" />
                                        </td>
                                    </tr>
