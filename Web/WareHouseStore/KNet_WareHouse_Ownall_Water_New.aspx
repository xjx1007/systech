<%@ Page Language="C#"  enableEventValidation="false"   viewStateEncryptionMode="Never"   CodeFile="KNet_WareHouse_Ownall_Water_New.aspx.cs"
    Inherits="KNet_WareHouse_Ownall_Water_New1" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>库存 > <a class="hdrLink" href="KNet_WareHouse_Ownall_Water_New.aspx">库存流水帐</a>
                </td>
                <td width="100%" nowrap>
            ...
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            <!-- Buttons -->
                            <td style="padding-right: 20px" align="left" colspan="2" nowrap>查看范围:
                                <asp:DropDownList ID="WaterTypeDropDownList" runat="server" Width="160px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                            ...
                            <td width="85%" align="left" valign="top" style="border-left: 2px dashed #cccccc;">
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="true" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="150px" SortExpression="HouseNo" HeaderText="仓库名称"
                                        ...
                                        <asp:BoundField DataField="DirectInAmount" HeaderText="数量" SortExpression="DirectInAmount" DataFormatString="{0:F0}">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" Width="50px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
