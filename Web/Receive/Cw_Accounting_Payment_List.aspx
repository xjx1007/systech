                    ...
                    <tr>
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                PageSize="8" Width="100%" OnRowDataBound="GridView1_DataRowBinding">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="客户" SortExpression="CAP_CustomerValue" ItemStyle-HorizontalAlign="left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%#base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "CAP_CustomerValue").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="产品" SortExpression="CAP_CustomerValue" ItemStyle-HorizontalAlign="left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="付款方式" SortExpression="CAP_Payment" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center" ItemStyle-Width="130px">
                                        <ItemTemplate>
                                            <%#base.Base_GetBasicCodeName("104", DataBinder.Eval(Container.DataItem, "CAP_Payment").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="开票状态" SortExpression="v_State" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                                    <a href="../Bill/Cw_Account_Bill_Add.aspx?ReceiveID=<%#DataBinder.Eval(Container.DataItem, "CAP_ID").ToString() %>" class="webMnu" target="_blank"><%#base.Base_GetBasicCodeName("210", DataBinder.Eval(Container.DataItem, "v_State").ToString())%></a>
