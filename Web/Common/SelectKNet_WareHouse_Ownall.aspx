<%@ Page Language="C#" AutoEventWireup="true"   CodeFile="SelectKNet_WareHouse_Ownall.aspx.cs" Inherits="Knet_Common_SelectKNet_WareHouse_Ownall" %>
...
<%--     <asp:TemplateField HeaderText="库存量" SortExpression="StorageVolume" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-Width="60px"   ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <ItemTemplate>
                <asp:TextBox ID="OrderAmounttxt" runat="server" CssClass="Boxx" Width="40px" Text='<%# DataBinder.Eval(Container.DataItem,"WareHouseAmount")%>'></asp:TextBox>
          </ItemTemplate>
      </asp:TemplateField>--%>
...
<!--底部功能栏-->
   <asp:GridView ID="GridView2" runat="server" GridLines="None" Width="100%"  ItemStyle-Height="25px" HorizontalAlign="center" AutoGenerateColumns="false">
      ...
      <asp:TemplateField HeaderText="数量" SortExpression="DirectOutAmount" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue"   ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">

          <ItemTemplate>
              <asp:Label ID="Labddfgdel1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DirectOutAmount")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
