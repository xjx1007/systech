<%@ Page Language="C#" AutoEventWireup="true"   CodeFile="SelectProductsDictionaryDirectInto.aspx.cs" Inherits="Knet_Common_SelectProductsDictionaryDirectInto" %>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="150" background="../../images/ktxt1.gif" style="background-color:#F5F5F5; height:28px; width:130px;padding-left:20px;"><div class="TP2">入库产品选择</div></td>
    <td  align="left"  background="../../images/ktxt2.gif" style="background-color:#F5F5F5; height:28px;">&nbsp;&nbsp;<font color="blue">提示:</font><font color="#999999">选择产品后，点确定添加到入库明细中，再修改其价格与数量.</font></td>
...
<!--GridView-->
       ...
       <asp:TemplateField ItemStyle-Width="40px" ItemStyle-Height="25px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="left">
        ...
        <asp:TemplateField HeaderText="大类名称"  SortExpression="ProductsMainCategory" HeaderStyle-Font-Size="12px"    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
         ...
         <asp:BoundField  DataField="ProductsSellingPrice" ItemStyle-Font-Size="12px"  ItemStyle-ForeColor="blue"  HeaderText="厂家建议售价" ItemStyle-Width="90px"   HeaderStyle-Font-Size="12px"   SortExpression="ProductsSellingPrice" DataFormatString="{0:c}" HtmlEncode="false">
            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
            <HeaderStyle  HorizontalAlign="Left" Font-Size="12px" />
        </asp:BoundField> 
...
<!--底部功能栏-->
   ...
   <asp:GridView ID="GridView2" runat="server" GridLines="None" Width="100%"  ItemStyle-Height="25px" HorizontalAlign="center" AutoGenerateColumns="false">
      ...
      <asp:TemplateField HeaderText="数量" SortExpression="DirectInAmount" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue"   ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">

          <ItemTemplate>
              <asp:Label ID="Labddfgdel1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"DirectInAmount")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
