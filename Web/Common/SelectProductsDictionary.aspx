<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectProductsDictionary.aspx.cs" Inherits="Knet_Common_SelectProductsDictionary" %>
            ...
            <table height="22" border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
                <tr>
                    <td width="90" align="center">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="Div11" Width="90px" Height="21px" Font-Size="14px">供应商报价</asp:HyperLink></td>
                    <td width="4" align="center"></td>

                    <td width="90" align="center">
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="Div22" Width="90px" Height="21px" Font-Size="14px" Font-Bold="true" ForeColor="MintCream">产品字典库</asp:HyperLink></td>
                    <td width="4" align="center"></td>
                    ...
                    <td>
                        ...
                        <asp:GridView ID="GridView2" runat="server" GridLines="None" Width="100%" ItemStyle-Height="25px" HorizontalAlign="center" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="数量" SortExpression="OrderAmount" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">

                                    <ItemTemplate>
                                        <asp:Label ID="Labddfgdel1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"OrderAmount")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
