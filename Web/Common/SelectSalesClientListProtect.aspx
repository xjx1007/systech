<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectSalesClientListProtect.aspx.cs" Inherits="Knet_Common_SelectSalesClientListProtect" %>
            ...
            <table height="22" border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
                <tr>
                    <td width="90" align="center">
                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="Div22" Width="90px" Height="21px" Font-Size="14px" Font-Bold="true" ForeColor="MintCream">保护客户</asp:HyperLink></td>
                    <td width="4" align="center"></td>

                    <td width="90" align="center">
                        <asp:HyperLink ID="HyperLink1" runat="server" CssClass="Div11" Width="90px" Height="21px" Font-Size="14px">普通客户</asp:HyperLink></td>
                    <td width="4" align="center"></td>
                    <td align="right">&nbsp;&nbsp;</td>
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top: 1px solid #A3B2CC;">
                            <tr>
                                ...
                                <td width="39%" align="right">
                                    <select id="sheng" style="width: 90px" runat="server" onchange="changsheng(this.value)">
                                        <option value="0">选择省份</option>
                                    </select>&nbsp;<select id="city" runat="server" style="width: 100px"><option value="0">--选择城区--</option>
                                    </select></td>
                                <td width="7%" align="left">
                                    <asp:Button ID="Button4" runat="server" Text="筛选" CssClass="Btt" OnClick="Button12_Click1" /></td>
                            </tr>
                        </table>
                        <!--底部功能栏-->
