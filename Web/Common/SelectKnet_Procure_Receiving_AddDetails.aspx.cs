...
/// 选择采购单产品明细
/// </summary>
public partial class Knet_Common_SelectKnet_Procure_Receiving_AddDetails : System.Web.UI.Page
{
            ...
            if (Request.QueryString["OrderNo"] != null && Request.QueryString["OrderNo"] != "")
            {
                ...
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                    ...
                    if (cb.Checked == true)
                    {
                        ...
                        int RecingProductNum = int.Parse(obj2.Text.ToString()); //收货数量
                        ...
                        //更新采购单为 “收货中”
                        string DoSqlOrder = " update Knet_Procure_OrdersList set OrderState=3 where OrderNo='" + KnetOrderNo + "'";
                ...
                else
                {
                    ...
                    LogAM.Add_Logs("采购入库--->采购收货--->添加收货单明细记录 操作成功！");
    ...
    {
        KNet.BLL.Knet_Procure_ReceivingList_Details BLL = new KNet.BLL.Knet_Procure_ReceivingList_Details();
        KNet.Model.Knet_Procure_ReceivingList_Details model = new KNet.Model.Knet_Procure_ReceivingList_Details();

        model.ReceivNo = ReceivNo;
        ...
        model.ReceivAmount = ReceivAmount;
        model.ReceivUnitPrice = ReceivUnitPrice;
        model.ReceivRemarks = ReceivRemarks;

        model.ReceivDiscount = ReceivDiscount;
        model.ReceivTotalNet = ReceivTotalNet;
        ...
        try
        {
            ...
            {
                string Dosql = "UPDATE Knet_Procure_ReceivingList_Details set ReceivAmount=ReceivAmount+" + ReceivAmount + ",ReceivDiscount=ReceivDiscount+" + ReceivDiscount + ",ReceivTotalNet=ReceivTotalNet+" + ReceivTotalNet + " where ProductsBarCode='" + ProductsBarCode + "' and  ReceivNo='" + ReceivNo + "' ";
