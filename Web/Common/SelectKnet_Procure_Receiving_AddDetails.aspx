<%@ Page Language="C#" EnableEventValidation="false"  ValidateRequest="false" AutoEventWireup="true" CodeFile="SelectKnet_Procure_Receiving_AddDetails.aspx.cs" Inherits="Knet_Common_SelectKnet_Procure_Receiving_AddDetails" %>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="150" background="../../images/ktxt1.gif" style="background-color:#F5F5F5; height:28px; width:130px;padding-left:20px;"><div class="TP2">选择收货明细</div></td>
    <td  background="../../images/ktxt2.gif" >&nbsp;<font color="blue">提示:</font><font color="#999999">点击左边<img src="../../images/up.jpg" width="20" height="20" /> 可把采购单往上收缩方便查看明细，点 <img src="../../images/down.jpg" width="20" height="20" />可把采购单向下展开...</font>&nbsp;</td>
...
<table width="99%" border="0" align="center" cellpadding="1" cellspacing="1">
 ...
 <tr>
        <td width="17%" height="25" align="right" class="tableBotcss"><asp:ImageButton ID="ImageButton_down" runat="server" ImageUrl="../../images/down.jpg"  Visible="false"  CausesValidation="false" OnClick="ImageButton_down_Click"  /><asp:ImageButton ID="ImageButton_up" runat="server" ImageUrl="../../images/up.jpg"  OnClick="ImageButton_up_Click"  CausesValidation="false" />&nbsp;采购单号:</td>
        <td width="36%" align="left" class="tableBotcss"><asp:Label ID="OrderNo1" runat="server" ></asp:Label></td>
        <td width="14%" align="right" class="tableBotcss">采购主题:</td>
        <td width="33%" align="left" class="tableBotcss"><asp:Label ID="OrderTopic1" runat="server" ></asp:Label></td>
      </tr>
	        <tr>
        <td width="17%" height="25" align="right" class="tableBotcss">采购日期:</td>
        <td width="36%" align="left" class="tableBotcss"><asp:Label ID="OrderDateTime1" runat="server" ></asp:Label></td>
        <td width="14%" align="right" class="tableBotcss">预到日期:</td>
        <td width="33%" align="left" class="tableBotcss"><asp:Label ID="OrderPreToDate1" runat="server" ></asp:Label></td>
      </tr>
	  
	  
<tr  id="DShowA" runat="server" >
        <td width="17%" height="25" align="right" class="tableBotcss">供应商:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="SuppNo1" runat="server" ></asp:Label></td>
        <td align="right" class="tableBotcss">结算方式:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderPaymentNotes1" runat="server" ></asp:Label></td>
</tr>
      
<tr  id="DShowB" runat="server">
        <td width="17%" height="25" align="right" class="tableBotcss">公司:</td>
        <td align="left" class="tableBotcss">
		<asp:Label ID="OrderStaffBranch" runat="server" ></asp:Label></td>
        <td align="right" class="tableBotcss">采购部门:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderStaffDepart" runat="server" ></asp:Label></td>
</tr>
	  
<tr   id="DShowC" runat="server">
        <td width="17%" height="25" align="right" class="tableBotcss">运输分担:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderTransShare" runat="server" ></asp:Label></td>
        <td align="right" class="tableBotcss">采购类型:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderType" runat="server" ></asp:Label></td>
</tr>

<tr  id="DShowD" runat="server">
        <td height="25" align="right" class="tableBotcss">经办(开单)人:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderStaffNotxt" runat="server" ></asp:Label></td>
        <td align="right" class="tableBotcss">审核人:</td>
        <td align="left" class="tableBotcss"><asp:Label ID="OrderCheckStaffNotxt" runat="server" ></asp:Label></td>
</tr>

<tr  id="DShowE" runat="server">
        <td height="25" align="right">备注说明:</td>
        <td colspan="3" align="left" valign="top" ><asp:Label ID="OrderRemarks" runat="server" ></asp:Label></td>
 </tr>
 </table>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" class="tablecss">
  ...
  <asp:GridView ID="GridView1" runat="server"  AllowSorting="True"  EmptyDataText="<div align=center><font color=Blue><br/><br/><B>暂时没有明细记录，或已收退货完成.</B><br/><br/></font></div>"  GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false"  ShowHeader="true"  HeaderStyle-Height="25px"
      ...
      <asp:BoundField  DataField="OrderAmount"   HeaderText="采购数量"  ItemStyle-ForeColor="blue"  SortExpression="OrderAmount" ReadOnly="true">
        ...
        <asp:TemplateField HeaderText="收货数量" SortExpression="thisNowAmount" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-Width="60px"   ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <ItemTemplate>
      ...
      <asp:BoundField  DataField="OrderHaveReceiving"   HeaderText="已收"  ItemStyle-ForeColor="blue"  SortExpression="OrderHaveReceiving" ReadOnly="true">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  Width="50px" />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
       </asp:BoundField>

       <asp:BoundField  DataField="OrderHasReturned"   HeaderText="已退" ItemStyle-ForeColor="red"   SortExpression="OrderHasReturned" ReadOnly="true">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  Width="50px" />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
       </asp:BoundField>
