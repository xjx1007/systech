...
<title>选择供应商采购报价</title><base target="_self" />
</head>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                报价 > <a class="hdrLink" href="SelectClientProductsList.aspx">选择产品报价</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" style="border-top:1px solid #A3B2CC;">
  <tr>
    <td width="25%" ><asp:Button ID="Button2" runat="server"  CssClass="crmbutton small save" Text="确定" OnClick="Button1_Click" style="width: 55px;height: 33px;"  />
