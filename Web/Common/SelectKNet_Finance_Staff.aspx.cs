...
/// 选择人员
/// </summary>
public partial class Knet_Common_SelectKNet_Finance_Staff : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                this.Button2.Attributes.Add("onclick", "return confirm('你确定要选择所选的人员吗?！')");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (cb.Checked == true)
            {
                ...
                StaffNo = GridView1.DataKeys[i].Value.ToString();
                KK = KK + 1;
            }
        }
        if (KK > 1)
        {
            Response.Write("<script language=javascript>alert('每次只能选择一个人员！');window.close();</script>");
            Response.End();
        }

        if (cal == "")
        {
            Response.Write("<script language=javascript>alert('您没有选择记录！\\n\\n注意:每次只能选择一个人员');window.close();</script>");
            Response.End();
        }
        else
        {
            ...
            else
            {
                ...
                s.Append("window.returnValue='" + StaffNo + "|" + GetStaffStaffName(StaffNo) + "';" + "\n");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SelectKNet_Finance_Staff.aspx?KSeachKey=" + Sekety + "&StaffBranch=" + StaffBranch + "&StaffDepart=" + StaffDepart + "");
        Response.End();
    }
    /// <summary>
    /// 按分公司筛选记录
    ...
    protected void StrucNameDList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SelectKNet_Finance_Staff.aspx?StaffBranch=" + StaffBranch + "");
        Response.End();
    }
    ...
    /// <param name="aa"></param>
    /// <returns></returns>
    protected string GetStaffStaffName(object aa)
    {
