<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectKNet_WareHouse_OwnallForContractList.aspx.cs" Inherits="Knet_Common_SelectKNet_WareHouse_OwnallForContractList" %>
        ...
        <div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="left" background="../../images/ktxt2.gif" style="background-color: #F5F5F5; height: 28px;">&nbsp;&nbsp;<font color="blue">提示:</font><font color="#999999">选择产品后，点确定添加到明细中.</font>&nbsp;&nbsp;&nbsp;<font color="blue">“调节金额”可为正或为负，当打折时为负，当加收税点时为正.</font></td>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
                <tr>
                    <td>
                        <!--GridView-->
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" EmptyDataText="<div align=center><font color=red><br/><br/><B>合同出货仓库没有找到相关产品记录，有必要请先从其它仓库调拨后再操作.</B><br/><br/></font></div>" GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false" ShowHeader="true" HeaderStyle-Height="25px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="数量" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-Width="60px" ControlStyle-Width="60px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="销售单价" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-Width="60px" ControlStyle-Width="70px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:TextBox ID="Contract_SalesUnitPrice" runat="server" CssClass="Boxx" Width="65px" Text='<%# GetProductsSellingPrice(DataBinder.Eval(Container.DataItem,"ProductsBarCode"),DataBinder.Eval(Container.DataItem,"HouseNo"))%>'></asp:TextBox><br />
                                        <asp:RequiredFieldValidator ID="ssmberas" runat="server" ErrorMessage="单价非空!" ControlToValidate="Contract_SalesUnitPrice" Display="Dynamic" ValidationGroup="88"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="salidator1" runat="server" ErrorMessage="货币形式.如 85.00" ControlToValidate="Contract_SalesUnitPrice" ValidationExpression="^(-)?(\d+|,\d{3})+(\.\d{0,3})?$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>



                                <asp:TemplateField HeaderText="调节金额" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-Width="70px" ControlStyle-Width="60px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <asp:TextBox ID="Contract_SalesDiscount" runat="server" CssClass="Boxx" Width="65px" Text="0.00"></asp:TextBox><br />
                                        <asp:RequiredFieldValidator ID="ssmbssseras" runat="server" ErrorMessage="非空值!" ControlToValidate="Contract_SalesDiscount" Display="Dynamic" ValidationGroup="88"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="sssgasdg" runat="server" ErrorMessage="货币形式.如 85.00" ControlToValidate="Contract_SalesDiscount" ValidationExpression="^(-)?(\d+|,\d{3})+(\.\d{0,3})?$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>


                                <asp:TemplateField HeaderText="厂家建议售价" SortExpression="ProductsBarCode" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <%# GetBaoPriceUnitPrice(DataBinder.Eval(Container.DataItem, "ProductsBarCode"))%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:GridView ID="GridView2" runat="server" GridLines="None" Width="100%" ItemStyle-Height="25px" HorizontalAlign="center" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="数量" SortExpression="ContractAmount" HeaderStyle-Font-Size="12px" HeaderStyle-ForeColor="blue" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Labddfgdel1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"ContractAmount")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
