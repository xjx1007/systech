        ...
        <div>
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="120" background="../../images/ktxt2.gif" style="background-color: #F5F5F5; height: 28px;" align="left">
                        <asp:Button
                    ...
                    <td>
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top: 1px solid #A3B2CC;">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="Ddl_isShip" runat="server" OnTextChanged="Ddl_isShip_TextChanged" AutoPostBack="true">
