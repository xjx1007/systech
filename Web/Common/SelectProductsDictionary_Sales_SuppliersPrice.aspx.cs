...
/// 选择供应商采购报价
/// </summary>
public partial class Knet_Common_SelectProductsDictionary_Sales_SuppliersPrice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                {
                    ViewState["SortOrder"] = "ProcureUpdateDateTime";
                    ...
                    this.KClaaBind(this.DropDownList1);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            string cal = "";
            string MyOrderNo = Request.QueryString["BaoPriceNo"].Trim();
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                if (cb.Checked == true)
                {
                    ...
                    //添加记录
                    this.AddToKNet_Sales_BaoPriceList_Details(MyOrderNo, model.ProductsName, model.ProductsBarCode, model.ProductsPattern, model.ProductsUnits, 1, decimal.Parse(model.Salesprice.ToString()), 0, decimal.Parse(model.Salesprice.ToString()), "");
            ...
            else
            {
                ...
                LogAM.Add_Logs("销售管理--->销售报价--->添加报价明细记录 操作成功！");
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("SelectProductsDictionary_Sales_SuppliersPrice.aspx?ProductsMainCategory=" + ProductsMainCategory + "&ProductsSmallCategory=" + ProductsSmallCategory + "&SeachKey=" + Seackey + "&SuppNo=" + Request.QueryString["SuppNo"].Trim() + "&Sn=" + DateTime.Now.ToFileTimeUtc().ToString() + "&BaoPriceNo=" + Request.QueryString["BaoPriceNo"] + "");
        Response.End();
    }
    ...
    {
        string SuppNo = this.DropDownList1.SelectedValue;

        if (SuppNo != "")
        {
            Response.Redirect("SelectProductsDictionary_Sales_SuppliersPrice.aspx?SuppNo=" + SuppNo + "&Sn=" + DateTime.Now.ToFileTimeUtc().ToString() + "&BaoPriceNo=" + Request.QueryString["BaoPriceNo"] + "");
            Response.End();
        }
