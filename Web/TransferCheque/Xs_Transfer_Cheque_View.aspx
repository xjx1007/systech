<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_Transfer_Cheque_View.aspx.cs" Inherits="Web_Xs_Transfer_Cheque_View" %>
                                ...
                                <table border="0" cellspacing="3" cellpadding="3" width="100%" class="dvtContentSpace">
                                    ...
                                    <tr>
                                        <td valign="top" align="left">
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <input title="编辑 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit" onclick="PageGo('Xs_Transfer_Cheque_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>    ')" name="Edit" value="&nbsp;编辑&nbsp;">&nbsp;
                                    <input title="共享" class="crmbutton small edit" onclick="" type="button" name="Share" value="&nbsp;共享&nbsp;">&nbsp;
                                    <input title="" class="crmbutton small edit" onclick="PageGo('Xs_Transfer_Cheque_List.aspx')" type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;</td>
                                                    <td align="right">
                                                        <input title="复制 [Alt+U]" type="button" accesskey="U" class="crmbutton small create" onclick="PageGo('Xs_Transfer_Cheque_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>    &Type=1')" name="Duplicate" value="复制">&nbsp;
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_UseName" runat="server"></asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_ChineseMoney" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="17%" class="dvtCellLabel">收款人:</td>
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_Payee" runat="server" Width="178px" ReadOnly="true"></asp:Label>
                                                    </td>
                                            ...
                                            <td  class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_Shen" runat="server"></asp:Label>
                                             </td>
                                            <td  class="dvtCellLabel" >市:</td>
                                            <td  class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_Shi" runat="server"></asp:Label>
                                                 </td>
                                        </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_BillType" runat="server"></asp:Label>
                                                    </td>
                                                    <td class="dvtCellLabel">票据张数:</td>
                                                    <td class="dvtCellInfo">
                                                        <asp:Label ID="Lbl_BillNumber" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
