                ...
                <table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0"   >
                            ...
                            <tr>
                                ...
                                <td width=22% valign=top style="border-left:2px dashed #cccccc;padding:13px" rowspan="2">
                                    ...
                                    <a href="../CustomerContent/Xs_Sales_Content_Add.aspx?CustomerValue=<%=s_CustomerValue %>&LinkMan=<%=s_LinkMan %>&OppID=<%=s_OppID %>" class="webMnu">创建联系记录</a> 
                                    </td>
                                    </tr>
                                    <tr>
                                    <td align="left" style="padding-left:10px;">
                                    <img src="../../themes/softed/images/pointer.gif" hspace="5" align="middle"/>
                                    <a href="../SalesQuotes/Xs_Sales_Quotes_Add.aspx?OppID=<%=s_ID %>" class="webMnu">创建报价单</a> 
                                    </td>
                                    </tr>
