<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Fright.aspx.cs"
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "合格供应商名录");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("合格供应商名录.xls");		
	};	       
    </script>
