...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var Year = document.all('Tbx_Year').value;
            var OrderType = document.all('OrderType').value;
            
            var s_URL = 'List_Order.aspx?';
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                    采购报表 > <a class="hdrLink" href="Report_Order.aspx">供应商月采购金额</a>
                </td>
                <td width="100%" nowrap>
                </td>
            </tr>
                                ...
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <asp:TextBox ID="Tbx_Year" CssClass="detailedViewTextBox" Width="200px" OnFocus="this.className='detailedViewTextBoxOn'"
                                                    OnBlur="this.className='detailedViewTextBox'" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                            <tr>
