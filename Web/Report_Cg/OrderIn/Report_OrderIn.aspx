...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var QRState = document.all('Ddl_State').value;
            var HouseNo = document.all('HouseNo').value;
            var Check = document.all('Ddl_Check').value;
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                采购入库明细 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">采购入库明细</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="dvtCellInfo" align="left">
                                            <asp:DropDownList ID="Ddl_State" runat="server">
                                                ...
                                                <asp:ListItem Text="3天以上未确认" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="dvtCellInfo" align="left">
                                            <asp:DropDownList ID="Ddl_Check" runat="server">
                                                <asp:ListItem Text="请选择" Value=""></asp:ListItem>
                                                <asp:ListItem Text="未对账" Value="0"></asp:ListItem>
