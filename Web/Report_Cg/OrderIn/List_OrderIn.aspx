<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_OrderIn.aspx.cs"
    Inherits="Web_List_OrderIn" %>
...
<head id="Head1" runat="server">
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "采购入库明细");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("采购入库明细.xls");
	};
    </script>
...
<body>
    ...
    <div>
        ...
        <input type="button" value="导出Excel" runat="server" OnServerClick="Button2_OnServerClick"  id="Button2" /><%--onclick="javascript:OutToFileMoreSheet()"--%>
