...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var ProductsPattern = document.all('Tbx_ProductsPattern').value;
            var ProductsName = document.all('Tbx_ProductsName').value;

            var s_URL = 'List_ProductsList.aspx?';
            s_URL += 'ProductsType=' + ProductsType + '';
            s_URL += '&ProductsEidition=' + ProductsEidition + '';
            s_URL += '&ProductsPattern=' + ProductsPattern + '';
            s_URL += '&ProductsName=' + ProductsName + '';
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>采购报表 > <a href="Report_Kc.aspx">产品明细</a></td>
                                    ...
                                    <td align="right" valign="top">
                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" class="dvtCellLabel">产品名称：
                                                </td>
                                                <td align="left" class="dvtCellInfo">
                                                    <asp:TextBox ID="Tbx_ProductsName" runat="server" CssClass="detailedViewTextBox"
                                                        OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"
                                                        MaxLength="48" Width="200px"></asp:TextBox>
                                                </td>
                                            </tr>
