<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_Fright.aspx.cs" Inherits="Report_Fright" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'List_Fright.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                采购报表 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">运费承担明细</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
