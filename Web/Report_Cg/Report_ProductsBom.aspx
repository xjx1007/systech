<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_ProductsBom.aspx.cs" Inherits="Web_Report_Xs_Report_ProductsBom" %>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss_add">
                ...
                <tr>
                    ...
                    <td align="left" class="tableBotcss1">
                        <asp:TextBox ID="Tbx_Pattern" runat="Server"></asp:TextBox></td>
                </tr>
                <tr>
                    <td width="17%" height="25" align="right" class="tableBotcss">产品版本:</td>
                    <td align="left" class="tableBotcss">
                        <asp:TextBox ID="Tbx_Edition" runat="Server"></asp:TextBox></td>
                    <td align="right" class="tableBotcss">产品分类:</td>
                    <td align="left" class="tableBotcss1">
                        <asp:DropDownList ID="ProductsMainCategory" runat="server" Width="150px"></asp:DropDownList></td>
                </tr>
                <tr>
