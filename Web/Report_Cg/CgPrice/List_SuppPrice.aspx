<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_SuppPrice.aspx.cs" Inherits="Web_List_SuppPrice" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "供应商报价单");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("供应商报价单.xls");
        };
    </script>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link rel="stylesheet" href="../css/Report_j.css" type="text/css" />
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" id="tMater" class="pTable">
                <tr>
                    <td align="center"><font size="6"><b>供应商报价单</b></font></td>
                </tr>
                <tr>
                    <td>
