...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'List_SuppPrice.aspx?SuppNoValue=' + SuppNoValue + '';
            s_URL += '&ProductsEidition=' + ProductsEidition + '';
            s_URL += '&ProductsType=' + ProductsType + '';
            s_URL += '&State=' + State + '';
            s_URL += '&StartDate=' + StartDate + '';
            s_URL += '&EndDate=' + EndDate + '';
    ...
    <div>
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                采购报表 > <a class="hdrLink" href="Report_SuppPrice.aspx">供应商报价表</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" class="dvtCellInfo">
                                                <asp:DropDownList runat="server" ID="Ddl_State">
                                                    <asp:ListItem Value="0" >正在使用</asp:ListItem>
                                                    <asp:ListItem Value="" >所有历史</asp:ListItem>   
