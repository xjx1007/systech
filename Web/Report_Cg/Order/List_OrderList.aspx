<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_OrderList.aspx.cs" Inherits="Web_Report_CG_List_OrderList" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "杭州士腾订单明细表");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("杭州士腾订单明细表.xls");
        };
    </script>
