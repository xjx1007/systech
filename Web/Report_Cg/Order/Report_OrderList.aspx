<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_OrderList.aspx.cs"
    Inherits="Web_Report_CG_Report_OrderList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var RkState = document.all('Ddl_RkState').value;

            var OEMOrderNo = document.all('OEMOrderNo').value;
            
            var s_URL = 'List_OrderList.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
            ...
            s_URL += '&RkState=' + RkState + '';
            s_URL += '&OEMOrderNo=' + OEMOrderNo + '';
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                    采购报表 > <a class="hdrLink" href="Report_Order.aspx">采购订单明细</a>
                </td>
                <td width="100%" nowrap>
                </td>
            </tr>
                                ...
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <asp:DropDownList runat="server" ID="Ddl_RkState">
                                                    <asp:ListItem Value="">--请选择--</asp:ListItem>
                                                    <asp:ListItem Value="0">未入库</asp:ListItem>
                                                    <asp:ListItem Value="1">已入库</asp:ListItem>
                                                    <asp:ListItem Value="2">部分入库</asp:ListItem>
                                                    <asp:ListItem Value="3">未完全入库</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <asp:TextBox ID="OEMOrderNo" CssClass="detailedViewTextBox" Width="200px"
                                                    OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"
                                                    runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
