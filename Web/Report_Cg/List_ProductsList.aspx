<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_ProductsList.aspx.cs" Inherits="Web_Report_Xs_List_ProductsList" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet(){
		...
		LODOP.SET_SAVE_MODE("Caption","产品明细");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("产品明细.xls");		
	};	       
</script> 
