<%@ Page Language="C#" AutoEventWireup="true" CodeFile="feedback_List.aspx.cs" Inherits="Web_feedback_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('feedback_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 问题反馈..." title="创建 问题反馈..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 问题反馈..." title="查找 问题反馈..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 问题反馈" title="*导入 问题反馈"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 问题反馈" title="*导出 问题反馈"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
        <tr>
            <td>
                <%=base.Base_BindView("PB_Basic_Feedback", "feedback_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="编码" SortExpression="PBF_ID" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <a href="feedback_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBF_ID") %>">
                                                <%# DataBinder.Eval(Container.DataItem, "PBF_Code").ToString()%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="联系人" SortExpression="PBF_ContentPerson" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PBF_ContentPerson").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="问题类型" SortExpression="PBF_Type" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# base.Base_GetBasicCodeName("148", DataBinder.Eval(Container.DataItem, "PBF_Type").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="问题反馈简介" SortExpression="PBF_Details" ItemStyle-HorizontalAlign="left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%#GetDetails(DataBinder.Eval(Container.DataItem, "PBF_Details").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="创建人" SortExpression="PBF_Creator" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PBF_Creator").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="创建时间" DataField="PBF_CTime" SortExpression="PBF_CTime">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <a href="feedback_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBF_ID") %>">
