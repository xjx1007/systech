<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectContractProducts.aspx.cs" Inherits="SelectContractProducts" %>
                    ...
                    <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="true" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="产品名称" ItemStyle-Height="25px" ItemStyle-HorizontalAlign="Left"
                                ...
                                <ItemTemplate>
                                    <%# GetLink(DataBinder.Eval(Container.DataItem, "ID").ToString(), DataBinder.Eval(Container.DataItem, "ProductsBarCode").ToString(), DataBinder.Eval(Container.DataItem, "Contract_SalesUnitPrice").ToString(), DataBinder.Eval(Container.DataItem, "ContractAmount").ToString())%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="ContractNo" HeaderText="合同编号" SortExpression="ContractNo">
                            ...
                            <asp:BoundField DataField="ContractAmount" HeaderText="订单数量" SortExpression="ContractAmount">
                                <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Vs_SalesShipNumber" HeaderText="发货数量" SortExpression="ContractAmount">
                                <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="vs_Leftnumber" HeaderText="剩余数量" SortExpression="ContractAmount">
                                <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="Contract_SalesUnitPrice" HeaderText="单价" SortExpression="Contract_SalesUnitPrice">
                                <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                            </asp:BoundField>
                        </Columns>
