...
public partial class CG_Payment_For_List : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        {
            //仅自己查看
            if (AM.YNAuthority("查看全部费用报销") == false)
            {
    ...
    public string getShState(string s_ID)
    {
        using (SqlConnection conn = DBClass.GetConnection("KNetERP"))
        {
            ...
            AdminloginMess AM = new AdminloginMess();
            conn.Open();
            string Dostr = "select CPF_State from CG_Payment_For where CPF_ID='" + s_ID + "'";
