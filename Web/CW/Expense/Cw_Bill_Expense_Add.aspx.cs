    ...
    protected void Btn_SaveOnClick(object sender, EventArgs e)
    {
        ...
        if (s_ID == "")//新增
        {
            try
            {
                ...
                base.Base_SendMessage(base.Base_GetDeptPerson("供应链平台（物料部/仓库管理）", 1), "用款申请审批： <a href='Web/CG/Payment/CG_Payment_For_View.aspx?ID=" + this.Tbx_ID.Text + "'  target=\"_blank\" onclick='RemoveSms('#ID', '', 0);'> " + model.CPF_Used + "</a> 需要你审批！ ");
