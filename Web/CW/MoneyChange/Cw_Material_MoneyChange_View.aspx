<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cw_Material_MoneyChange_View.aspx.cs"
    Inherits="Web_Cw_Material_MoneyChange_View" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                财务 > <a class="hdrLink" href="Cw_Material_MoneyChange_List.aspx">原材料调整单</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td>
                                                    <input title="编辑 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit"
                                                        onclick="PageGo('Cw_Material_MoneyChange_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>')"
                                                        name="Edit" value="&nbsp;编辑&nbsp;">&nbsp;
                                                    <input title="共享" class="crmbutton small edit" onclick="" type="button" name="Share"
                                                        value="&nbsp;共享&nbsp;">&nbsp;
                                                    <input title="" class="crmbutton small edit" onclick="PageGo('Cw_Material_MoneyChange_List.aspx')"
                                                ...
                                                <td align="right">&nbsp;<input title="复制 [Alt+U]" type="button" accesskey="U" class="crmbutton small create"
                                                        onclick="PageGo('Cw_Material_MoneyChange_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>&Type=1')"
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                            ...
                                            <tr>
                                                ...
                                                <td class="dvtCellInfo">
                                                    <asp:Label ID="Lbl_STime" runat="server" Width="200px" ReadOnly="true"></asp:Label>&nbsp;
                                                </td>
                                                <td width="17%" class="dvtCellLabel">
                                                    金额:
                                                </td>
                                                <td class="dvtCellInfo" >
                                                    <asp:Label ID="Lbl_Money" runat="server" Width="200px" ReadOnly="true"></asp:Label>&nbsp;
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="detailedViewHeader">
