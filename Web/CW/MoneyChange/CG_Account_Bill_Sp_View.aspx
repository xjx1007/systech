<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_Account_Bill_Sp_View.aspx.cs"
    Inherits="CG_Account_Bill_Sp_View" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>采购 > <a class="hdrLink" href="CG_Account_Bill_List.aspx">发票审批</a>
                </td>
                <td width="100%" nowrap>
                            ...
                            <td style="height: 44px">
                                <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                    <tr>
                                        ...
                                        <td class="dvtSelectedCell" align="center" nowrap>发票审批信息
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    <td class="dvtCellLabel" width="15%">编号:
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="17%" class="dvtCellLabel">对账单号:
                                                    </td>
                                                    <td class="dvtCellInfo">
