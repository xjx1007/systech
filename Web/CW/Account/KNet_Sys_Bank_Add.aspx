<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_Sys_Bank_Add.aspx.cs" Inherits="KNet_Sys_Bank_Add" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="CG_Payment_For_List.aspx">银行账号</a>
                </td>
                <td width="100%" nowrap>
                            ...
                            <td style="height: 44px">
                                <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                    <tr>
                                        ...
                                        <td class="dvtSelectedCell" align="center" nowrap>银行账号信息</td>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    <td class="dvtCellLabel">初始化日期:</td>
                                                    <td class="dvtCellInfo">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="申请日期不能为空"
                                                ControlToValidate="Tbx_STime" Display="Dynamic"></asp:RequiredFieldValidator>
                                                    ...
                                                    <td class="dvtCellLabel">初始化金额:</td>
                                                    <td class="dvtCellInfo">
