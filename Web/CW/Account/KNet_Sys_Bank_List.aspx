<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_Sys_Bank_List.aspx.cs" Inherits="KNet_Sys_Bank_List" %>
...
<script language="javascript" type="text/javascript" src="/include/scriptaculous/dom-drag.js"></script>
    <script type="text/javascript" >
        function GPrint(ID) {
            ...
            var temp = window.showModalDialog("KNet_Sys_Bank_Print.aspx?ID=" + ID + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="KNet_Sys_Bank_List.aspx">银行账户</a>
                </td>
                <td width="100%" nowrap>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('KNet_Sys_Bank_Add.aspx')">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
            <tr>
                <td>
                    <%=base.Base_BindView("KNet_Sys_Bank", "KNet_Sys_Bank_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                                    ...
                                    <tr>
                                        <td align="left" width="40%">
                                            <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("KNet_Sys_Bank")%>    ','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到记录</B><br/><br/></font></div>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="名称" SortExpression="CPF_ID" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="KNet_Sys_Bank_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID") %>"><%# DataBinder.Eval(Container.DataItem, "BankName") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:BoundField HeaderText="账号" DataField="BankCount" SortExpression="BankCount">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="账号初始化金额" DataField="InitialAmount" SortExpression="InitialAmount">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="账号初始化日期" DataField="KSB_STime" SortExpression="KSB_STime">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="KNet_Sys_Bank_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID") %>">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="/images/Edit.gif" border="0" ToolTip="修改" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="转账" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="CW_Bank_Bill_Add.aspx?BankNo=<%# DataBinder.Eval(Container.DataItem, "BankNo") %>">
                                                    转账</a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
