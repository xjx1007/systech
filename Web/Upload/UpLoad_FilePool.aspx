<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpLoad_FilePool.aspx.cs" Inherits="Web_Upload_UpLoad_FilePool" %>
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top: 1px solid #A3B2CC;">
                            <tr>
                                <td height="30" width="58%">
                                    <asp:TextBox runat="server" ID="Tbx_ID" CssClass="Custom_Hidden"></asp:TextBox>&nbsp;<asp:Button ID="Button2" runat="server" OnClick="Button2_OnClick" CssClass="crmbutton small save" Text="确定选择" Style="width: 70px; height: 33px;" />
