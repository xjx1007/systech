...
<head>
    ...
    <script type="text/javascript">
        function setabc() {
            document.getElementById("uploadFile1").value = document.getElementById("uploadFile").value;
        }
    </script>
</head>
<body marginheight="0" marginwidth="0" leftmargin="0" rightmargin="0" bottommargin="0"
    ...
    <form method="post" runat="server">
        <table border="0" cellspacing="0" cellpadding="5" width="100%" class="layerHeadingULine">
            <tr>
                <td class="layerPopupHeading" align="left">添加附件
                </td>
        ...
        <table border="0" cellspacing="0" cellpadding="5" width="100%" class="layerPopupTransport">
            <tr>
                <td colspan="2" align="center">
                    <asp:Button ID="save" runat="server" Text="上传" CssClass="crmbutton small save" OnClick="save_Click" Width="55px" Height="33px" />&nbsp;&nbsp;
