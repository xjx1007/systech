<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_ShipList.aspx.cs" Inherits="Web_Report_Xs_List_ShipList" %>
...
.gg{background-color:#dee2f2}
	...
	function OutToFileMoreSheet(){
		...
		LODOP.SET_SAVE_MODE("Caption","销售出库明细");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("销售发货明细.xls");		
	};	       
</script> 
...
<body>
    ...
    <table  width=100% cellspacing=0 cellpadding=0 ID=tMater class=pTable>
    	<tr>
    		<td align="center"><font size="6"><b>销售发货明细</b></font></td>
    	</tr>
    	<tr><td>
