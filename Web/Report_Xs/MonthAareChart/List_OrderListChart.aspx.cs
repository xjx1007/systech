...
public partial class Web_Report_Xs_List_OrderList : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (s_Type == "1")
            {
                s_Sql += " cast(Sum(case when d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 天津,";
                s_Sql += " cast(Sum(case when d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 广东,";
                s_Sql += " cast(Sum(case when f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 福建,";
                s_Sql += " cast(Sum(case when d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 河北,";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000'  or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 浙江, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 江苏, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or f.CustomerName like '%湖北%' or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 湖北, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or f.CustomerName like '%湖北%' or f.CustomerName like '%北京%'  or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  DirectOutAmount else 0 end)/10000.0 as decimal(18,2)) as 北京 ";
            }
            else
            {

                s_Sql += " cast(Sum(case when d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 天津,";
                s_Sql += " cast(Sum(case when d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 广东,";
                s_Sql += " cast(Sum(case when f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 福建,";
                s_Sql += " cast(Sum(case when d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 河北,";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 浙江, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 江苏, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or f.CustomerName like '%湖北%' or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 湖北, ";
                s_Sql += " cast(Sum(case when  f.CustomerProvinces='330000' or f.CustomerName like '%湖北%' or f.CustomerName like '%北京%'  or ( f.CustomerName like '%江苏%'  and  f.CustomerValue<>'101141' ) or d.ProductsEdition like '%河北%' or  f.CustomerName like '%福建%' or d.ProductsEdition like '%广东%' or d.ProductsEdition like '%天津%' then  KWD_SalesTotalNet else 0 end)/10000.0 as decimal(18,2)) as 北京 ";
            }
            ...
            if (Dts_Table.Tables[0].Rows.Count > 0)
            {
                ...
                s_Detail += "<td class=\"ListHead\">天津</td>";
                s_Detail += "<td class=\"ListHead\">广东</td>";
                s_Detail += "<td class=\"ListHead\">福建</td>";
                s_Detail += "<td class=\"ListHead\">河北</td>";
                s_Detail += "<td class=\"ListHead\">浙江</td>";
                s_Detail += "<td class=\"ListHead\">江苏</td>";
                s_Detail += "<td class=\"ListHead\">河北</td>";
                s_Detail += "<td class=\"ListHead\">北京</td>";
                s_Detail += "<td class=\"ListHead\">合计</td>";
                s_Detail += "</tr>";
                decimal d_TotalNum = 0, d_TotalNet = 0;
                decimal[] d_TotalNums = new decimal[9];
                for (int i = 0; i < 9; i++)
                {
                    d_TotalNums[i] = 0;
                }
                for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
                {
                    ...
                    decimal d_LeftNumber4 = decimal.Parse(Dts_Table.Tables[0].Rows[i][6].ToString()) - decimal.Parse(Dts_Table.Tables[0].Rows[i][5].ToString());
                    s_Detail += "<td class=\"ListHeadDetails\">" + d_LeftNumber4 + "</td>";

                    decimal d_LeftNumber5 = decimal.Parse(Dts_Table.Tables[0].Rows[i][7].ToString()) - decimal.Parse(Dts_Table.Tables[0].Rows[i][6].ToString());
                    s_Detail += "<td class=\"ListHeadDetails\">" + d_LeftNumber5 + "</td>";

                    decimal d_LeftNumber6 = decimal.Parse(Dts_Table.Tables[0].Rows[i][8].ToString()) - decimal.Parse(Dts_Table.Tables[0].Rows[i][7].ToString());
                    s_Detail += "<td class=\"ListHeadDetails\">" + d_LeftNumber6 + "</td>";

                    d_TotalNum +=  decimal.Parse(Dts_Table.Tables[0].Rows[i][8].ToString());
                    ...
                    d_TotalNums[5] += d_LeftNumber4;
                    d_TotalNums[6] += d_LeftNumber5;
                    d_TotalNums[7] += d_LeftNumber6;
                    d_TotalNums[8] += d_TotalNum;
                ...
                s_Detail += "<td class=\"ListHeadDetails\">" + d_TotalNums[6] + "</td>";
                s_Detail += "<td class=\"ListHeadDetails\">" + d_TotalNums[7] + "</td>";
                s_Detail += "<td class=\"ListHeadDetails\">" + d_TotalNums[8] + "</td>";
                s_Detail += "</tr>";
                s_Detail += "</table>";
