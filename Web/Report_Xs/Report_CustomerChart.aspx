<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_CustomerChart.aspx.cs" Inherits="Web_Report_Xs_Report_CustomerChart" %>
    ...
    <title>渠道销售统计表</title>
     <script language="javascript" >
         function OnClick() {
             ...
             var s_URL = 'List_CustomerChart.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
    ...
    <form id="form1" runat="server">
            <div>
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                    ...
                    <tr>
                        <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>销售报表 > <a class="hdrLink" href="Report_CustomerChart.aspx">产品销售统计表</a>
                        </td>
                ...
                <td class="dvtCellInfo"  colspan="3"><asp:TextBox ID="StartDate" runat="server" CssClass="Wdate"  onFocus="var EndDate=$dp.$('EndDate');WdatePicker({onpicked:function(){EndDate.focus();},maxDate:'#F{$dp.$D(\'EndDate\')}'})" ></asp:TextBox>&nbsp;到<asp:TextBox ID="EndDate" runat="server"  CssClass="Wdate"   onFocus="WdatePicker({minDate:'#F{$dp.$D(\'StartDate\')}'})" ></asp:TextBox></td>
            </tr>
          <tr>
                <td  class="dvtCellLabel">客户名称:</td>
                <td class="dvtCellInfo"><asp:TextBox ID="Tbx_CustomerName" runat="Server"></asp:TextBox></td>
                <td  class="dvtCellLabel">产品型号:</td>
                <td class="dvtCellInfo"><asp:TextBox ID="Tbx_Type" runat="Server"></asp:TextBox></td>
            </tr>
          <tr>
                <td  class="dvtCellLabel">客户类别:</td>
                <td  class="dvtCellInfo"><asp:DropDownList ID="Tbx_CustomerTypes" runat="server"  >
                </asp:DropDownList></td>
                <td class="dvtCellLabel">渠道:</td>
                <td  class="dvtCellInfo" ><asp:DropDownList ID="CustomerClass" runat="server"  >
                </asp:DropDownList></td>
            </tr>
          <tr>
                <td  class="dvtCellLabel">类型:</td>
                <td  class="dvtCellInfo"><asp:DropDownList ID="Ddl_Type" runat="server"  >
                    <asp:ListItem Value="0" Text="数量"></asp:ListItem>
