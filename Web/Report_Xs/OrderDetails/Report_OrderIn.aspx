...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var ContractClass = document.all('ContractClass').value;
            ...
            s_URL += '&ContractClass=' + ContractClass + '';
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                订单报表 > <a class="hdrLink" href="Report_OrderIn.aspx">订单评审明细</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="dvtCellInfo">
                                            <asp:DropDownList ID="ContractClass" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                        <td width="16%" align="right" class="dvtCellLabel">
                                            产品型号:
