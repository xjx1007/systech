<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_CustomerOrderChart.aspx.cs" Inherits="Web_Report_Xs_List_CustomerOrderChart" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function OutToFileMoreSheet(){
		...
		LODOP.SET_SAVE_MODE("Caption","客户销售排名统计表");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("客户销售排名统计表.xls");		
	};	       
</script> 
