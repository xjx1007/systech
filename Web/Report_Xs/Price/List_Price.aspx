<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Price.aspx.cs" Inherits="Web_Report_Xs_List_Price" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet(){
		...
		LODOP.SET_SAVE_MODE("Caption","产品销售价格明细");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("产品销售价格明细.xls");		
	};	       
</script> 
...
<body>
    ...
    <table  width=100% cellspacing=0 cellpadding=0 ID=tMater class=pTable>
    	<tr>
    		<td align="center"><font size="6"><b>产品销售价格明细</b></font></td>
    	</tr>
    	<tr><td>
