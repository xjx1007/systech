<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_ShipDetail_Condition.aspx.cs" Inherits="Web_Report_Xs_Xs_ShipDetail_Condition" %>
...
<body>
 ...
 <tr>
  ...
  <td width="17%" align="right" class="tableBotcss" style="height: 25px">&nbsp;客户名称:</td>
   ...
   <tr><td colspan="4" align="center"><br /><asp:Button ID="Btn_Save" runat="server"  CssClass="Custom_Button" Text="查  看" OnClick="Btn_Save_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Btn_Reset" runat="server"  CssClass="Custom_Button" Text="取 消" /><br />
   </td></tr>
