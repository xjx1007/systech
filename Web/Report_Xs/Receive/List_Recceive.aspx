<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Recceive.aspx.cs" Inherits="List_Recceive" %>
...
.Custom_Hidden
{
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "销售应收明细");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("销售应收明细.xls");
        };
