<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report_CustomerOrderChart.aspx.cs" Inherits="Web_Report_Xs_Report_CustomerOrderChart" %>
    ...
    <title>客户排名统计表</title>
     <script language="javascript" >
         function OnClick() {
             ...
             var s_URL = 'List_CustomerOrderChart.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
    ...
    <form id="form1" runat="server">
            <div>
                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                    ...
                    <tr>
                        <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>销售报表 > <a class="hdrLink" href="Report_CustomerChart.aspx">客户销售排名统计表</a>
                        </td>
