<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment_List.aspx.cs" Inherits="Web_Report_Xs_OrderList_Payment_List" %>
...
<head id="Head1" runat="server">
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script src="/Web/Js/TableFreeze.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript">

        $(document).ready(function () {

            $("#ListDetail").FrozenTable(2, 1, 5);
        })
    </script>
    <script language="javascript" type="text/javascript">
        var LODOP; //声明为全局变量 
