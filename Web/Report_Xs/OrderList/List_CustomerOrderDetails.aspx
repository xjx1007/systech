<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_CustomerOrderDetails.aspx.cs" Inherits="Web_Report_Xs_List_CustomerOrderDetails" %>
...
.gg{background-color:#dee2f2}
	...
	function OutToFileMoreSheet(){
		...
		LODOP.SET_SAVE_MODE("Caption","客户对账表");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("客户合同出货明细表.xls");		
	};	       
</script> 
