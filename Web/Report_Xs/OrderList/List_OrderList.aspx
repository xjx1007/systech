<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_OrderList.aspx.cs" Inherits="Web_Report_Xs_List_OrderList" %>
...
function OutToFileMoreSheet() {
    ...
    LODOP.SET_SAVE_MODE("Caption", "订单执行情况表");
    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
    LODOP.SAVE_TO_FILE("订单执行情况表.xls");
};
</script> 
