<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zl_Project_ProductsTry_List.aspx.cs" Inherits="Zl_Project_ProductsTry_List" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="Zl_Project_ProductsTry_List.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Zl_Project_ProductsTry_Add.aspx')">
                                                            <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 产品试制..." title="创建 产品试制..."
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 产品试制..." title="查找 产品试制..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 产品试制" title="*导入 产品试制"
                                                            border="0">
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 产品试制" title="*导出 产品试制"
                                                            border="0">
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Zl_Project_ProductsTry", "Zl_Project_ProductsTry_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <table cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv1 small" align="center"
                            ...
                            <tr>
                                ...
                                <td nowrap class="small">
                                    <b>
                                        <input name="matchtype" id="matchtype1" type="radio" runat="server" value="all">&nbsp;匹配以下所有产品试制</b>
                                </td>
                                <td nowrap width="60%" class="small">
                                    <b>
                                        <input name="matchtype" id="matchtype2" type="radio" value="any" runat="server" checked>&nbsp;匹配以下任意产品试制</b>
                                </td>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加产品试制 " onclick="fnAddSrch('<%=Base_GetBindSearch("Zl_Project_ProductsTry")%>    ','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
                                        class="crmbuttom small edit">
                                    <input name="button" type="button" value=" 删除产品试制 " onclick="delRow()" class="crmbuttom small edit">
                                </td>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="产品试制名称" SortExpression="ZPP_Title" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="Zl_Project_ProductsTry_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPP_ID") %>">
                                        ...
                                        <asp:TemplateField HeaderText="样品主题" SortExpression="PPS_Name" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <a href="../ProductsSample/Pb_Products_Sample_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPP_SampleID") %>" target="_blank">
                                                    <%# DataBinder.Eval(Container.DataItem, "ZPP_SampleName").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="需求日期" DataField="ZPP_STime" SortExpression="ZPP_STime"
                                            DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="状态" SortExpression="ZPP_State" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("251",DataBinder.Eval(Container.DataItem, "ZPP_State").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="类型" SortExpression="ZPP_Type" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("252",DataBinder.Eval(Container.DataItem, "ZPP_Type").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Zl_Project_ProductsTry_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPP_ID") %>">
