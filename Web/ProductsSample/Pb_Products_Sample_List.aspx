<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pb_Products_Sample_List.aspx.cs"
    Inherits="Web_Sales_Pb_Products_Sample_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>样品申请 > <a class="hdrLink" href="Pb_Products_Sample_List.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Pb_Products_Sample_Add.aspx')">
                                                            <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 样品申请..." title="创建 样品申请..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px;">
                                                        <a href="javascript:;" onclick="PageGo('')">
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv()">
                                                            <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 样品申请..." title="查找 样品申请..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 样品申请" title="*导入 样品申请"
                                                            border="0">
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 样品申请" title="*导出 样品申请"
                                                            border="0">
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="申请主题" SortExpression="PPS_Name" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <a href="Pb_Products_Sample_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PPS_ID") %>">
                                                    <%# DataBinder.Eval(Container.DataItem, "PPS_Name").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="类型" SortExpression="PPS_LinkMan" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("142", DataBinder.Eval(Container.DataItem, "PPS_Type").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="打烊情况跟踪" HeaderStyle-Font-Size="12px" ItemStyle-Width="230px"
                                            ...
                                            <ItemTemplate>
                                                <%# GetOutWareListfollowup(DataBinder.Eval(Container.DataItem, "PPS_ID").ToString(),"样品跟踪")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="样品" SortExpression="PPS_ID" ItemStyle-HorizontalAlign="center"
                                            HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# getDemo(DataBinder.Eval(Container.DataItem, "PPS_ID").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="审核" SortExpression="PPS_ID" ItemStyle-HorizontalAlign="center"
                                            HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
