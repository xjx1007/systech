                    ...
                    <td width="85%" align="left" valign="top" style="border-left: 2px dashed #cccccc;">
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top: 1px solid #A3B2CC;">
                            <tr>
                                ...
                                <td width="25%" style="height: 29px">关健词:<asp:TextBox ID="SeachKey" runat="server" CssClass="detailedViewTextBox" Width="200px"></asp:TextBox>&nbsp;<asp:Button ID="Button3" runat="server" Text="产品筛选" CssClass="crmbutton small create" OnClick="Button1_Click1" /></td>
                            </tr>
                        </table>
