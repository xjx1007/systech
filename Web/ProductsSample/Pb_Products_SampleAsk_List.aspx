<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pb_Products_SampleAsk_List.aspx.cs" Inherits="Web_Sales_Pb_Products_Sample_List" %>
...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>样品申请 >
	<a class="hdrLink" href="Pb_Products_Sample_List.aspx">样品申请</a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Pb_Products_Sample_Add.aspx')"><img src="../../themes/softed/images/btnL3Add.gif" alt="创建 样品申请..." title="创建 样品申请..." border=0></a></td>
				<td style="padding-right:0px;"><a href="javascript:;"  onclick="PageGo('')"> <asp:ImageButton runat="server" ID="Btn_Del" ImageUrl="../../themes/softed/images/btnL3Delete.gif"  OnClick="Btn_Del_Click"/></td>
				<td style="padding-right:10px"><a href="javascript:;" onClick="ShowDiv()" ><img src="../../themes/softed/images/btnL3Search.gif" alt="查找 样品申请..." title="查找 样品申请..." border=0></a></td>
				<td style="padding-right:0px;padding-left:10px;"><img src="../../themes/softed/images/tbarImport.gif" alt="*导入 样品申请" title="*导入 样品申请" border="0"></td>	
				<td style="padding-right:10px"><img src="../../themes/softed/images/tbarExport.gif" alt="*导出 样品申请" title="*导出 样品申请" border="0"></td>
				</tr>
				</table>
			</td>
			</tr>
...
<tr>
 <td>
    <%=base.Base_BindView("Pb_Products_Sample", "Pb_Products_Sample_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
</td>
</tr>
  <tr>
    <td>
...
<Columns>
        ...
        <asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="申请主题"  SortExpression="PPS_Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <a href="Pb_Products_Sample_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PPS_ID") %>"><%# DataBinder.Eval(Container.DataItem, "PPS_Name").ToString()%></a>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="客户名称"  SortExpression="PPS_CustomerValue" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "PPS_CustomerValue").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="联系人"  SortExpression="PPS_LinkMan" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetLinkManValue(DataBinder.Eval(Container.DataItem, "PPS_LinkMan").ToString(),"XOL_Name")%>
          </ItemTemplate>
        </asp:TemplateField>
         <asp:BoundField  HeaderText="申请日期"  DataField="PPS_Stime"  SortExpression="PPS_Stime" DataFormatString="{0:yyyy-MM-dd}"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
            <ItemStyle HorizontalAlign="Left"   Font-Size="12px"   />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
      <asp:TemplateField HeaderText="负责人"  SortExpression="PPS_DutyPeson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PPS_DutyPeson").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        
         <asp:BoundField  HeaderText="创建人"  DataField="PPS_CTime"  SortExpression="PPS_CTime" >
            <ItemStyle HorizontalAlign="Left"   Font-Size="12px"   />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        
      <asp:TemplateField HeaderText="状态"  SortExpression="PPS_Dept" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetBasicCodeName("124",DataBinder.Eval(Container.DataItem, "PPS_Dept").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        
      <asp:TemplateField HeaderText="审核"  SortExpression="PPS_ID" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# getShState(DataBinder.Eval(Container.DataItem, "PPS_ID").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Pb_Products_Sample_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PPS_ID") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="../../images/Edit.gif" border=0  ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
</Columns>
