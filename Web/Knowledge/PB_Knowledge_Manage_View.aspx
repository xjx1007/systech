<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Knowledge_Manage_View.aspx.cs"
                                                ...
                                                <tr>
                                                    <td>
                                                        <input title="编辑 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit"
                                                            onclick="PageGo('PB_Knowledge_Manage_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>')"
                                                            name="Edit" value="&nbsp;编辑&nbsp;">&nbsp;
                                                        <input title="共享" class="crmbutton small edit" onclick="" type="button" name="Share"
                                                            value="&nbsp;共享&nbsp;">&nbsp;
                                                        <input title="" class="crmbutton small edit" onclick="PageGo('PB_Knowledge_Manage_List.aspx')"
                                                            type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;
                                                    </td>
                                                    <td align="right">
                                                        <input title="复制 [Alt+U]" type="button" accesskey="U" class="crmbutton small create"
                                                            onclick="PageGo('PB_Knowledge_Manage_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>&Type=1')"
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvtContentSpace">
                                    ...
                                    <tr>
                                        <td  align="right" valign="top">
                                            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo" align="left">
                                                        <asp:Label runat="server" ID="Tbx_ProductsID" ></asp:Label>
                                                    </td>
                                                    <td width="16%" align="right" class="dvtCellLabel">
                                                        客户：
                                                    </td>
                                                    <td class="dvtCellInfo" align="left">
                                                        <asp:Label runat="server" ID="Tbx_CustomerValue" ></asp:Label>
                                                    </td>
                                                </tr>     
                                                <tr>
                                                    <td width="16%" align="right" class="dvtCellLabel">
                                                    ...
                                                    <td class="dvtCellInfo" align="left" >
                                                        <asp:Label runat="server" ID="Tbx_TypeID" ></asp:Label> </td>
                                                </tr>   
                                                <tr>
                                                    <td width="16%" align="right" class="dvtCellLabel">
                                                        问题：
                                            ...
                                            <asp:Label ID="Tbx_Problem" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="16%" align="right" class="dvtCellLabel">
