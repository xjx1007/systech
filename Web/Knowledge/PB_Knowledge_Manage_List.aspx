<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Knowledge_Manage_List.aspx.cs" Inherits="PB_Knowledge_Manage_List" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="PB_Knowledge_Manage_List.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('PB_Knowledge_Manage_Add.aspx')">
                                                            <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 知识库..." title="创建 知识库..."
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 知识库..." title="查找 知识库..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 知识库" title="*导入 知识库"
                                                            border="0">
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 知识库" title="*导出 知识库"
                                                            border="0">
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("PB_Knowledge_Manage", "PB_Knowledge_Manage_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <tr>
                            ...
                            <td width="85%" align="left" valign="top" style="border-left: 2px dashed #cccccc;">
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ItemStyle-Height="25px" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <asp:TemplateField HeaderText="产品名称" SortExpression="PKM_Title" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="PB_Knowledge_Manage_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PKM_ID") %>">
                                                    <%# base.Base_GetProductsEdition(DataBinder.Eval(Container.DataItem, "PKM_ProductsBarCode"))%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="分类" SortExpression="PKM_Type" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%#GetProductsType(DataBinder.Eval(Container.DataItem, "PKM_Type").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="客户名称" SortExpression="PKM_CustomerValue" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "PKM_CustomerValue").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="问题" SortExpression="PKM_Problem" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "PKM_Problem")%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="状态" SortExpression="PKM_State" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("220",DataBinder.Eval(Container.DataItem, "PKM_State").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="创建人" SortExpression="PKM_Creator" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PKM_Creator").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="PB_Knowledge_Manage_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PKM_ID") %>">
