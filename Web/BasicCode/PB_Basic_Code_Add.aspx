...
<table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
 ...
 <asp:TextBox ID="Tbx_Code1" runat="server" style="display:none"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td  class="dvtCellLabel" >上级ID:</td>
                                            <td class="dvtCellInfo">
                                            <pc:PTextBox runat="server" ID="Tbx_FID" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="150px"></pc:PTextBox>
                                            
                                            </td>
                                            
                                            <td  class="dvtCellLabel" >上级Code:</td>
                                            <td class="dvtCellInfo">
                                            <pc:PTextBox runat="server" ID="Tbx_FCode"   CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="150px"></pc:PTextBox>
                                            </td>
