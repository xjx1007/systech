<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_Sales_CheckList_List.aspx.cs"
    Inherits="Web_Xs_Sales_CheckList_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                销售对账 > <a class="hdrLink" href="Xs_Sales_CheckList_List.aspx">销售对账</a>
            </td>
            <td width="100%" nowrap>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Xs_Sales_CheckList_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 销售对账单..." title="创建 销售对账单..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 销售对账单..." title="查找 销售对账单..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 销售对账单" title="*导入 销售对账单"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 销售对账单" title="*导出 销售对账单"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindView("Cg_Order_Checklist", "Xs_Sales_CheckList_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关销售单记录</B><br/><br/></font></div>"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="对账单号" SortExpression="COC_Code" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="Xs_Sales_CheckList_CView.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "COC_Code") %>">
                                    ...
                                    <asp:TemplateField HeaderText="查看" HeaderStyle-Font-Size="12px" ItemStyle-Width="28px"
                                        ...
                                        <ItemTemplate>
                                            <a href="#" onclick="javascript:window.open('Xs_Sales_CheckList_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "COC_Code")%>&PrinterModel=128898695453437500','查看详细','top=120,left=150,menubar=no,scrollbars=yes, resizable=yes, location=no, status=no, width=700,height=450');">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Xs_Sales_CheckList_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "COC_Code") %>"><asp:Image ID="Image3" runat="server"  ImageUrl="../../images/Edit.gif" border=0 ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
