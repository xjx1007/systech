    ...
    <form id="form1" runat="server">
        <div>
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>联系人 > <a class="hdrLink" href="SelectContentPerson.aspx">选择联系人</a>
                    </td>
                    <td width="100%" nowrap>
                ...
                <tr>
                    <td>
                        <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                            <tr>
                                <td width="75%" align="left">名称:<asp:TextBox ID="Tbx_Name" class="detailedViewTextBox" runat="server" Width="300px"></asp:TextBox>&nbsp;<asp:Button
                                    ID="Button1" runat="server" Text="筛选" CssClass="crmbutton small save" OnClick="Button1_Click1" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="XOL_Mail" HeaderText="EMail" SortExpression="XOL_Mail">
