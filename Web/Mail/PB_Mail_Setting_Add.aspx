...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="PB_Basic_Menu_List.aspx">发件人</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>发件人
                                            </td>
                                        ...
                                        <tr>
                                            <td align="right" valign="top">
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">SMTP服务器：
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">SMTP端口：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">EMail：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">密码：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">需要验证：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">发送邮件：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">发送人：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">发送间隔：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
