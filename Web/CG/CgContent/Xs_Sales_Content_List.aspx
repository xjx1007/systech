...
<Columns>
      ...
      <asp:TemplateField HeaderText="供应商"  SortExpression="XSC_CustomerValue" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetSupplierName_Link(DataBinder.Eval(Container.DataItem, "XSC_CustomerValue").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
      ...
      <asp:TemplateField HeaderText="联系类型"  SortExpression="XSC_Types" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# base.Base_GetBasicCodeName("764",DataBinder.Eval(Container.DataItem, "XSC_Types").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
