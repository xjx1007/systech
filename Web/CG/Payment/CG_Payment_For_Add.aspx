...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="CG_Payment_For_List.aspx">用款申请</a>
                ...
                <td width="100%" nowrap>
                    ...
                    <asp:TextBox ID="Tbx_MainFID" runat="server" Style="display: none"></asp:TextBox>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="货币类型不能为空"
                                                ControlToValidate="Ddl_Currency" Display="Dynamic"></asp:RequiredFieldValidator>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:DropDownList ID="Ddl_UseType" CssClass="detailedViewTextBox" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="Ddl_UseType_SelectedIndexChanged"></asp:DropDownList>
                                                        (<font color="red">*</font>)
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="用款方式不能为空"
                                                ...
                                                <asp:Panel runat="server" ID="Pan_YFBill" Visible="false">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellLabel">项目名称:
                                                        </td>
                                                        <td class="dvtCellInfo">
                                                            <pc:PTextBox runat="server" ID="Tbx_Project" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="200px"></pc:PTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dvtCellLabel">款项退还方式:
                                                        </td>
                                                        <td class="dvtCellInfo">
                                                            <pc:PTextBox runat="server" ID="Tbx_RepayMoney" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="200px"></pc:PTextBox>
                                                        </td>
                                                        <td class="dvtCellLabel">责任人:
                                                        </td>
                                                        <td class="dvtCellInfo">
                                                            
                                                        <asp:DropDownList ID="DdL_DDutyPerson" CssClass="detailedViewTextBox" runat="server" Width="100px"></asp:DropDownList>(<font color="red">*</font>)
                                                        </td>
                                                    </tr>
                                                </asp:Panel>
                                                <tr>
                                                ...
                                                <asp:Panel runat="server" ID="Pan_Bond" Visible="false">

                                                    <tr>
                                                        <td colspan="4" class="detailedViewHeader"><b></b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dvtCellLabel">附加信息:</td>
                                                        <td class="dvtCellInfo" colspan="4">
                                                            <asp:TextBox ID="TextBox1" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="600px" Height="40px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </asp:Panel>
                                                <tr>
