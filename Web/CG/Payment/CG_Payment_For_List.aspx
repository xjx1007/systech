<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_Payment_For_List.aspx.cs" Inherits="CG_Payment_For_List" %>
...
<script language="javascript" type="text/javascript" src="/include/scriptaculous/dom-drag.js"></script>
    <script type="text/javascript" >
        ...
        function GPrint1(ID) {
            //window.open('Sales_ShipWareOut_Print_Cw.aspx?ID=' + ID, '查看详细', 'top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500')
            var temp = window.showModalDialog("CG_Payment_For_Print1.aspx?ID=" + ID + "", "", "dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
            // window.location.reload(); 
        }
</script>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('CG_Payment_For_Add.aspx')">
                                                        <img src="/themes/softed/images/btnL3Add.gif" alt="创建 用款申请..." title="创建 用款申请..." border="0"></a></td>
                                                    ...
                                                    <td style="padding-right: 10px"><a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="/themes/softed/images/btnL3Search.gif" alt="查找 用款申请..." title="查找 用款申请..." border="0"></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="/themes/softed/images/tbarImport.gif" alt="*导入 用款申请" title="*导入 用款申请" border="0"></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="/themes/softed/images/tbarExport.gif" alt="*导出 用款申请" title="*导出 用款申请" border="0"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
            ...
            <tr>
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            <!-- Buttons -->
                            <td style="padding-right: 20px" align="left" nowrap>查看范围:<asp:DropDownList runat="server" ID="Ddl_Batch" AutoPostBack="True" OnSelectedIndexChanged="Ddl_Batch_TeCPFhanged"></asp:DropDownList>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到记录</B><br/><br/></font></div>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="到期日期" DataField="CPF_OutDateTime" SortExpression="CPF_OutDateTime" DataFormatString="{0:yyyy-MM-dd}">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="打印" SortExpression="CPF_ID" HeaderStyle-Font-Size="12px"
                                            ...
                                            <itemtemplate>   
                                            <a href="#"  onclick="GPrint('<%# DataBinder.Eval(Container.DataItem, "CPF_ID")%>')"><asp:Image ID="Image4" runat="server"  ImageUrl="../../../images/Print1.gif" border=0  ToolTip="查看详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "CPF_PrintNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="查看" SortExpression="CPF_ID" HeaderStyle-Font-Size="12px"
                                             ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>   
                                            <a href="#"  onclick="GPrint1('<%# DataBinder.Eval(Container.DataItem, "CPF_ID")%>')"><asp:Image ID="Image5" runat="server"  ImageUrl="../../../images/view.gif" border=0  ToolTip="查看详细信息" /></a>
                                          </itemtemplate>
                                        </asp:TemplateField>
