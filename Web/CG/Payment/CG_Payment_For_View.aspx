                            ...
                            <td>
                                <table border="0" cellspacing="3" cellpadding="3" width="100%" class="dvtContentSpace">
                                    ...
                                    <input title="" class="crmbutton small edit" onclick="PageGo('CG_Payment_For_List.aspx')" type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;
                                        ...
                                        <asp:Button ID="Button2" runat="server" class="crmbutton small delete" Text="关闭" OnClick="Button2_Click"   />&nbsp;
                                                    </td>
                                                    <td align="right">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo" colspan="3">
                                                        <asp:Label ID="Lbl_ProductsType"  runat="server" ></asp:Label>&nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo">
                                                        <asp:Label runat="server" ID="Lbl_OutTime"  OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox';" ></asp:Label>&nbsp;
                                                    </td>
                                                    <td class="dvtCellLabel">项目:</td>
                                                    <td class="dvtCellInfo">
                                                        <asp:Label runat="server" ID="Lbl_Project"  OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" ></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
                                                
                                                <tr>
                                                    <td class="dvtCellLabel">款项退还方式 :</td>
                                                    <td class="dvtCellInfo">
                                                        <asp:Label runat="server" ID="Lbl_RepayMoney"  OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox';" ></asp:Label>&nbsp;
                                                    </td>
                                                    <td class="dvtCellLabel">责任人:</td>
                                                    <td class="dvtCellInfo">
                                                        <asp:Label runat="server" ID="Lbl_DdutyPerson"  OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" ></asp:Label>&nbsp;
                                                    </td>
                                                </tr>
