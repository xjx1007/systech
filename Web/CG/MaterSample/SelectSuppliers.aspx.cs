...
public partial class Knet_Common_SelectSuppliers : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(Knet_Common_SelectSuppliers));
        if (!IsPostBack)
        {
    ...
    [Ajax.AjaxMethod()]
    public string LinMan_Bind(string s_SuppNO)
    {
        string s_Return = "";
        try
        {
            ...
            s_Return += "|"+Model.SuppBankAccount + "|" + Model.SuppBankName;
            return s_Return;
        }
        catch
        {
    ...
    [Ajax.AjaxMethod()]
    public string GetCustomer(string s_CustomerValue)
    {
        string s_Return = "";
        try
        {
            ...
            s_Return += "|" + GetSuppProvinceName(Model.CustomerProvinces) + "|" + GetSuppCityName(Model.CustomerCity) + "|" + Model.BankAccount + "|" + Model.OpeningBank;
            return s_Return;
        }
        catch
        {
    ...
    protected void DataShows()
    {
        ...
        if (this.SeachKey1.Text != "")
        {
            KSeachKey = this.SeachKey1.Text;
        ...
        GridView1.DataBind();
            ...
            ds = bll_ClientList.GetList(SqlWhere);
    ...
    public string GetLink(string s_CustomerValue)
    {
        ...
        try
        {
            ...
            s_Return += "<a href=\"javascript:window.close();\" onclick='set_return_Customer(\"" + s_CustomerValue + "\", \"" + base.Base_GetCustomerName(s_CustomerValue) + "\");'>" + base.Base_GetCustomerName(s_CustomerValue) + "</a>";
        }
        catch
        {
            s_Return = "-";
    ...
    public string GetSupp(string s_ID)
    {
        ...
        try
        {
            ...
            string s_Province = base.Base_GetCityName(Model_Supp.SuppProvince);
            string s_City = base.Base_GetShiName(Model_Supp.SuppCity);
            s_Return += "<a href=\"javascript:window.close();\" onclick='GetReturn(\"" + s_ID + "\", \"" + base.Base_GetSupplierName(s_ID) + "\", \"" + this.KNetOddNumbers(s_ID) + "\", \"" + GetSuppNoAddress(s_ID) + "\", \"" + s_Province + "\", \"" + s_City + "\");'>" + base.Base_GetSupplierName(s_ID) + "</a>";
        }
        catch { }
        return s_Return;
    }
