        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            else
            {
                try
                {
                    ...
                    string s_Sql = "Select * from KNet_Sales_ContractList_Details a join KNET_Sys_Products b on a.ProductsBarCode=b.ProductsBarCode where ContractNo='" + ContractNo + "'";
                    ...
                    if (Dtb_Table.Rows.Count > 0)
                    {
                        for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                        {
                            ...
                            s_Remarks += Dtb_Table.Rows[i]["ProductsEdition"].ToString();
                        }
                        s_Remarks += " 电池";
                    }
                }
