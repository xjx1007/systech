...
/// 采购管理-----采购单 管理
/// </summary>
public partial class Knet_Procure_OpenBilling_ManageQr : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                base.Base_DropBindSearch(this.bas_searchfield, "Knet_Procure_OpenBilling_ManageQr");
                base.Base_DropBindSearch(this.Fields, "Knet_Procure_OpenBilling_ManageQr");
                this.DataShows();
            }
        }
    ...
    protected void DataShows()
    {
        ...
        string SqlWhere = " 1=1 and SuppNo<>'' and a.KPO_Del=0 and c.rkState<>1 and KPO_RkState<>'1' ";
        string s_Sql = " Select a.SuppNo,Count(*) Countnum from Knet_Procure_OrdersList a join Knet_Procure_OrdersList_Details b on a.OrderNo=b.OrderNo join v_OrderRkDetailsQR c on b.ID=c.KPO_ID where ";
        AdminloginMess AM = new AdminloginMess();
        ...
        SqlWhere += " Group by SuppNo order by SuppNo ";
    ...
    else
    {
        ...
        try
        {
            s_Return += "  <a href=\"../../Mail/PB_Basic_Mail_Add.aspx?SuppNo=" + s_HouseNo + "\" class=\"webMnu\" target=\"_blank\"><img src=\"../../images/email.gif\"  border=\"0\" /></a> ";
        }
        catch
        { }
        return s_Return;
