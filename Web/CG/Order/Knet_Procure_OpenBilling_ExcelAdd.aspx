<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Procure_OpenBilling_ExcelAdd.aspx.cs"
                ...
                <td class="showPanelBg" valign="top" width="100%">
                    <div class="small" style="padding: 10px">
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <table width="100%" align="center" class="detail-panel-div" border="0" cellspacing="0" cellpadding="5">
                	...
                	<asp:CheckBox runat="server" ID="Chk_IsOVer" />覆盖重复记录
                                        ...
                                        <asp:Panel ID="Pan_Second" runat="server">
                                            ...
                                            <tr>
                                                <td height="50" align="left" class="detail-content-heading" valign="middle" colspan="2">导入采购确定信息</td>
                                            </tr>
                                        ...
                                        <asp:Panel ID="Pan_Third" runat="server">
                                            ...
                                            <asp:TextBox runat="server" ID="TextBox1" Style="display: none" Text="0"></asp:TextBox>
                                            <asp:TextBox runat="server" ID="TextBox2" Style="display: none"></asp:TextBox>
                                            <tr>
                                                <td align="left" valign="top" style="padding-left: 40px;" colspan="2">
                                                    <br>
                                                    <span class="genHeaderGray">第三步(共三步):</span>&nbsp; 
                                                    <span class="genHeaderSmall">采购确认 </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top" style="padding-left: 40px;" colspan="2">以下列表显示 交期确认 和 采购入库. 请确认是否导入。
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="4" align="right">&nbsp;
                                                <br />
                                                    <asp:Button ID="Button4" runat="server" Text="导入" AccessKey="S" title="导入"
                                                        class="pure-button pure-button-edit" OnClick="Btn_Save_Click1" />
                                                    <input title="取消 [Alt+X]" accesskey="X" class="pure-button pure-button-cancel" onclick="window.history.back()"
                                                        type="button" name="button" value="取 消">
                                                </td>
