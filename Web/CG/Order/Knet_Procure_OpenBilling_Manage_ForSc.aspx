<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" 
     CodeFile="Knet_Procure_OpenBilling_Manage_ForSc.aspx.cs"
    Inherits="Knet_Procure_OpenBilling_Manage_ForSc" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>生产 > <a class="hdrLink" href="Knet_Procure_OpenBilling_Manage_ForSc.aspx">
                                                ...
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Knet_Procure_OpenBilling.aspx')">
                                                            <img src="../../../themes/softed/images/btnL3Add.gif" alt="创建 生产订单..." title="创建 生产订单..."
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="../../../themes/softed/images/btnL3Search.gif" alt="查找 生产订单..." title="查找 生产订单..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                       
                                                    <a href="Knet_Procure_OpenBilling_ExcelAdd.aspx"> <img src="../../../themes/softed/images/tbarImport.gif" alt="*导入" title="*导入"
                                                            border="0">
                                                        </a>
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../../themes/softed/images/tbarExport.gif" alt="*导出 生产订单" title="*导出 生产订单"
                                                            border="0">
                                                    </td>
                                                </tr>
                                            </table>
            ...
            <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <%=base.Base_BindView("Knet_Procure_OrdersList", "Knet_Procure_OpenBilling_Manage_ForSc.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="采购单号" SortExpression="OrderNo" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <a href="Knet_Procure_OpenBilling_View_ForSc.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "OrderNo") %>" target="_blank">
                                                ...
                                                <asp:TemplateField HeaderText="原材料调拨" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%# GetDbState(DataBinder.Eval(Container.DataItem, "OrderNo").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
