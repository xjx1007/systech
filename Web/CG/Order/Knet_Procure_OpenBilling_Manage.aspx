<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="Knet_Procure_OpenBilling_Manage.aspx.cs"
    Inherits="Knet_Web_Procure_Knet_Procure_OpenBilling_Manage" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>采购 > <a class="hdrLink" href="Knet_Procure_OpenBilling_Manage.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        ...
                                                        <a href="Knet_Procure_OpenBilling_ExcelAdd.aspx">
                                                            <img src="../../../themes/softed/images/tbarImport.gif" alt="*导入" title="*导入"
                                                                border="0">
                                                        </a>
                                                    </td>
                                                    <td style="padding-right: 10px">
            ...
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            <td>供应商：<asp:DropDownList runat="server" ID="Ddl_Supp" AutoPostBack="true" OnSelectedIndexChanged="Ddl_Supp_SelectedIndexChanged"></asp:DropDownList>  制单人：<asp:DropDownList runat="server" ID="Ddl_StaffNo" AutoPostBack="true" OnSelectedIndexChanged="Ddl_StaffNo_OnSelectedIndexChanged"></asp:DropDownList>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="采购单号" SortExpression="OrderNo" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="Knet_Procure_OpenBilling_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "OrderNo") %>" target="_blank">
                                        ...
                                        <asp:TemplateField HeaderText="采购类型" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# ScOrder(DataBinder.Eval(Container.DataItem, "OrderNo").ToString(),DataBinder.Eval(Container.DataItem, "ProcureTypeName").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="查看" SortExpression="CustomerValue" HeaderStyle-Font-Size="12px"
                                            ...
                                            <ItemTemplate>
                                                <%# CheckView(DataBinder.Eval(Container.DataItem, "ID").ToString(),DataBinder.Eval(Container.DataItem, "OrderNo").ToString(), DataBinder.Eval(Container.DataItem, "OrderType").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="制单人" SortExpression="OrderStaffNo" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "OrderStaffNo").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="审核" SortExpression="OrderCheckYN" HeaderStyle-Font-Size="12px"
