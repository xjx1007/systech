<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="Knet_Procure_OpenBilling_ForSc.aspx.cs"
...
<head>
    ...
    <script language="JAVASCRIPT">
        function btnGetReturnValue_onclick() {
            ...
            var temp = window.open("../../Common/SelectSuppliers.aspx?ID=" + intSeconds + "", "选择供应商", "width=750px, height=500,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
        }
        ...
        function btnSelectOrder_onclick() {
            ...
            var temp = window.open("SelectOrder.aspx?WhereID=220", "选择订单", "width=1000px, height=550px,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
        }
        ...
        function btnGetReturnValue_onclick1() {
            ...
            var temp = window.open("../../Common/SelectSuppliers.aspx?ID=" + intSeconds + "&callback=SetReturnValueInOpenner_Suppliers3", "选择供应商", "width=850px, height=500,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
        }
        ...
        function btnGetProducts_onclick() {
            ...
            var temp = window.open("SelectSuppliersPrice.aspx?sID=" + document.all("Xs_ProductsCode").value + "&SuppNo=" + document.all("SuppNoSelectValue").value + "&Contract=" + document.all("SalesOrderNo").value + "&isModiy=" + document.all("Tbx_ID").value + " ", "选择供应商", "width=850px, height=500,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
        }
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>生产 > <a class="hdrLink" href="Knet_Procure_OpenBilling_Manage.aspx">生产订单</a>
                </td>
