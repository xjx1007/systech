...
<!--GridView-->
      ...
      <asp:TemplateField ItemStyle-Width="40px" ItemStyle-Height="25px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="left">
       ...
       <asp:TemplateField HeaderText="次数"  HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <ItemTemplate>
               <%# Convert.ToString(int.Parse(DataBinder.Eval(Container.DataItem, "KSO_Order").ToString())+1)%>
          </ItemTemplate>
        </asp:TemplateField>
       <asp:TemplateField HeaderText="交期确认内容"  HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <ItemTemplate>
        ...
        <asp:BoundField   HeaderText="回复交期"  DataField="ReTime"  SortExpression="ReTime" >
            <ItemStyle HorizontalAlign="Left" Font-Size="12px"  Width="120px" />
            <HeaderStyle  HorizontalAlign="Left" Font-Size="12px" />
        </asp:BoundField>
        <asp:BoundField   HeaderText="原交期"  DataField="OldTime"  SortExpression="OldTime" >
            <ItemStyle HorizontalAlign="Left" Font-Size="12px"  Width="120px" />
            <HeaderStyle  HorizontalAlign="Left" Font-Size="12px" />
        </asp:BoundField>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" style="border-top:1px solid #A3B2CC;">
  <tr>
    <td height="30" width="58%">&nbsp;<asp:Button ID="Button2" runat="server"  CssClass="Btt" Text="删除所选项" OnClick="Button1_Click"  />
