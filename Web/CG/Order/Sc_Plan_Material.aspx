<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Sc_Plan_Material.aspx.cs"
    Inherits="Sc_Plan_Material" %>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                <tr>
                    ...
                    <td align="left" class="dvtCellInfo" valign="middle">
                        ...
                        <asp:TextBox ID="Tbx_ProductsEdtion" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'"
                            OnBlur="this.className='detailedViewTextBox'" Width="252px"></asp:TextBox>
                        &nbsp;<asp:Button ID="Button1" runat="server" Text="筛选" class="crmbutton small save"
                            CausesValidation="false" Height="32px" OnClick="Button1_Click" Width="88px" />
                    </td>
                </tr>
            </table>
        <hr />
        <asp:Button runat="server" ID="Btn_Total" Text="汇总" class="crmbutton small save" Height="30px" OnClick="Btn_Details_Click1"  Visible="false" Width="68px" />
        <asp:Button runat="server" ID="Btn_Details" Text="明细" class="crmbutton small save" Height="30px" OnClick="Btn_Details_Click" Visible="false" Width="68px" />
