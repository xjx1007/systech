                ...
                for (int i = 0; i < i_Num; i++)
                {
                    ...
                    if (s_Check != "")
                    {
                        ...
                        else
                        {
                            ...
                            Model.ID = GetMainID(i);
                            Model.ProductsBarCode = s_ProductsBarCode;
                             s_Sql = "Select KSP_isModiy from KNet_Sys_Products ";
                            s_Sql += " where ProductsBarCode='" + s_ProductsBarCode + "' ";
                            this.BeginQuery(s_Sql);
                            s_IsModiy = this.QueryForReturn();
                ...
                if (Dtb_Table.Rows.Count > 0)
                {
                    for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                    {
                        ...
                        try
                        {
                            ...
                            string s_Sql = "Select Sum(NeedNumber) from KNET_NeedStore where ProductsBarCode='" + s_ProductsBarCode + "' and HouseNo='"+s_HouseNo+"'  ";
                            this.BeginQuery(s_Sql);
                            ...
                            s_Sql = "Select Sum(NeedNumber) from KNET_NeedStore where ProductsBarCode='" + s_ProductsBarCode + "'";
                            this.BeginQuery(s_Sql);
                        ...
                        try
                        {
                            ...
                            if ((s_SuppNo == "129842136364062500") || (s_SuppNo == "130383676039147477") || (s_SuppNo == "131076009825562998"))
                            {
                                /*1. 余姚君超
                                    2. 南昌天佳 
                                 * 3.益欣
