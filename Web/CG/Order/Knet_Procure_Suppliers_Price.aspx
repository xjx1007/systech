            ...
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            <!-- Buttons -->
                            <td style="padding-right: 20px" align="left" nowrap colspan="2">供应商：<asp:DropDownList runat="server" ID="Ddl_Supp" AutoPostBack="true" OnSelectedIndexChanged="Ddl_Supp_SelectedIndexChanged"></asp:DropDownList>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Button ID="Btn_Sp" runat="server" Text="审批通过" Width="100%" OnClick="Btn_SpSave"  Style=" height: 33px;"  class="crmbutton small save"/>
                                                
                                                <asp:Button ID="Btn_Sp1" runat="server" Text="不通过" Width="100%" OnClick="Btn_SpSave1"   Style=" height: 33px;"  class="crmbutton small cancel"/>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                        ...
                        <tr>
                            ...
                            <td width="90%" align="left" valign="top" style="border-left: 2px dashed #cccccc;">
                                <cc1:MyGridView ID="GridView1" runat="server" AllowSorting="True" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关记录</B><br/><br/></font></div>" GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false" ShowHeader="true" HeaderStyle-Height="25px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="编号" SortExpression="KPP_Code" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="Knet_Procure_Suppliers_Price_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ID") %>" target="_blank">
                                                    <%# DataBinder.Eval(Container.DataItem, "KPP_Code") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="状态" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="40px" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("1131", DataBinder.Eval(Container.DataItem, "KPP_Del").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="操作人" HeaderStyle-Font-Size="12px" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "KPP_Creator").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="审核" HeaderStyle-Font-Size="12px" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%#GetShState(DataBinder.Eval(Container.DataItem, "KPP_State").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="审核人" HeaderStyle-Font-Size="12px" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%#base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "KPP_ShPerson").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:BoundField DataField="KPP_ShTime" ItemStyle-Font-Size="12px" HeaderText="审核时间" HeaderStyle-Font-Size="12px" SortExpression="KPP_ShTime" HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
