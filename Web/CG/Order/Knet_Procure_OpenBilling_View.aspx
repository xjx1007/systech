<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Procure_OpenBilling_View.aspx.cs" Inherits="Web_Sales_Knet_Procure_OpenBilling_View" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="Knet_Procure_OpenBilling_Manage.aspx">查看采购订单</a>
                </td>
                <td width="100%" nowrap>
                                    ...
                                    <input title="刪除 [Alt+D]" type="button" accesskey="D" class="crmbutton small delete" onclick=" return confirm('确定要删除这个记录吗?')" name="Delete" value="删除" style="height: 26px; width: 60px">&nbsp;
                                                        ...
                                                        <div id="tab2" class="tab">
                                                            <cc1:MyGridView ID="GridView1" runat="server" AllowSorting="True"
                                                                AutoGenerateColumns="False" CssClass="Custom_DgMain" Width="100%" PageSize="10" BorderColor="#4974C2" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关采购订单记录</B><br/><br/></font></div>">
                                                                <Columns>
                                                        ...
                                                        <div id="tab4" class="tab">
                                                            ...
                                                            <iframe runat="server" style="width: 100%; height: 800px" name="Iframe1" id="Iframe1" src="/Web/Sc/Sc_Plan_Material2.aspx?OrderNo=<%=s_OrderID %>" marginheight="0" frameborder="0"></iframe>
