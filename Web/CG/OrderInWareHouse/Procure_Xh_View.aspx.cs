...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string  s_Style = "";
            decimal d_TotalNumber = 0, d_TotalNet = 0, d_TotalNumber1 = 0;
            string s_Head = "";
            string s_Head1 = "";
            //原材料委外耗料
            string s_Sql = "";
            ...
            if (sampling=="1")
            {
                ...
                //{
                    ...
                    s_Details1 += " <tr " + s_Style + ">\n";
                        ...
                        s_Details1 += "<td class='thstyleLeftDetails'align=center >" + ss[1] + "</td>\n";

                        if (base.Base_GetProdutsName(Dtb_Table.Rows[i]["ProductsBarCode"].ToString()).IndexOf("芯") > 0)
                        {
                            s_Details1 += "<td  class='thstyleLeftDetails'align=center >" + base.Base_GetProductsPattern(Dtb_Table.Rows[i]["ProductsBarCode"].ToString()) + "</td>\n";
                        }
                        else
                        {
                            s_Details1 += "<td  class='thstyleLeftDetails'align=center >" + base.Base_GetProductsEdition(Dtb_Table.Rows[i]["ProductsBarCode"].ToString()) + "</td>\n";
                        }
                        s_Details1 += "<td class='thstyleLeftDetails' align=center >" + base.Base_GetUnitsName(base.Base_GetProductsUnits(Dtb_Table.Rows[i]["ProductsBarCode"].ToString())) + "</td>\n";


                        s_Details1 += "<td  class='thstyleLeftDetails' align=right  >&nbsp;" + base.FormatNumber1(Dtb_Table.Rows[i]["WareHouseAmount"].ToString(), 0) + "</td>\n";
                    ...
                    s_Details1 += " <tr >\n";
                    s_Details1 += "<td class='thstyleBootDetails'align=center  colspan='5'>合计:</td>\n";
               ...
               // }
                ...
                s_Head1 += "<th class=\"thstyle\" align=center>品名</th>\n";
                s_Head1 += "<th class=\"thstyle\" align=center>料号</th>\n";
                s_Head1 += "<th class=\"thstyle\" align=center>型号</th>\n";
                s_Head1 += "<th class=\"thstyle\">单位</th>\n";
                ...
                //{
                    ...
                    s_Details += " <tr " + s_Style + ">\n";
                        ...
                        s_Details += "<td class='thstyleLeftDetails'align=center >" + ss[1] + "</td>\n";
                ...
                s_Head += "<tr>\n<th colspan=\"10\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>原材料样品采购出库单</th></tr>\n";
            ...
            else
            {
                if (Dtb_Table.Rows.Count > 0)
                {
                    for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                    {
                        ...
                        s_Details += "<td  class='thstyleLeftDetails' align=right  >&nbsp;" + base.FormatNumber1(Dtb_Table.Rows[i]["WareHouseAmount"].ToString(), 0) + "</td>\n";
                        s_Details += "<td  class='thstyleLeftDetails' align=right  >&nbsp;" + Dtb_Table.Rows[i]["WareHouseUnitPrice"].ToString() + "</td>\n";
                        try
                        {
                            decimal d_Money = decimal.Parse(Dtb_Table.Rows[i]["WareHouseAmount"].ToString()) * decimal.Parse(Dtb_Table.Rows[i]["WareHouseUnitPrice"].ToString());
                            s_Details += "<td  class='thstyleLeftDetails' align=right  >&nbsp;" + base.FormatNumber1(Dtb_Table.Rows[i]["WareHouseTotalNet"].ToString(), 2) + "</td>\n";
