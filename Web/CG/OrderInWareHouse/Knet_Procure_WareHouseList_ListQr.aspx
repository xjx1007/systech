<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Procure_WareHouseList_ListQr.aspx.cs"
    Inherits="Knet_Procure_WareHouseList_ListQr" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>采购入库 > <a class="hdrLink" href="Knet_Procure_WareHouseList_List.aspx">采购入库确认</a>
                </td>
                <td width="100%" nowrap>
                                        ...
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="Knet_Procure_WareHouseList_ExcelAdd.aspx">
                                                            <img src="../../../themes/softed/images/tbarImport.gif" alt="*导入 采购入库" title="*导入 采购入库"
                                                                border="0">
                                                        </a>
            ...
            <tr>
                <td>
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            <!-- Buttons -->
                            <td style="padding-right: 20px" align="left" nowrap>查看范围:
                                <asp:DropDownList runat="server" ID="Ddl_House" AutoPostBack="true" OnTextChanged="Ddl_House_TextChanged"></asp:DropDownList><a id="moreoperate" href="" target="main" onmouseover="BatchfnDropDown(this,'selectoperate');"
                        ...
                        <tr>
                            <td>
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    AutoGenerateColumns="False" CssClass="Custom_DgMain" PageSize="7" Width="100%" OnRowDataBound="GridView1_DataRowBinding">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="仓库" SortExpression="HouseNo" ItemStyle-HorizontalAlign="Left"
                                            ...
                                            <ItemTemplate>
                                                <a href="Knet_Procure_WareHouseList_ViewQr.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "HouseNo") %>">
                                                    <font color="blue"><%# base.Base_GetHouseName(DataBinder.Eval(Container.DataItem, "HouseNo").ToString())%></font></a>
                                                
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="未确认笔数" DataField="CountNumber" SortExpression="CountNumber"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="未确认总数量" DataField="number" SortExpression="number"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="查看" SortExpression="CustomerValue" HeaderStyle-Font-Size="12px"
                                            ...
                                            <ItemTemplate>
                                                <%# CheckView(DataBinder.Eval(Container.DataItem, "HouseNo").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="发送" SortExpression="CustomerValue" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# GetPrint(DataBinder.Eval(Container.DataItem, "HouseNo").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <table style="margin-top: 0px;" class="lvt small" border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tbody>
                            ...
                            <tr bgcolor="white">
                                <td style="line-height: 26px;" valign="top">●<a style="color: rgb(153, 102, 51);" href="javascript:;" onclick="PageGo('../../Report_Cg/OrderIn/Report_OrderIn.aspx')">采购入库明细</a>
                                </td>
                            </tr>
