<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Procure_WareHouseCheckYN.aspx.cs" Inherits="Knet_Web_Procure_pop_Knet_Procure_WareHouseCheckYN" %>
    ...
    <form id="form1" runat="server">
        <div>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" height="102" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="36%" height="30" align="right" style="border-bottom: #A3B2CC 1px solid;">入库审核选择：</td>
           ...
           <asp:Label ID="MyStatStr" runat="server" Text="" Visible="false" ForeColor="red"></asp:Label>
                            ...
                            <tr>
                                <td height="30" colspan="2" align="center">&nbsp;
    <asp:Button ID="Button1" runat="server" Text="确定审核" CssClass="Btt" OnClick="Button1_Click" Style="width: 55px; height: 33px;" />&nbsp;<input name="button2" type="button" value="关闭本窗口" class="Btt" onclick="closeWindow();">
                                </td>
                            </tr>
                        </table>
