                        ...
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="发货时间" DataField="KPO_CheckTime" SortExpression="WareHouseDateTime"
                                        DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    
                                    <asp:TemplateField HeaderText="入库时间" SortExpression="WareHouseDateTime" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# base.DateToString(DataBinder.Eval(Container.DataItem, "WareHouseDateTime").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="对账" HeaderStyle-Font-Size="12px"
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetCheckState(DataBinder.Eval(Container.DataItem, "WareHouseNo").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="打印" SortExpression="DirectOutCheckYN" HeaderStyle-Font-Size="12px"
                                            ...
                                            <itemtemplate>   
                                            <%# GetPrint1(DataBinder.Eval(Container.DataItem, "ID").ToString())%>
