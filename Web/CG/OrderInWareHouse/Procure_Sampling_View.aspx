<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_Sampling_View.aspx.cs" Inherits="Web_CG_OrderInWareHouse_Procure_Sampling_View" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "请购出入库单");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("请购出入库单.xls");
	};
