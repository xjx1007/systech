<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_Account_Bill_List.aspx.cs" Inherits="CG_Account_Bill_List" %>
...
<tr>
	...
	<a class="hdrLink" href="CG_Account_Bill_List.aspx">发票管理</a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('CG_Account_Bill_Add.aspx')"><img src="../../../themes/softed/images/btnL3Add.gif" alt="创建 发票管理..." title="创建 发票管理..." border=0></a></td>
...
<tr>
 <td>
    <%=base.Base_BindView("CG_Account_Bill", "CG_Account_Bill_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
</td>
</tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("CG_Account_Bill")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
...
<Columns>
        ...
        <asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="编号"  SortExpression="CAB_Code" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <a href="CG_Account_Bill_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "CAB_ID") %>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "CAB_Code").ToString()%></a>
          </ItemTemplate>
        </asp:TemplateField>
      ...
      <asp:TemplateField HeaderText="负责人"  SortExpression="CAB_DutyPerson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="CG_Account_Bill_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "CAB_ID") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="../../../images/Edit.gif" border=0 ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
                                    <asp:TemplateField HeaderText="审核">
                                        <ItemTemplate>
                                            <%# GetShDetails(DataBinder.Eval(Container.DataItem, "CAB_ID").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
</Columns>
