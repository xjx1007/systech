...
public partial class Web_CG_Account_Bill_View : BasePage
{
        ...
        try
        {
            ...
            if (Dtb_Table.Rows.Count > 0)
            {
                for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                {
                    ...
                    s_Return += "<td class=\"dvtCellInfo\" nowrap>" + Dtb_Table.Rows[i]["CABO_Money"].ToString() + "</td>";
                    s_Return += "<td class=\"dvtCellInfo\" nowrap>" + Dtb_Table.Rows[i]["CABO_Days"].ToString() + "</td>";
                    s_Return += "<td class=\"dvtCellInfo\" nowrap>" + DateTime.Parse(Dtb_Table.Rows[i]["CABO_OutTime"].ToString()).ToShortDateString() + "</td>";
                    s_Return += "<td  class=\"dvtCellInfo\" nowrap>" + Dtb_Table.Rows[i]["CABO_Remarks"].ToString() + "</tr>";
                }
            }
            s_Return += " </table>";
    ...
    public string ShowCheckDetails1(string s_CheckNo, string s_InSuppNo, string s_ID)
    {
        ...
        if (Dts_Table.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
            {
                ...
                s_Return += "<td class=\"ListHeadDetails\" align=\"center\">" + Dts_Table.Tables[0].Rows[i]["COD_FPCode"].ToString() + "</td>";
    ...
    private void ShowCheckDetails(string s_CheckNo)
    {
        ...
        if (s_CheckNo != "")
        {
            ...
            if (Dts_Table.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
                {
                    ...
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_CkNumber"].ToString(), 0) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_DzNumber"].ToString(), 0) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_BNumber"].ToString(), 0) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_Price"].ToString(), 3) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_HandPrice"].ToString(), 3) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\"><input name=\"Tbx_Money_" + i.ToString() + "\" type=\"text\" id=\"Tbx_Money_" + i.ToString() + "\" value=" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_Money"].ToString(), 3) + " style=\"display: none\" />" + FormatNumber1(Dts_Table.Tables[0].Rows[i]["COD_Money"].ToString(), 3) + "</td>";
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_KWD_NoTaxMoney.ToString(), 3) + "</td>";
                    ...
                    this.BeginQuery("Select CABD_FPCode1 from CG_Account_Bill_Details where CABD_CheckDetailsID='" + Dts_Table.Tables[0].Rows[i]["COD_Code"].ToString() + "'");
                    this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + this.QueryForReturn() + "</td>";
                ...
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_Total.ToString(), 0) + "</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_Total1.ToString(), 0) + "</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_Total2.ToString(), 0) + "</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">&nbsp;</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">&nbsp;</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_Total3.ToString(), 2) + "</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\">" + FormatNumber1(d_Total4.ToString(), 2) + "</td>";
                this.Lbl_Detail.Text += "<td class=\"ListHeadDetails\" align=\"center\" colspan=3>&nbsp;</td>";
                this.Lbl_Detail.Text += "</tr>";
            }
        ...
        try
        {
            string s_Sql2 = "select * from Cw_Material_MoneyChange where CMM_FID='" + this.Lbl_ID.Text + "'";
            this.BeginQuery(s_Sql2);
            this.QueryForDataTable();
            if (this.Dtb_Result.Rows.Count > 0)
            {
                this.Tbx_Code.Text = Dtb_Result.Rows[0]["CMM_Code"].ToString();
                this.Tbx_STime.Text = base.DateToString(Dtb_Result.Rows[0]["CMM_STime"].ToString());
                this.Tbx_Money.Text = Dtb_Result.Rows[0]["CMM_Money"].ToString();
                this.Tbx_Remarks.Text = Dtb_Result.Rows[0]["CMM_Remarks"].ToString();
            }
        }
        catch
        {}
    ...
    protected void btn_Chcek_Click(object sender, EventArgs e)
    {
        ...
        {
            AdminloginMess AM = new AdminloginMess();
            string s_Sql = "Update CG_Account_Bill set CAB_State='0' where CAB_ID='" + this.Lbl_ID.Text + "'";
            if (DbHelperSQL.ExecuteSql(s_Sql) > 0)
            {
                AM.Add_Logs("采购--->发票登记--->发票登记反审批 操作成功！ID：" + this.Lbl_ID.Text);
            }
            ...
            for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
            {
                if (AM.CheckLogin("财务审核出库单") == true)
                {
                    ...
                    KNet.Model.Knet_Procure_WareHouseList_Details Model_Details = bll_Details.GetModel(s_DetailsID);
                    ...
                    string sql = " update Knet_Procure_WareHouseList  set WareHouseCheckYN=" + s_CheckYN + ",WareHouseCheckStaffNo ='" + AM.KNet_StaffNo + "'  where  WareHouseNo='" + s_DetailsID + "' ";
                    DbHelperSQL.ExecuteSql(sql);
                }
            }
            try
            {
                KNet.BLL.Cw_Material_MoneyChange BLL_Money = new KNet.BLL.Cw_Material_MoneyChange();
                BLL_Money.DeleteByFID(this.Lbl_ID.Text);
            }
            catch { }
            AlertAndRedirect("发票反审批成功！", "CG_Account_Bill_List.aspx");
        }
        catch
        { }
    }
