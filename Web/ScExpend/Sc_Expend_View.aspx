    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                生产消耗 > <a class="hdrLink" href="Sc_Expend_Manage.aspx">生产消耗</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <input title="" class="crmbutton small edit" onclick="PageGo('Sc_Expend_Manage.aspx')"
                                                        type="button" name="ListView" value="&nbsp;返回列表&nbsp;"  style="width: 70px; height: 33px;">&nbsp;

                                                       <asp:Button ID="btn_Chcek" runat="server" class="crmbutton small edit" Text="审批"  OnClick="btn_Chcek_Click"  style="width: 55px; height: 33px;"/>
