<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Sc_Expend_Manage_Cw.aspx.cs"
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                单据 > <a class="hdrLink" href="Sc_Expend_Manage.aspx">成品入库单</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Sc_Expend_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 成品入库单..." title="创建 成品入库单..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 成品入库单..." title="查找 成品入库单..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 成品入库单" title="*导入 成品入库单"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 成品入库单" title="*导出 成品入库单"
                                                        border="0">
                                                </td>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindViewByTitle("视图","Sc_Expend_Manage", "Sc_Expend_Manage_Cw.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString(),"and PBW_Order='0'")%>
            </td>
        </tr>
                <tr>
            <td>
                <%=base.Base_BindViewByTitle("月份","Sc_Expend_Manage", "Sc_Expend_Manage_Cw.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString(),"and PBW_Order='1'")%>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            ...
                            <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="类型" DataField="TypeName" SortExpression="TypeName" HtmlEncode="false">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="入库仓库" SortExpression="SEM_SuppNo" HeaderStyle-Font-Size="12px"
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="型号" SortExpression="SER_ProductsBarCode">
                                        <ItemTemplate>
                                            <%# base.Base_GetProductsPattern(DataBinder.Eval(Container.DataItem, "SER_ProductsBarCode").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="版本号" SortExpression="SER_ProductsBarCode" HeaderStyle-Font-Size="12px"
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField HeaderText="数量" DataField="SER_ScNumber" SortExpression="SER_ScNumber"
                                        ...
                                        <asp:BoundField HeaderText="入库日期" DataField="SEM_Stime" SortExpression="SEM_Stime"
                                    ...
                                    <asp:TemplateField HeaderText="入库人" SortExpression="SEM_RkPerson" HeaderStyle-Font-Size="12px"
                                        ...
                                        <asp:TemplateField HeaderText="入库单" SortExpression="SEM_ID" HeaderStyle-Font-Size="12px"
                                             ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>   
                                            <a href="#"  onclick="GPrint('<%# DataBinder.Eval(Container.DataItem, "SEM_ID")%>')"><asp:Image ID="Image4" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "SEM_RCPrintNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="耗料单" SortExpression="SEM_ID" HeaderStyle-Font-Size="12px"
                                             ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <itemtemplate>   
                                            <a href="#"  onclick="HPrint('<%# DataBinder.Eval(Container.DataItem, "SEM_ID")%>')"><asp:Image ID="Image5" runat="server"  ImageUrl="../../images/Print1.gif" border=0  ToolTip="查看发货详细信息" /></a>(<%# DataBinder.Eval(Container.DataItem, "SEM_MaterPrintNums")%>)
                                          </itemtemplate>
                                        </asp:TemplateField>
                                    <asp:TemplateField HeaderText="审核" HeaderStyle-Font-Size="12px"
