<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Procure_RC_View.aspx.cs"
    Inherits="Web_Procure_RC_View" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "成品生产入库单");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("成品生产入库单.xls");
	};
