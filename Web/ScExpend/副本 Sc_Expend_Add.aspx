<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="副本 Sc_Expend_Add.aspx.cs"
       ...
       var temp = window.showModalDialog("../Common/SelectSuppliers.aspx?ID=" + intSeconds + "&Type=128860698200781250", "", "dialogtop=150px;dialogleft=160px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=750px;dialogHeight=500px");
         ...
         function ChangPrice(s_Value) {
             ...
             for (var i = 1; i < rows.length; i++) {
                 var Tbx_number = rows[i].cells[11].childNodes[0];
                                                    ...
                                                    <td runat="server" id="Td1" class="dvtCellInfo" colspan="4">
                                                        ...
                                                        <cc1:MyGridView ID="MyGridView2" runat="server" AllowPaging="True" AllowSorting="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="供应商" SortExpression="XPP_SuppNo" HeaderStyle-Font-Size="12px"
                                                                    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <%# base.Base_GetSupplierName_Link(DataBinder.Eval(Container.DataItem, "XPP_SuppNo").ToString()) %>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:BoundField HeaderText="比例" DataField="XPP_Number" SortExpression="XPP_Number"
                                                                    DataFormatString="{0:f0}" HtmlEncode="false">
                                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                                </asp:BoundField>
                                                                ...
                                                                <asp:BoundField HeaderText="单价" DataField="XPP_Price" SortExpression="XPP_Price"
                                                                    DataFormatString="{0:f3}" HtmlEncode="false">
                                                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                                                </asp:BoundField>
