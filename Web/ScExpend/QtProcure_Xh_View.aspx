<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QtProcure_Xh_View.aspx.cs"
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
	    ...
	    LODOP.SET_SAVE_MODE("Caption", "材料出库单");
	    LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
	    LODOP.SAVE_TO_FILE("材料出库单.xls");
	};
