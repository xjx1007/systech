...
public partial class Web_Procure_Xh_View : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s_HouseName = "入库仓库：" + base.Base_GetHouseName(Model.SEM_SuppNo);
            string s_WareHouseNo = "遥控器单号："+Model.SEM_ID;
            string s_OrderNo = "采购单号：" +GetOrderNo(s_ID);
            string s_WareHouseDateTime = "入库日期：" + DateTime.Parse(Model.SEM_Stime.ToString()).ToShortDateString();

            string s_RC = "成品：" + GetRC(s_ID,0);
            string s_RCNumber = "生产数量：" + GetRC(s_ID, 1);
            string s_Depart1 = "入库部门：" + base.Base_GetUserDept(s_RkPerson);
            string s_StaffName1 = "入库人：" + base.Base_GetUserName(s_RkPerson);

            s_Head += "<div class=\"tableContainer\" id=\"tableContainer\" >\n";
            s_Head += "<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" class=\"scrollTable\">\n<thead class=\"fixedHeader\" > \n";
            s_Head += "<tr>\n<th colspan=\"11\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>材料入库单</th></tr>\n";
            ...
            Model.SEM_MaterPrintNums1 = Model.SEM_MaterPrintNums1 + 1;
            //Model.KPW_PrintNums =1;
            BLL.UpdateMaterPrintState1(Model);
        }
