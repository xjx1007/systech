...
public partial class Web_Sales_KNet_Sales_LinkMan_Add : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (s_ID!= "")
            {
                ...
                {
                    this.Tbx_ID.Text = "";
                    this.Lbl_Title.Text = "复制联系人";
                }
                else
                {
                    this.Lbl_Title.Text = "修改联系人";
            ...
            if (s_CustomerValue != "")
            {
                ...
                this.Tbx_CustomerName.Text = base.Base_GetSupplierName(s_CustomerValue);
            }
        }
    }
    ...
    private void ShowInfo(string XOL_ID)
    {
        ...
        this.Tbx_CustomerName.Text = base.Base_GetSupplierName(model.XOL_Compy);
        ...
        this.Tbx_Card.Text = model.XOL_Card;
    }
    private bool SetValue(KNet.Model.XS_Compy_LinkMan model)
    {
        ...
        try
        {
            ...
            model.XOL_Type = "102";
            model.XOL_Card = this.Tbx_Card.Text;
            model.XOL_PassWord = KNetPage.KNetMD5(this.Tbx_PassWord.Text);
    ...
    protected void Btn_SaveOnClick(object sender, EventArgs e)
    {
        ...
        if (s_ID == "")//新增
        {
            ...
            {
                bll.Add(model);
                AM.Add_Logs("联系人增加" + this.Tbx_ID.Text);
                AlertAndRedirect("新增成功！", "Knet_Sales_LinkMan_List.aspx");
            }
            catch { }
        }
        else
