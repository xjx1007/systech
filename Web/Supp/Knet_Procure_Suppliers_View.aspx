                                            ...
                                            <td>
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_Sname" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <%--<tr>
                                        <td  class="dvtCellLabel" >生产对接人:</td>
                                        <td class="dvtCellInfo">
                                        <asp:Label ID="KPS_Production"  runat="server"  ></asp:Label>&nbsp;
                                        </td>
                                        <td  class="dvtCellLabel" >生产对接人手机:</td>
                                        <td  class="dvtCellInfo">
                                        <asp:Label ID="KPS_ProductionPho" runat="server" ></asp:Label>&nbsp;
                                        </td>
                                        </tr>--%>
                                                    <tr>
                                                        <td class="dvtCellLabel">仓库对接人:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_WareHouse" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                        <td class="dvtCellLabel">仓库对接人手机:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_WareHousePho" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_CdBankName" runat="server"></asp:Label>&nbsp;</td>
                                                        <td class="dvtCellLabel">承兑开户行账号:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_CdBankNum" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="Lbl_Nature" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dvtCellLabel">五证合一或营业执照:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_BusinessUrl" runat="server"></asp:Label>&nbsp;</td>
                                                        <td class="dvtCellLabel">发票资料:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_InvoiceUrl" runat="server"></asp:Label>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="dvtCellLabel">生产/采购合同:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="KPS_ContractUrl" runat="server"></asp:Label>&nbsp;</td>
                                                         <td class="dvtCellLabel">质量保证协议:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="Lbl_Five" runat="server"></asp:Label>&nbsp;</td>
                                                    </tr>
                                                     <tr>
                                                        
                                                         <td class="dvtCellLabel">审厂报告及整改报告:</td>
                                                        <td class="dvtCellInfo">
                                                            <asp:Label ID="Lbl_SQE" runat="server"></asp:Label>&nbsp;</td>
                                                    </tr>
                                                    <tr>
