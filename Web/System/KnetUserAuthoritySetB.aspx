<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KnetUserAuthoritySetB.aspx.cs" Inherits="web_SystemSettings_AuthoritySetB" %>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" style="border-top:1px solid #A3B2CC;">
  <tr>
    ...
    <td width="40%" align="left">&nbsp;<asp:Button ID="Button1" runat="server" Text="确定权限设置"  CssClass="Btt" OnClick="Button1_Click" />&nbsp;&nbsp;&nbsp;&nbsp;<input name="button2" type="button" value="关闭本窗口" class="Btt" onclick="closeWindow();"></td>
  </tr>
</table>
<!--底部功能栏-->
<%--内容页结束--%>
