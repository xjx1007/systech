...
<script type="text/javascript">
     function btnGetFJReturnValue_onclick3(id) {
        ...
        rootpath += "/Web";
        var tempd = window.open(rootpath + "/System/Document/MediaPlayer.aspx?Id=" + id + "", "上传附件", "width=850px, height=500,top=150px,left=160px,toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no,alwaysRaised=yes,depended=yes");
    }
</script>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('Knet_Document_Add.aspx')">
                                                        <img src="/themes/softed/images/btnL3Add.gif" alt="创建 文档中心..." title="创建 文档中心..." border="0"/></a></td>
                                                    ...
                                                    <td style="padding-right: 10px"><a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="/themes/softed/images/btnL3Search.gif" alt="查找 文档中心..." title="查找 文档中心..." border="0"/></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="/themes/softed/images/tbarImport.gif" alt="*导入 文档中心" title="*导入 文档中心" border="0"/></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="/themes/softed/images/tbarExport.gif" alt="*导出 文档中心" title="*导出 文档中心" border="0"/></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <td>
                            ...
                            <cc1:MyGridView
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="文档编号" SortExpression="PBM_Code" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="Knet_Document_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBM_Code").ToString()%>"><%# DataBinder.Eval(Container.DataItem, "PBM_Code").ToString()%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="文档名称" SortExpression="PBM_Name" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "PBM_Name").ToString()%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="播放" SortExpression="PBA_State" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="#" onclick="return btnGetFJReturnValue_onclick3('<%#Eval("PBM_Code") %>')">播放</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="操作" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
