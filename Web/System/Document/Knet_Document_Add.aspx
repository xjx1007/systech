...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>文档中心信息</td>
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvtContentSpace">
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" align="left" class="dvtCellInfo">
                                                <asp:TextBox ID="Tbx_Code" runat="server" CssClass="detailedViewTextBox"
                                            ...
                                            <td align="left" class="dvtCellInfo" style="width: 498px">
        ...
        <input id="button" type="button" value="上传文档" runat="server" class="crmbutton small save" onserverclick="button_ServerClick" causesvalidation="false" /></td>
                                        </tr>
                                        <tr>
