<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="BasisSetting_CheckMethod.aspx.cs" Inherits="KNet_Web_System_BasisSetting_CheckMethod" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
   <td width="140" align="left"><B>[结算方式]</B></td>
    <td width="80" align="right">方式名称:</td>
    ...
    <td width="65" align="left"><asp:TextBox ID="txtUnitsPai" Text="10" Width="60px" runat="server" CssClass="Boxx"></asp:TextBox><asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="不能为空!"  ControlToValidate="txtUnitsPai" MaximumValue=9999  MinimumValue=1 Type="Integer" Display="Dynamic"></asp:RangeValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="正整数!" ControlToValidate="txtUnitsPai" ValidationExpression="^(0|[1-9][0-9]*)$" Display="Dynamic"></asp:RegularExpressionValidator></td>
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加结算方式"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="CheckName"   HeaderText="结算方式" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="CheckName">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        

       <asp:TemplateField HeaderText="排序号" HeaderStyle-Font-Size="12px"  ItemStyle-Width="10%"    SortExpression="CheckPai" ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
                <asp:TextBox ID="UnitsPaitxt" runat="server" CssClass="Boxx" Width="60px" Text='<%# DataBinder.Eval(Container.DataItem,"CheckPai")%>'></asp:TextBox><br />
          ...
          <ItemTemplate>
              <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"CheckPai")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
