<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="BasisSetting_Units.aspx.cs" Inherits="KNet_Web_System_BasisSetting_Units" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
    <td width="140" align="left"><B>[单位设置]</B></td>
    ...
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加计量单位"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="UnitsName"   HeaderText="单位名称" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="UnitsName">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        

       <asp:TemplateField HeaderText="排序号" HeaderStyle-Font-Size="12px"  ItemStyle-Width="10%"    SortExpression="UnitsPai" ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
                <asp:TextBox ID="UnitsPaitxt" runat="server" CssClass="Boxx" Width="60px" Text='<%# DataBinder.Eval(Container.DataItem,"UnitsPai")%>'></asp:TextBox><br />
          ...
          <ItemTemplate>
              <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"UnitsPai")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
