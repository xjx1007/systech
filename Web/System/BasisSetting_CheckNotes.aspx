<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="BasisSetting_CheckNotes.aspx.cs" Inherits="KNet_Web_System_BasisSetting_CheckNotes" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
    <td width="140" align="left"><B>[票据类型]</B></td>
    <td width="80" align="right">票据名称:</td>
    ...
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加票据类型"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="NotesName"   HeaderText="票据类型" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="NotesName">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        

       <asp:TemplateField HeaderText="排序号" HeaderStyle-Font-Size="12px"  ItemStyle-Width="10%"    SortExpression="NotesPai" ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
                <asp:TextBox ID="UnitsPaitxt" runat="server" CssClass="Boxx" Width="60px" Text='<%# DataBinder.Eval(Container.DataItem,"NotesPai")%>'></asp:TextBox><br />
          ...
          <ItemTemplate>
              <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"NotesPai")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
