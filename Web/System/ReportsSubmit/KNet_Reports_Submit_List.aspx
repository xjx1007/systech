...
<Columns>
      ...
      <asp:TemplateField HeaderText="公告"  SortExpression="KRS_NoticeID" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
          <ItemTemplate>
               <%# GetLink(DataBinder.Eval(Container.DataItem, "KRS_NoticeID").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
