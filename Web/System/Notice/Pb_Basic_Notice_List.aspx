<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pb_Basic_Notice_List.aspx.cs" Inherits="Pb_Basic_Notice_List" %>
                            ...
                            <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="主题" SortExpression="PBN_Title" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="Pb_Basic_Notice_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBN_ID") %>">
                                                <%# DataBinder.Eval(Container.DataItem, "PBN_Title")%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
