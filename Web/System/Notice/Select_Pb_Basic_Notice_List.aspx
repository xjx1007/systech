<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Select_Pb_Basic_Notice_List.aspx.cs" Inherits="Select_Pb_Basic_Notice_List" %>
    ...
    <script>
        ...
        function set_return_Customer(Customer_id, Customer_name) {
            if (window.opener != undefined) {
                window.opener.returnValue = Customer_id + "," + Customer_name ;
            }
            else {
                window.returnValue = Customer_id + "," + Customer_name ;
            }
        }
    </script>
    <title>选择公告列表</title>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                工作台 > <a class="hdrLink" href="Pb_Basic_Notice_List.aspx"><asp:Label runat="server" ID="Lbl_Title"></asp:Label></a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Pb_Basic_Notice_Add.aspx')">
                                                        <img src="/themes/softed/images/btnL3Add.gif" alt="创建 公告..." title="创建 公告..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="/themes/softed/images/btnL3Search.gif" alt="查找 公告..." title="查找 公告..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="/themes/softed/images/tbarImport.gif" alt="*导入 公告" title="*导入 公告"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="/themes/softed/images/tbarExport.gif" alt="*导出 公告" title="*导出 公告"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindView("Pb_Basic_Notice", "Pb_Basic_Notice_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                >
                                <Columns>
                                    <asp:TemplateField HeaderText="主题" SortExpression="PBN_Title" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                                <%# GetLink(DataBinder.Eval(Container.DataItem, "PBN_ID").ToString(),DataBinder.Eval(Container.DataItem, "PBN_Title").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="公告类型" SortExpression="PBN_Type" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                        <%# base.Base_GetBasicCodeName("219",DataBinder.Eval(Container.DataItem, "PBN_Type").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="开始日期" DataField="PBN_BeginTime" SortExpression="PBN_BeginTime"
                                        DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="结束日期" DataField="PBN_EndTime" SortExpression="PBN_EndTime"
                                        DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="创建人" SortExpression="PBN_Creator" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                        <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PBN_Creator").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
