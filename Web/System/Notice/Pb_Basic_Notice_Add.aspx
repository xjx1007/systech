...
<head>
    ...
    <script language="JAVASCRIPT">
        function btnGetReturnValue_onclick() {
            ...
            var temp = window.showModalDialog("/Web/Common/SelectDeptPerson.aspx?ID=" + v_Receive + "", "", "dialogtop=150px;dialogleft=160px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=600px");
            if (temp == undefined) {
                                            ...
                                            <table width="100%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo" align="left" colspan="3">
                                                                ...
                                                                <iframe src='/Web/eWebEditor/ewebeditor.htm?id=Tbx_Remark&style=gray'
