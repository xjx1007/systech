<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="BasisSetting_BigClass.aspx.cs" Inherits="KNet_Web_System_BasisSetting_BigClass" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
    <td width="140" align="left"><B>[产品大类]</B></td>
    ...
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加产品大类"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="CateName"   HeaderText="大类名称" ControlStyle-CssClass="Boxx" ControlStyle-Width="250px" SortExpression="CateName">
