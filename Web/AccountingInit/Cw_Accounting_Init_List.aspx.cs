...
public partial class Cw_Accounting_Init_List : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                base.Base_DropBatchBind(this.Ddl_Batch, "Cw_Accounting_Init", "CAI_DutyPerson");
            }
        }
    ...
    protected void DataShows()
    {
        ...
        s_SqlWhere +=" Order by CAI_CTime desc";
        ...
        MyGridView1.DataKeyNames = new string[] { "CAI_ID" };
        ...
        try
        {
            for (int i = 0; i < MyGridView1.Rows.Count; i++)
            {
                ...
                if (Ckb.Checked)
                {
                    ...
                    s_Sql.Append(" delete from  Cw_Accounting_Init_Details Where CAID_FID='" + s_ID + "' ");
