<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pb_Basic_KnowledgeClass_List.aspx.cs"
    Inherits="PB_Basic_KnowledgeClass_List" %>
                ...
                <table border="0" cellspacing="0" cellpadding="5" width="100%" class="settingsSelUITopLine">
                    ...
                    <tr>
                        <td valign="top" class="small">
                            使用帮助：把鼠标放在某个知识分类上，旁边会出现添加分类,编辑分类和删除分类的图标，点击相应图标可以维护知识分类。
                        </td>
                    </tr>
                </table>
            </td>
