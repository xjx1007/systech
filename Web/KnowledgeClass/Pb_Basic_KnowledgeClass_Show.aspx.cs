...
public partial class PB_Basic_KnowledgeClass_Show : BasePage
{
        ...
        try
        {
            ...
            if (Dts_Table.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < Dts_Table.Tables[0].Rows.Count; i++)
                {
                    ...
                    treeNode1.Text = Dts_Table.Tables[0].Rows[i]["PBK_Name"].ToString() + " (" + Dts_Table.Tables[0].Rows[i]["PBK_Code"].ToString() + ")";
    ...
    {
        string s_Return = TreeView1.SelectedNode.Value + "," + TreeView1.SelectedNode.Text ;
