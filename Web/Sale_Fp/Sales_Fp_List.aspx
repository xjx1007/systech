                    ...
                    <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss_Select">
                        <tr>
                            ...
                            <td class="tableBotcss" width="35%" style="height: 30px; text-align: left">
                                <asp:TextBox ID="Tbx_DirectNo" runat="server"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td class="tableBotcss" width="35%" style="text-align: left">
                                <asp:TextBox ID="Tbx_ReceiveMan" runat="server"></asp:TextBox></td>
                            <td class="tableBotcss" width="15%" style="text-align: right">�����ֿ�</td>
                            <td class="tableBotcss1" width="35%" style="text-align: left">
                                <asp:DropDownList ID="Drop_House" runat="server"></asp:DropDownList></td>
                        </tr>
                    </table>
                    <br />
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>û���ҵ���زɹ�����¼</B><br/><br/></font></div>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="�޸�" HeaderStyle-HorizontalAlign="center" HeaderStyle-Width="30px">
                                            <ItemTemplate>
                                                <a href="../WareHouse/KNet_WareHouse_DirectOut_AddDetails.aspx?DirectOutNo=<%# DataBinder.Eval(Container.DataItem, "DirectOutNo") %>&Type=101&Css2=Div22">
                                                    <asp:Image ID="Image1" runat="server" ImageUrl="../../images/Edit.gif" border="0" ToolTip="�޸�" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
