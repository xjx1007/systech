                ...
                <td>
                    ...
                    <table width="99%" border="0" align="center" id="AddPaten" runat="server">
                        <tr>
                            ...
                            <td width="36%" align="left" class="tableBotcss" style="height: 30px">
                                <asp:TextBox ID="Tbx_DirectInNo" MaxLength="40" runat="server" CssClass="Boxx" Width="150px"></asp:TextBox>(<font color="red">*</font>)唯一性<br />
                        ...
                        <tr>
                            <td align="right" class="tableBotcss" style="height: 30px" width="17%">开票日期：</td>
                            ...
                            <td align="right" class="tableBotcss" style="height: 30px" width="17%">发票号：</td>
                            <td align="left" class="tableBotcss" style="height: 30px" width="36%">
                        ...
                        <tr>
                            ...
                            <td colspan="3" align="left" valign="top" class="tableBotcss1">
                                <asp:TextBox ID="Tbx_DirectInRemarks" TextMode="MultiLine" runat="server" CssClass="Boxx" Width="400px" Height="40px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td align="right" class="tableBotcss" height="12">明细：</td>
                            <td align="left" class="tableBotcss1" colspan="3" valign="top">
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowSorting="True"
                                    ...
                                    IsShowEmptyTemplate="true" PageSize="10" Width="100%">
