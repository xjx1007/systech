...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>应收款 > <a class="hdrLink" href="Finace_Receive_View.aspx">应收款</a>
                </td>
            </tr>
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="right" class="dvtCellLabel">时间:</td>
                                        ...
                                        <td align="right" class="dvtCellLabel">客户名称:</td>
                                        <td class="dvtCellInfo" align="left">
                                    ...
                                    <tr>
                                        <td align="right" class="dvtCellLabel">产品名称:</td>
                                        <td class="dvtCellInfo" align="left">
