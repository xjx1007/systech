...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        function OnClick() {
            ...
            var Paper = document.all('Ddl_Paper').value;
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>仓库 > <a class="hdrLink" href="Report_Kc.aspx">仓库单据打印</a>
                </td>
                                ...
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="dvtCellLabel">打印状态：
                                            </td>
                                            <td align="left" class="dvtCellInfo">
                                        ...
                                        <tr>
                                            <td align="right" class="dvtCellLabel">纸张：
                                            </td>
                                            <td align="left" class="dvtCellInfo" colspan="3">
                                                <asp:DropDownList runat="server" ID="Ddl_Paper">
                                                    <asp:ListItem Value="0">小纸</asp:ListItem>
                                                    <asp:ListItem Value="1">大纸</asp:ListItem>
                                                </asp:DropDownList>
                                                    </td>
