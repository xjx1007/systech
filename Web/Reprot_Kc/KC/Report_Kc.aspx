...
<head id="Head1" runat="server">
    ...
    <script language="JAVASCRIPT">
        function OnClick() {
            ...
            window.open(s_URL, '库存报表', 'top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=yes, location=no, status=no, width=850,height=450');
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>仓库> <a class="hdrLink" href="Report_Kc.aspx">库存报表</a>
                </td>
                                ...
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="16%" align="right" class="dvtCellLabel">产品:
                                            </td>
                                            <td class="dvtCellInfo" align="left">
