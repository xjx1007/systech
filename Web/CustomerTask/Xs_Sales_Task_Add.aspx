...
<SCRIPT LANGUAGE=JAVASCRIPT >
    ...
    {   
       ...
       var tempd= window.showModalDialog("../Common/SelectDeptPerson.aspx?sID="+intSeconds+"","","dialogtop=100px;dialogleft=120px;help=no;toolbar=no; menubar=no;scrollbars=yes; resizable=yes; location=no; status=no; dialogwidth=850px;dialogHeight=500px");
       if(tempd!=undefined)   
       {   
          	 var ss;
	         ss=tempd.split("|");
