<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_Product_Burn_List.aspx.cs" Inherits="Web_Products_KNet_Product_Burn_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>烧录 > <a class="hdrLink" href="KNet_Product_Burn_List.aspx">烧录审核</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("KNet_Product_Burn_List.aspx", "KNet_Product_Burn_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
