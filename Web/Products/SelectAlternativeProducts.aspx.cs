...
/// 选择供应商采购报价
/// </summary>
public partial class SelectAlternativeProducts : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        if (s_ProductsType != "")
        {
            SqlWhere += " and ProductsType='" + s_ProductsType + "'";
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (cb.Checked == true)
            {
                ...
                s_Return += s_ProductsBarCode + "," + s_ProductsName + "," + s_ProdctsEdition + "|";
            }
        }
        ...
        else
        {
            ...
            s.Append("    window.opener.SetReturnValueInOpenner_AlternativeProducts('" + s_Return + "');\n");
            s.Append("}\n");
            s.Append("else\n");
            s.Append("{\n");
            s.Append("    window.returnValue = '" + s_Return + "';\n");
