...
/// 选择供应商采购报价
/// </summary>
public partial class Knet_Common_SelectMouldProduct : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        string s_SonID = Bll_ProductsDetails.GetSonIDs("M130703044928726");
    ...
    public string GetLink(string s_ID)
    {
        ...
        try
        {
            s_Return += "<a href=\"javascript:window.close();\" onclick='set_return(\"" + s_ID + "\", \"" + base.Base_GetProdutsName(s_ID) + "\", \"" + base.Base_GetProductsEdition(s_ID) + "\");'>" + base.Base_GetProdutsName(s_ID) + "</a>";
