<%@ Page Language="C#" AutoEventWireup="true"   CodeFile="SelectProductsDemo.aspx.cs" Inherits="Knet_Common_SelectProductsDemo" %>
...
<title>选择材料</title><base target="_self" />
</head>
...
<!--GridView-->
        ...
        <asp:TemplateField HeaderText="大类名称"  SortExpression="ProductsType"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
         ...
         <asp:TemplateField HeaderText="单位"  SortExpression="ProductsUnits"   ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="30px">
          <ItemTemplate>
               <%# base.Base_GetUnitsName(DataBinder.Eval(Container.DataItem, "ProductsUnits").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="包装数量"   HeaderStyle-Font-Size="12px"    ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <ItemTemplate>
          ...
          <asp:TextBox ID="ProductsCode" Width="0px" runat="server"  CssClass="Custom_Hidden"  value='<%# DataBinder.Eval(Container.DataItem, "KSP_Code").ToString() %>'></asp:TextBox>
          </ItemTemplate>
        </asp:TemplateField>
        </Columns>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" style="border-top:1px solid #A3B2CC;">
  <tr>
    <td width="25%" style="height: 29px"><asp:Button ID="Button2" runat="server"  CssClass="crmbutton small save" Text="确定选择" OnClick="Button1_Click" style="width: 70px;height: 33px;"  />
     关健词:<asp:TextBox ID="SeachKey" runat="server" CssClass="Boxx" Width="100px"></asp:TextBox>&nbsp;<asp:Button  ID="Button1" runat="server" Text="产品筛选" CssClass="crmButton small create" OnClick="Button1_Click1"  style="width: 70px;height: 33px;"/></td>
  </tr>
</table>
<!--底部功能栏-->
