<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOMWithPrice.aspx.cs"
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>产品 > <a class="hdrLink" href="KnetProductsSetting.aspx"></a>
                        <a href="KnetProductsSetting.aspx">BOM相关报价</a></td>
                    <td width="100%" nowrap>
                                ...
                                <tr>
                                    <td align="left" class="dvtCellInfo" style="text-align: left" colspan="4">
                                        <table id="ProductsBomTable" width="100%" border="0" align="center" cellpadding="0" class="ListDetails"
                                            cellspacing="0">
                                            <tr id="tr3">
                                                <td align="center" class="ListHead" height="30px">序号
                                                </td>
                                                ...
                                                <td align="center" class="ListHead">新产品
                                                </td>
                                                ...
                                                <td align="center" class="ListHead">最低金额
                                                </td>
                                                <td align="center" class="ListHead">最新价格
                                                </td>
                                            </tr>
