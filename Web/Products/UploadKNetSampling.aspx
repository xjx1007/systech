<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadKNetSampling.aspx.cs" Inherits="Web_Products_UploadKNetSampling" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>请购 > <a class="hdrLink" runat="server" id="tit" href="KNetSamplingListAdd.aspx">请购信息更改</a>
                </td>
                <td width="100%" nowrap>
                                ...
                                <td style="height: 44px">
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>更改样品信息
                                            </td>
                            ...
                            <tr>
                                <td valign="top" align="left">
                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                        <tr>
                                            <td>
                                                <input title="编辑 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit" onclick="<%--PageGo('KNetSamplingListAdd.aspx?ID=<%= Request.QueryString["ID"].ToString() %>  ')--%>" name="Edit" value="&nbsp;编辑&nbsp;">&nbsp;
                                 
                                    <input title="" class="crmbutton small edit" onclick="PageGo('KNetSamplingList.aspx')" type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;
                                                    <%--   <asp:Button ID="btn_Chcek" runat="server" class="crmbutton small edit" Text="审核通过" OnClick="btn_Chcek_Click" />--%>
                                    ...
                                    <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" style="padding-left: 10px; border-bottom: 1px dotted #CCCCCC;">
                                                ...
                                                <a href="../CG/Order/Knet_Procure_OpenBilling.aspx?Type=Sampling&&Sampling=Sampling&&SamlingID=<%= Request.QueryString["ID"].ToString() %>" class="webMnu">创建采购单</a>
                                            </td>
                                        </tr>
...
<%--                                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="dvtContentSpace">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo">
                                                <asp:TextBox ID="Packaging" runat="server" Text=""></asp:TextBox>
                                            </td>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="请购单号" SortExpression="ID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TextBox ID="ID" runat="server" ReadOnly="True" Text='<%# DataBinder.Eval(Container.DataItem, "ID").ToString()%>'></asp:TextBox>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="物品编号" SortExpression="ReID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                         ...
                         <asp:TextBox ID="ReID" runat="server" ReadOnly="True" Text='<%# DataBinder.Eval(Container.DataItem, "ReID").ToString()%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="样品名称" SortExpression="SampleName" HeaderStyle-Font-Size="12px" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                         ...
                         <asp:TextBox ID="SampleName1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SampleName")%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="封装" SortExpression="ID" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px"
                    ...
                    <ItemTemplate>
                          ...
                          <asp:TextBox ID="Packaging1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Packaging")%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="申请数量" SortExpression="Number" HeaderStyle-Font-Size="12px" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Center"
                    HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:TextBox ID="Number1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Number").ToString()%>'></asp:TextBox>
                 ...
                 <asp:TemplateField HeaderText="物品单价" SortExpression="Price" HeaderStyle-Font-Size="12px" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                         ...
                         <asp:TextBox ID="Price1" runat="server"  Text='<%# DataBinder.Eval(Container.DataItem,"Price").ToString()%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="文件" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
                 ...
                 <asp:TemplateField HeaderText="备注" HeaderStyle-Font-Size="12px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"
                    ...
                    <ItemTemplate>
                         ...
                         <asp:TextBox ID="Remark1" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Remark").ToString()%>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
               <%-- <asp:TemplateField HeaderText="采购状态" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
                    HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <%# GetBuyStateYN(DataBinder.Eval(Container.DataItem, "ReID").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
