<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Sampling_OpenBilling.aspx.cs" Inherits="Web_Products_Knet_Sampling_OpenBilling" %>
        ...
        function SetReturnValueInOpenner_SuppliersPrice(tempd) {
            if (tempd != undefined) {
                ...
                for (var i = 0; i < ss.length - 1; i++) {
                    ...
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"hidden\"  Name=\"ID_' + v_NumInt + '\" value=' + s_Value[0] + '>' + s_Value[0];
                    objCel.className = "ListHeadDetails";
                    var objCel = objRow.insertCell();
                    ...
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"hidden\"  Name=\"ProductsName_' + v_NumInt + '\" value=' + s_Value[2] + '>' + s_Value[2];
                    objCel.className = "ListHeadDetails";
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"hidden\"  Name=\"Number_' + v_NumInt + '\" value=' + s_Value[3] + '>' + s_Value[3];
                    objCel.className = "ListHeadDetails";
                    
                  
                  
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"text\" Class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"ChangPrice();this.className=\'detailedViewTextBox\'\"  style="width:70px;"   Name=\"Price_' + v_NumInt + '\" value="0">';
                    objCel.className = "ListHeadDetails";
                  
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"text\" Class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"this.className=\'detailedViewTextBox\'\"  readonly style="width:70px;"  Name=\"Money_' + v_NumInt + '\" value="0">';
                    objCel.className = "ListHeadDetails";
                  
                    var objCel = objRow.insertCell();
                    objCel.innerHTML = '<input type=\"text\" Class=\"detailedViewTextBox\" OnFocus=\"this.className=\'detailedViewTextBoxOn\'\" OnBlur=\"this.className=\'detailedViewTextBox\'\" style="width:70px;"  Name=\"Remarks_' + v_NumInt + '\" value=' + s_Value[4] + ' >';
                    objCel.className = "ListHeadDetails";
                    i_row = i_row + 1;
                    s_ID = s_ID + s_Value[1] + ",";
                    v_SuppNo = s_Value[10];
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>请购入库 > <a class="hdrLink" href="Knet_Sampling_OpenBilling.aspx">入库订单</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>入库单信息
                                            </td>
                                        ...
                                        <tr>
                                            <td height="304" align="right" valign="top">
                                                <table width="100%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">入库单号:
                                                        </td>
                                                        ...
                                                        <td width="17%" height="25" align="right" class="dvtCellLabel">入库日期:
                                                        </td>
