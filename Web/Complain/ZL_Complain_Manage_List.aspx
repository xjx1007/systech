                                        ...
                                        <table border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('ZL_Complain_Manage_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 客户抱怨..." title="创建 客户抱怨..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 客户抱怨..." title="查找 客户抱怨..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 客户抱怨" title="*导入 客户抱怨"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 客户抱怨" title="*导出 客户抱怨"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
        ...
        <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                    <tr>
                        <td>
                            <%=base.Base_BindViewByTitle("视图","ZL_Complain_Manage", "ZL_Complain_Manage_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString(),"and PBW_Order='0'")%>
                        </td>
                    </tr>          
                    <tr>
                        <td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                                    ...
                                    <tr>
                                        <td align="left" width="40%">
                                            <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("ZL_Complain_Manage")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
                        ...
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="抱怨单号" SortExpression="ZCM_Code" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="抱怨类型" SortExpression="ZCM_Type" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="花费时间" SortExpression="ZCM_TimeState" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="联系人" SortExpression="ZCM_LinkMan" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# base.Base_GetLinkManValue(DataBinder.Eval(Container.DataItem, "ZCM_LinkMan").ToString(), "XOL_Name")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="负责人" SortExpression="ZCM_DutyPerson" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "ZCM_DutyPerson").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="操作时间" HeaderStyle-HorizontalAlign="center" SortExpression="ZCM_CTime">
                                        <ItemTemplate>
                                            <%# DateTime.Parse(DataBinder.Eval(Container.DataItem, "ZCM_MTime").ToString()).ToString()%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D1" SortExpression="ZCM_D1Leder" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="D2" SortExpression="ZCM_D2Finder" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D2Finder"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D2")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D3" SortExpression="ZCM_D3Cause" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D3Cause"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D3")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D4" SortExpression="ZCM_D4Person" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D4Person"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D4")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D5" SortExpression="ZCM_D5Person" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D5Person"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D5")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D6" SortExpression="ZCM_D6Person" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D6Person"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D6")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D7" SortExpression="ZCM_D7Person" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D7Person"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D7")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="D8" SortExpression="ZCM_D8Person" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <%# GetDState(DataBinder.Eval(Container.DataItem, "ZCM_D8Person"), DataBinder.Eval(Container.DataItem, "ZCM_ID").ToString(), "D8")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField HeaderText="8D报告" HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <a href="ZL_Complain_Manage_Print.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZCM_ID") %>" target="_blank">
                                    ...
                                    <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <a href="ZL_Complain_Manage_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZCM_ID") %>">
