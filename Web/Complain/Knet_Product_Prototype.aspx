<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Product_Prototype.aspx.cs" Inherits="Web_Complain_Knet_Product_Prototype" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>治具 > <a class="hdrLink" href="Knet_Product_Prototype.aspx">治具申请</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Knet_Product_Prototype.aspx", "Knet_Product_Prototype.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="申请单号" SortExpression="KPI_SID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>

                                                <a href="Knet_Product_Prototype_InOut.aspx?KPI_SID=<%# DataBinder.Eval(Container.DataItem, "KPI_SID") %>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()%></a>
                                            </ItemTemplate>

                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="申请类型" SortExpression="KPI_SID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetKPIInOut(DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="治具名称" SortExpression="KPI_SID" HeaderStyle-Font-Size="12px" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetName(DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="申请数量" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetNumber(DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="出处地" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetForSuppName(DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="去向地" HeaderStyle-Font-Size="12px" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetInSuppName( DataBinder.Eval(Container.DataItem, "KPI_SID").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="申请人" SortExpression="KPI_SID" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px"
                                        ...
                                        <asp:TemplateField HeaderText="申请时间" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetSamplingTime(DataBinder.Eval(Container.DataItem, "KPI_SID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="审核状态" HeaderStyle-Font-Size="12px" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# GetAuditState( DataBinder.Eval(Container.DataItem, "KPI_SID").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
