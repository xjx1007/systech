<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Product_Prototype_List.aspx.cs" Inherits="Web_Complain_Knet_Product_Prototype_List" %>
...
<script type="text/javascript">
    ...
    function add()
    {
        ...
        PageGo('Knet_Product_Prototype_InOut.aspx?ID=');
    }
    function add1()
    {
        //var v_Type=document.all("Tbx_Type").value;
        PageGo('Knet_Product_AddPrototype.aspx?ID=');
    }
</script>
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>治具 > <a class="hdrLink" href="Knet_Product_Prototype_List.aspx">治具管理</a>
                </td>
                <td width="100%" nowrap>
                                                ...
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="add1()">
                                                            <img src="../../themes/softed/images/btnL3Add.gif" alt="*创建 领出或归还治具" title="*创建 领出或归还治具"
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 治具..." title="查找 治具..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Knet_Product_Prototype_List.aspx", "Knet_Product_Prototype_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        <tr>
                            ...
                            <td style="padding-right: 20px" align="left" nowrap>
                                分类:
                                <asp:DropDownList runat="server" ID="DropDownListType" ></asp:DropDownList>
                                治具库存:
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                   ...
                                   >
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="编号" SortExpression="KPG_KID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href="Knet_Product_AddPrototype.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "KPG_ID") %>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "KPG_KID").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="分类" SortExpression="KPG_KID" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetType(DataBinder.Eval(Container.DataItem, "KPG_Type").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="名称" SortExpression="KPG_Name" HeaderStyle-Font-Size="12px" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "KPG_Name").ToString() %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="所在地" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetSuppNoName(DataBinder.Eval(Container.DataItem, "KPG_SuppNo").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="适用产品" SortExpression="KPG_ProductCode" HeaderStyle-Font-Size="12px" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetProductName(DataBinder.Eval(Container.DataItem, "KPG_ProductCode").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="库存数量" SortExpression="KPG_ProductCode" HeaderStyle-Font-Size="12px" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetStoreCount(DataBinder.Eval(Container.DataItem, "KPG_SuppNo").ToString(),DataBinder.Eval(Container.DataItem, "KPG_KID").ToString()) %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="添加时间" HeaderStyle-Font-Size="12px" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# DataBinder.Eval(Container.DataItem, "KPG_Time").ToString() %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                      

                                        <asp:TemplateField HeaderText="负责人" HeaderStyle-Font-Size="12px" ItemStyle-Width="140px" ItemStyle-HorizontalAlign="Center"
                                            HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%# Base_GetPersonName( DataBinder.Eval(Container.DataItem, "KPG_Person").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
