<%@ Page Language="C#" AutoEventWireup="true" CodeFile="System_Message_Detail.aspx.cs" Inherits="System_Message_Detail" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>短消息管理 > <a class="hdrLink" href="System_Message_Manage.aspx?Type=inbox">短消息查看</a>
                </td>
                <td width="100%" nowrap>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                                <tr>
                                                    ...
                                                    <td <%=s_OrderStyle%> align="center" nowrap>
                                                        <a href="System_Message_Detail.aspx?Type=0&ID=<%= Request.QueryString["ID"].ToString() %>">短消息查看</a>
                                                    </td>
                                                    <td class="dvtTabCache" style="width: 10px">&nbsp;
                                                    </td>
                                                    <td <%=s_DetailsStyle%> align="center" nowrap>
                                                        <a href="System_Message_Detail.aspx?Type=1&ID=<%= Request.QueryString["ID"].ToString() %>">短消息回复</a>
                                                    </td>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="dvtSelectedCell" align="center" nowrap>短消息发送</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td height="304" align="right" valign="top">
                                                                                        <table width="100%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td width="16%" height="25" align="right" class="dvtCellLabel">选择发送人:</td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td width="16%" height="25" align="right" class="dvtCellLabel">回复内容：</td>
                                                                                                <td class="dvtCellInfo" align="left" colspan="3">
