...
public partial class Web_List_OrderIn : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s_Sql1 = "select  a.ProductsBarCode,Count(a.HouseNo) rowspan   from (select distinct ProductsBarCode,HouseNo from v_DirectOutList_all a where 1=1 ";
            ...
            s_Sql1 += ") a join KNET_Sys_WareHouse b on a.HouseNO=b.HouseNo  ";
            ...
            for (int j = 0; j < Dtb_HouseNo.Rows.Count; j++)
            {
                ...
                string s_Sql = "Select   ";
                s_Sql += " b.HouseName,Sum(DirectOutAmount) as Number,Sum(case when ShipType=0 then isnull(KWD_BNumber,0) else DirectOutAmount+isnull(KWD_BNumber,0) end) BNumber ";
                s_Sql += " from v_DirectOutList_all a    ";
                s_Sql += " join  KNET_Sys_Products e on a.ProductsBarCode=e.ProductsBarCode    ";
                s_Sql += "  join KNET_Sys_WareHouse b on a.HouseNO=b.HouseNo   ";
                ...
                s_Sql += " group by b.HouseName order by b.HouseName ";
                ...
                if (Dtb_Table.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < Dtb_Table.Rows.Count; i++)
                    {
                        ...
                        s_Details += "<td  class='thstyleLeftDetails' >&nbsp;" + Dtb_Table.Rows[i]["HouseName"].ToString() + "</td>\n";
            ...
            s_Head += "<tr>\n<th colspan=\"9\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>产品出货返修率统计表（按OEM）</th></tr>\n";
