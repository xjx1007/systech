<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Submitted_IQC_List.aspx.cs" Inherits="Web_Report_Zl_IQC_OQC_Submitted_IQC_List" %>
...
.Custom_Hidden
{
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "IQC检验报表");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("IQC检验报表.xls");
        };
