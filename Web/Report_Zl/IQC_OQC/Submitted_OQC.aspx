<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Submitted_OQC.aspx.cs" Inherits="Web_Report_Submitted_OQC" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'Submitted_OQC_List.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                OQC检验报表 > <a class="hdrLink" href="Submitted_OQC.aspx">OQC检验报表</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
