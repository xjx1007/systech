...
public partial class Web_Report_Zl_IQC_OQC_Submitted_IQC_List : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string s_Sql =
                ...
                "' and KSP_Type = 1 and b.KPD_YNTState!=0 order by KSP_Time";
            ...
            s_Head +=
                "<tr>\n<th colspan=\"14\" class=\"MaterTitle\" style='height:14.25pt'>杭州士腾科技有限公司<br/>IQC送检报表</th></tr>\n";
            ...
            s_Head += "<th class=\"thstyle\">抽检数量</th>\n";
    ...
    protected void Button2_OnServerClick(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment; filename=" + HttpUtility.UrlEncode("IQC送检报表.xls", System.Text.Encoding.UTF8).ToString());
