<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Products_Type.aspx.cs" Inherits="Web_Report_Products_Type" %>
...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var s_URL = 'Products_Type_List.aspx?StartDate=' + StartDate + '&EndDate=' + EndDate + '';
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                物料分类报表 > <a class="hdrLink" href="Products_List.aspx">物料分类报表</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
