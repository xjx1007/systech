<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cg_Procure_Expense_Add.aspx.cs" Inherits="Web_Sales_Xs_Sales_Cares_Add" %>
                                        ...
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dvtCellInfo" colspan="4">
                                                        <asp:TextBox ID="Tbx_Remarks" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox>
                                                    </td>
                                                </tr>
