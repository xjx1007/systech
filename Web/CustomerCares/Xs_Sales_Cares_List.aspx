<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Xs_Sales_Cares_List.aspx.cs" Inherits="Web_Sales_Xs_Customer_Cares_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="Xs_Sales_Cares_List.aspx">
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('Xs_Sales_Cares_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 客户关怀..." title="创建 客户关怀..." border="0"></a></td>
                                                    <td style="padding-right: 0px;"><a href="javascript:;" onclick="PageGo('')">
                                                        <img src="../../themes/softed/images/btnL3Delete.gif" alt="删除 客户关怀..." title="删除 客户关怀..." border="0"></a></td>
                                                    <td style="padding-right: 10px"><a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 客户关怀..." title="查找 客户关怀..." border="0"></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 客户关怀" title="*导入 客户关怀" border="0"></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 客户关怀" title="*导出 客户关怀" border="0"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
            <tr>
                <td>
                    <%=base.Base_BindView("Xs_Customer_Cares", "Xs_Sales_Cares_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关客户记录</B><br/><br/></font></div>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="关怀主题" SortExpression="XCC_Topic" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Xs_Sales_Cares_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XCC_Code") %>"><%# DataBinder.Eval(Container.DataItem, "XCC_Topic").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a href="Xs_Sales_Cares_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XCC_Code") %>">
