...
<tr>
	...
	<a class="hdrLink" href="Xs_Sales_Cares_List.aspx"><asp:Label runat="server" ID="Lbl_Title"></asp:Label></a>
        </td>
	<td width=100% nowrap>
		...
		<td class="small" >
			...
			<td>
				...
				<tr>
				<td style="padding-right:0px;padding-left:10px;"><a href="javascript:;"  onclick="PageGo('Xs_Sales_Cares_Add.aspx')"><img src="../../themes/softed/images/btnL3Add.gif" alt="创建 客户关怀..." title="创建 客户关怀..." border=0></a></td>
...
<Columns>
      ...
      <asp:TemplateField HeaderText="执行人"  SortExpression="XCC_DutyPerson" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
        ...
        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" >
            <ItemTemplate>
                <a href="Xs_Sales_Cares_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "XCC_Code") %>"><asp:Image ID="Image1" runat="server"  ImageUrl="../../images/Edit.gif" border=0 ToolTip="修改" /></a>
           </ItemTemplate>
        </asp:TemplateField>
</Columns>
