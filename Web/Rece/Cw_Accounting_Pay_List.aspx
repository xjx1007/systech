    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                财务 > <a class="hdrLink" href="Cw_Accounting_Pay_List.aspx">收款单</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Cw_Accounting_Pay_Add.aspx')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 收款单..." title="创建 收款单..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 收款单..." title="查找 收款单..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 收款单" title="*导入 收款单"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 收款单" title="*导出 收款单"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="收款类型" SortExpression="CAP_Type" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%#base.Base_GetBasicCodeName("766",DataBinder.Eval(Container.DataItem, "CAP_Type").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="收款金额" DataField="CAA_PayMoney" SortExpression="CAA_PayMoney"
                                    ...
                                    <asp:BoundField HeaderText="票据日期" DataField="CAA_StartDateTime" SortExpression="CAA_StartDateTime"
                                        DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="到期日期" DataField="CAA_EndDateTime" SortExpression="CAA_EndDateTime"
                                        DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="票据编号" DataField="CAA_BillCode" SortExpression="CAA_BillCode" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField HeaderText="核销金额" DataField="CAA_DetailsTotalMoney" SortExpression="CAA_DetailsTotalMoney"
                                        ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="剩余金额" DataField="CAA_leftMoney" SortExpression="CAA_leftMoney"
                                        ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    
                                    <asp:TemplateField HeaderText="核销" SortExpression="CAA_Code" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%#GetState( DataBinder.Eval(Container.DataItem, "CAA_ID").ToString())%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
