...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="Pb_Basic_Notice_List.aspx">公告</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>公告
                                            </td>
                                        ...
                                        <tr>
                                            <td height="304" align="right" valign="top">
                                                <table width="100%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">公告标题：
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">公告类型：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">接收人:
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" colspan="3">
