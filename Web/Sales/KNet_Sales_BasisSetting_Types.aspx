<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="KNet_Sales_BasisSetting_Types.aspx.cs" Inherits="KNet_Web_Sales_KNet_Sales_BasisSetting_Types" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
   <td width="140" align="center"><B>[客户类型]</B></td>
    ...
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加客户类型"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="Client_Name"   HeaderText="类型名称" ControlStyle-CssClass="Boxx"   ControlStyle-Width="250px" SortExpression="Client_Name">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        
       <asp:TemplateField HeaderText="编码" HeaderStyle-Font-Size="12px"  ItemStyle-Width="10%"    SortExpression="Client_Code" ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
                <asp:TextBox ID="Tbx_Code1" runat="server" MaxLength="5" CssClass="Boxx" Width="60px" Text='<%# DataBinder.Eval(Container.DataItem,"Client_Code")%>'></asp:TextBox><br />
          </EditItemTemplate>
          <ItemTemplate>
              <asp:Label ID="Label2" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Client_Code")%>'></asp:Label>
          </ItemTemplate>
      </asp:TemplateField>
