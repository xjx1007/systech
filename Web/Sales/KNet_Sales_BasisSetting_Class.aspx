<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="KNet_Sales_BasisSetting_Class.aspx.cs" Inherits="KNet_Web_Sales_KNet_Sales_BasisSetting_Class" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
   <td width="140" align="center"><B>[渠道信息]</B></td>
    <td width="80" align="right">上级名称:</td>
    <td width="160" align="left"><asp:DropDownList ID="Drop_FaterCode" runat="Server"></asp:DropDownList> </td>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="Client_Name"   HeaderText="渠道名称" ControlStyle-CssClass="Boxx"   ControlStyle-Width="250px" SortExpression="Client_Name">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
        
        <asp:TemplateField  HeaderText="上级渠道" ControlStyle-CssClass="Boxx"   ControlStyle-Width="250px" SortExpression="Client_FaterNo">
            <EditItemTemplate> 
                <asp:DropDownList ID="Drop_FaterNo" runat="server"></asp:DropDownList><br />
            </EditItemTemplate>
          <ItemTemplate>
              <%# base.Base_GetKClaaName(DataBinder.Eval(Container.DataItem, "Client_FaterNo").ToString())%>
          </ItemTemplate>
        </asp:TemplateField>
        <asp:BoundField  DataField="Client_Code"   HeaderText="编码" ControlStyle-CssClass="Boxx"   ControlStyle-Width="250px" SortExpression="Client_Code">
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
        </asp:BoundField>
       <asp:TemplateField HeaderText="排序号" HeaderStyle-Font-Size="12px"  ItemStyle-Width="10%"    SortExpression="ClientPai" ControlStyle-Width="60px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
                <asp:TextBox ID="UnitsPaitxt" runat="server" CssClass="Boxx" Width="60px"  MaxLength="5" Text='<%# DataBinder.Eval(Container.DataItem,"ClientPai")%>'></asp:TextBox><br />
