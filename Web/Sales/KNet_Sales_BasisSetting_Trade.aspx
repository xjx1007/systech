<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="KNet_Sales_BasisSetting_Trade.aspx.cs" Inherits="KNet_Web_Sales_KNet_Sales_BasisSetting_Trade" %>
...
<table width="100%" border="0" align="center" height="30px" cellpadding="0" cellspacing="0" style="border-bottom:#3399CC 1px solid" >
  <tr >
   <td width="140" align="center"><B>[客户行业]</B></td>
    <td width="80" align="right">行业名称:</td>
    ...
    <td align="left" >&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="确定添加客户行业"  CssClass="Btt" OnClick="Button8_Click"  /></td>
  </tr>
</table>
...
<!--GridView-->
        ...
        <asp:BoundField  DataField="Client_Name"   HeaderText="行业名称" ControlStyle-CssClass="Boxx"   ControlStyle-Width="250px" SortExpression="Client_Name">
