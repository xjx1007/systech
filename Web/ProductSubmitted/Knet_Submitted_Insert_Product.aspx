<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_Submitted_Insert_Product.aspx.cs" Inherits="Web_ProductSubmitted_Knet_Submitted_Insert_Product" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>创建送检单 > <a class="hdrLink" href="#">创建送检单</a>
                </td>
                <td width="100%" nowrap>
                                ...
                                <td style="height: 44px">
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>创建送检单信息</td>
                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                    ...
                                                    <tr>
                                                        <td class="dvtCellLabel">送检单号:</td>
                                                        <td class="dvtCellInfo">
                                                            <pc:PTextBox runat="server" ID="ReceivNo" Enabled="false" AllowEmpty="true" ValidError="送检申请不能为空"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            <pc:PTextBox runat="server" ID="OrderNo" Enabled="false" AllowEmpty="true" ValidError="送检单号不能为空"
                                                                CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'"
                                                                OnBlur="this.className='detailedViewTextBox'" Width="150px"></pc:PTextBox>
                                                        </td>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            ...
                                                            <pc:PTextBox runat="server" ID="SuppNoSelectValue" Enabled="false" AllowEmpty="true"
                                                                ValidError="送检单号不能为空" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'"
