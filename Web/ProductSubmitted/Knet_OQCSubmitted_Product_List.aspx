<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_OQCSubmitted_Product_List.aspx.cs" Inherits="Web_ProductSubmitted_Knet_OQCSubmitted_Product_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>OQC ><a class="hdrLink" href="#">OQC送检</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Knet_OQCSubmitted_Product_List.aspx", "Knet_OQCSubmitted_Product_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
