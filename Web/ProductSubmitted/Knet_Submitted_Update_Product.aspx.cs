...
public partial class Web_ProductSubmitted_Knet_Submitted_Update_Product : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(Web_ProductSubmitted_Knet_Submitted_Update_Product));
    ...
    public void DateShow(string id)
    {
        ...
        this.Tbx_HouseName.Text = base.Base_GetHouseName(ds.Tables[0].Rows[0]["KSP_HouseNo"].ToString());
    ...
    protected void Btn_Save_OnClick(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //model.KSP_Sproposer = AM.KNet_StaffNo;
            ...
            AlertAndRedirect("操作成功！", "Knet_Submitted_Product_List.aspx");
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    protected void Button1_OnClick(object sender, EventArgs e)
    {
        try
        {
           ...
           "select * from  Knet_Submitted_Product_Details  where KPD_SID='" +this.Tbx_ID.Text + "' and KPD_YNTState=2";
                    ...
                    if (Dtb_Table.Rows.Count>0)
                    {
                        string body = "送检单号为" + this.Tbx_ID.Text + ",有不良产品,请相关部门注意";
                        string email_list = "zxc@systech.com.cn" + "|" + "zgy@systech.com.cn" + "|" + "xb@systech.com.cn" + "|" + "hyy@systech.com.cn" + "|" + "lwl@systech.com.cn" + "|";
                        //+ "zgy@systech.com.cn" + "|"+ "xb@systech.com.cn" + "|"+ "hyy@systech.com.cn" + "|"+ "lwl@systech.com.cn" + "|"
                        string File_Path = "";
    ...
    protected void Button4_OnClick(object sender, EventArgs e)
    {
        ...
        if (CodeString != "")
        {
            ...
            Response.Redirect(@"/Web/CG/OrderInWareHouse/Knet_Procure_WareHouseList_Add.aspx?OrderNo=" + this.Tbx_Order.Text + "&&SubCode=" + SubCode + "&&KSP_SID=" + this.Tbx_ID.Text + "");
        }
        else
        {
            //SubCode = "";
