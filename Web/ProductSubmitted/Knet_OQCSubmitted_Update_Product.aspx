<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Knet_OQCSubmitted_Update_Product.aspx.cs" Inherits="Web_ProductSubmitted_Knet_OQCSubmitted_Update_Product" %>
...
<head>
    ...
    <title runat="server" id="titl">OQC检测信息</title>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>OQC检测 > <a class="hdrLink" runat="server" id="tit" href="Knet_OQCSubmitted_Product_List.aspx">OQC检测信息</a>
                </td>
                <td width="100%" nowrap>
                                            ...
                                            <td align="left">
                                               <%-- <input title="审核 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit" runat="server" onserverclick="Edit_OnServerClick" name="Edit" value="&nbsp;审核&nbsp;" />&nbsp;--%>
                                                ...
                                                <input title="" class="crmbutton small edit" onclick="PageGo('Knet_Submitted_Product_List.aspx')" type="button" name="ListView" value="&nbsp;返回列表&nbsp;" />&nbsp;
                                                 ...
                                                 <asp:Button ID="Button4" runat="server" class="crmbutton small edit" Text="创建入库" Visible="False" OnClick="Button4_OnClick" />&nbsp;
                                                 <asp:Button ID="Button5" runat="server" class="crmbutton small edit" Text="入成品库" Visible="False" OnClick="Button5_OnClick" />&nbsp;
                                                 <asp:Button ID="Button6" runat="server" class="crmbutton small edit" Text="不良退货" OnClick="Button6_OnClick" />
                                            </td>
