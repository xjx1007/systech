<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sc_Plan_Print1.aspx.cs" Inherits="Sc_Plan_Print" %>
...
TABLE.print1 TD {
	BORDER-RIGHT: #000000 1px solid; PADDING-RIGHT: 3px; BORDER-TOP: #000000 0px solid; PADDING-LEFT: 3px; FONT-SIZE: 12px; BORDER-LEFT: #000000 1px solid; LINE-HEIGHT: 20px; BORDER-BOTTOM: #000000 1px solid;
}
TABLE.print1 .right {
	TEXT-ALIGN: right
}
    ...
    <div id="tMater">
        <table align="center" border="0" cellpadding="0" cellspacing="0" class="ke-zeroborder"
            ...
            <tr>
                <td width="100%">
                    <div align="center">
                        <font style="FONT-SIZE: 30px"><strong>杭州士腾科技有限公司<br>生产计划</strong></font></div>
                </td>
            </tr>
        </table>
        <br />
        <div id="zoom" class="init_font">
            <table id="table_1" align="center" border="0"  cellpadding="0" cellspacing="0" class="table_1 ke-zeroborder"
                style="font-size: 15pt; font-family: 黑体" width="90%">          <tr>
                    <td align="left">
