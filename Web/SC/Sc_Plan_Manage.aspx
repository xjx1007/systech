<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Sc_Plan_Manage.aspx.cs" Inherits="Sc_Plan_Manage" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                    生产计划 > <a class="hdrLink" href="Sc_Plan_Manage.aspx">生产计划</a>
                </td>
                <td width="100%" nowrap>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Sc_Plan_Add.aspx')">
                                                            <img src="/themes/softed/images/btnL3Add.gif" alt="创建 生产计划..." title="创建 生产计划..."
                                                                border="0"></a></td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="/themes/softed/images/btnL3Search.gif" alt="查找 生产计划..." title="查找 生产计划..."
                                                                border="0"></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="/themes/softed/images/tbarImport.gif" alt="*导入 生产计划" title="*导入 生产计划"
                                                            border="0"></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="/themes/softed/images/tbarExport.gif" alt="*导出 生产计划" title="*导出 生产计划"
                                                            border="0"></td>
                                                </tr>
                                            </table>
                                        </td>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Sc_Produce_Plan", "Sc_Plan_Manage.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                            ...
                            <td style="padding-right: 20px" align="left" nowrap>
                                ...
                                <div id="selectoperate" class="drop_mnu" onmouseout="fnHideDrop('selectoperate')"
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="drop_down">批量发短信</a></td>
                                        </tr>
                                        <tr>
                                            <td>
                    ...
                    <input type="CheckBox"  onclick="selectAll(this)"/>
                     ...
                     <asp:CheckBox ID="Chbk" runat="server"></asp:CheckBox>
                                        ...
                                        <asp:TemplateField HeaderText="编码" SortExpression="SPP_ID" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
                                            <itemtemplate>
                                                 <a href="Sc_Plan_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SPP_ID")%>"  target="_blank"><%#DataBinder.Eval(Container.DataItem, "SPP_ID").ToString()%></a>
                                              </itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="时间" SortExpression="SPP_Ctime" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
                                            <itemtemplate>
                                                 <%#DateTime.Parse( DataBinder.Eval(Container.DataItem, "SPP_Stime").ToString()).ToShortDateString()%>
                                              </itemtemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="供应商" SortExpression="SPP_SuppNo" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <itemtemplate>
           <%# base.Base_GetSupplierName(DataBinder.Eval(Container.DataItem, "SPP_SuppNo").ToString())%>
                  </itemtemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:BoundField HeaderText="操作时间" DataField="SPP_CTime" SortExpression="SPP_CTime"
                                            HtmlEncode="false">
                                            <itemstyle horizontalalign="Left" font-size="12px" />
                                            <headerstyle horizontalalign="Left" font-size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="计划人" SortExpression="SPP_Creator" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <itemtemplate>
                                                    <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "SPP_Creator").ToString())%>
                                            </itemtemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="备注" DataField="SPP_Remarks" SortExpression="SPP_Remarks"
                                            HtmlEncode="false">
                                            <itemstyle horizontalalign="Left" font-size="12px" />
                                            <headerstyle horizontalalign="Left" font-size="12px" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="发送邮件" SortExpression="SPP_IsSend" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# CheckView(DataBinder.Eval(Container.DataItem, "SPP_ID").ToString(), int.Parse(DataBinder.Eval(Container.DataItem, "SPP_IsSend").ToString()))%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="更新" SortExpression="Spp_SuppNo" HeaderStyle-Font-Size="12px"
                                            ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# CheckView1(DataBinder.Eval(Container.DataItem, "SPP_ID").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
