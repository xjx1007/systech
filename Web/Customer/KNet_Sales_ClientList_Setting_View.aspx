    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                采购 > <a class="hdrLink" href="Order_BasisSetting_Class.aspx">采购设置</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
		...
		<td style="width:45%;">
            <div onclick="location.href='Xs_Sales_BasisSetting_Class.aspx?id=2'" style="cursor: pointer">
                <h5>
                    1.业务类型</h5>
                <p class="gray">
                    对您公司客户的业务类型进行设置，如遥控器、代理、物联网等。</p>
            </div>
            ...
            <div onclick="location.href='Xs_Sales_BasisSetting_Class.aspx?id=1'" style="cursor: pointer">
                <h5>
                    2.营销渠道</h5>
                <p class="gray">
                    对营销渠道属性设置，系统默认有“零售、运营商、配套厂家等”。</p>
            </div>
        </td>
	</tr><tr>
		<td class="auto-style1">
            <div onclick="location.href='Xs_Sales_BasisSetting_Class.aspx?id=3'" style="cursor: pointer">
                <h5>
                    3.客户行业</h5>
                <p class="gray">
                    对客户行业设置，系统有“零售、数字/物联网电视(广电)、数字/物联网电视(电信)、、数字/物联网电视(其他)、物联网(智能家居)、物联网(广电)、物联网(电信)”。</p>
            </div>
            ...
            <div onclick="location.href='Xs_Sales_BasisSetting_Class.aspx?id=4'" style="cursor: pointer">
                <h5>
                    4.客户来源</h5>
                <p class="gray">
                    客户来源，系统有“展会/会议认识、客户主动联系、陌生开发、客户/朋友介绍、其他”。</p>
            </div>
        </td>
	</tr><tr>
		<td style="width:45%;">
            <div onclick="location.href='../BasicCode/PB_Basic_Code_List.aspx?id=112'" style="cursor: pointer">
                <h5>
                    5.客户级别</h5>
                <p class="gray">
                    客户级别，系统有“1星、2星、3星、4星、5星”。</p>
            </div>
        </td><td style="width:45%;">
            <div onclick="location.href='../BasicCode/PB_Basic_Code_List.aspx?id=114'" style="cursor: pointer">
                <h5>
                    6.客户类型</h5>
                <p class="gray">
                    客户类型,系统有“客户、竞争者、投资商、合作伙伴、代理商、其他”。</p>
            </div>
        </td>
	</tr><tr>
		<td style="width:45%;">
            <div onclick="location.href='../BasicCode/PB_Basic_Code_List.aspx?id=113'" style="cursor: pointer">
                <h5>
                    7.客户状态</h5>
                <p class="gray">
                    客户状态，系统有“潜在、未成交、有意向、已成交”。</p>
            </div>
        </td><td style="width:45%;">
        </td>
	</tr>
