...
public partial class Xs_Sales_BasisSetting_Class : BasePage
{
    ...
    protected void DataShows()
    {
        ...
        string s_SqlWhere = "Clientdefault=0";
        if (this.Tbx_ID.Text != "")
        {
            s_SqlWhere += " and clientKings='" + this.Tbx_ID.Text + "' ";
        }
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (bll.Exists(Client_Name, ClientKings) == false)
            {
                ...
                Response.Write("<script>alert('市场设置 添加 成功！');location.href='" + Request.Url.ToString() + "';</script>");
                Response.End();
            }   
            else
            {
