                ...
                <table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0"   >
                            <tr valign="bottom">
                                <td style="height: 44px">
                                    ...
                                    <a href="KNet_Sales_LinkMan_View.aspx?Type=0&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                        联系人信息</a></td>
                                    <td class="dvtTabCache" style="width:10px">&nbsp;</td>										
                                    <td <%=s_DetailsStyle%> align="center" nowrap>     
                                     <a href="KNet_Sales_LinkMan_View.aspx?Type=1&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                        名片信息</a></td>
                            ...
                            <tr>
                                <td valign=top align=left >
                                    <table border=0 cellspacing=0 cellpadding=0  id="Table_Btn" runat="server"  width=100%><tr><td>
