...
<head>
    ...
    <script>
        ...
        function btnGetFH_onclick() {
            ...
            objCel.className = "dvtCellLabel";
            var objCel = objRow.insertCell();
            objCel.innerHTML = '<textarea  style="height:50px;width:300px;" class=\"detailedViewTextBox\"  Name=\"FhDetails\" >';
            objCel.className = "dvtCellLabel";
            var objCel = objRow.insertCell();
                                        ...
                                        <tr>
                                            <td height="304" align="right" valign="top">
                                                <table width="100%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">客户名称:
                                                        </td>
                                                        ...
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">简称:
                                                        </td>
                                                        <td class="dvtCellInfo" align="left">
                                                    ...
                                                    <tr>
                                                        <td align="right" class="dvtCellLabel">客户编号:
                                                        </td>
                                                        ...
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">上级单位:
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">渠道信息:
                                                        </td>
                                                        ...
                                                        <td width="17%" align="right" class="dvtCellLabel">业务类型:
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">客户行业:
                                                        </td>
                                                        <td width="35%" align="left" class="dvtCellInfo">
                                                        ...
                                                        <td width="17%" align="right" class="dvtCellLabel">客户来源:
                                                        </td>
                                                        <td width="32%" align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">客户级别:
                                                        </td>
                                                        <td width="35%" align="left" class="dvtCellInfo">
                                                            <asp:DropDownList ID="Ddl_Level" runat="server" Width="150px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td width="17%" align="right" class="dvtCellLabel">客户状态:
                                                        </td>
                                                        <td width="32%" align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">客户类型:
                                                        </td>
                                                        <td width="35%" align="left" class="dvtCellInfo">
                                                            <asp:DropDownList ID="Ddl_Type" runat="server" Width="150px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td width="17%" align="right" class="dvtCellLabel">负责人:
                                                        </td>
                                                        <td width="32%" align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        <td width="17%" align="right" class="dvtCellLabel">辅助人:
                                                        </td>
                                                        <td width="32%" align="left" class="dvtCellInfo">
                                                        ...
                                                        <td height="25" align="right" class="dvtCellLabel">客户网址:
                                                        </td>
                                                        <td align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        <td width="16%" align="right" class="dvtCellLabel" style="height: 24px">首要联系人:
                                                        </td>
                                                        ...
                                                        <td width="17%" align="right" class="dvtCellLabel" style="height: 24px">性 别:
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">移动电话:
                                                        </td>
                                                        <td width="35%" align="left" class="dvtCellInfo">
                                                        ...
                                                        <td width="17%" align="right" class="dvtCellLabel">固定电话:
                                                        </td>
                                                        <td width="32%" align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        <td width="17%" align="right" class="dvtCellLabel" rowspan="2">发货要求:
                                                        </td>
                                                        <td align="left" class="dvtCellInfo" style="text-align: left" colspan="3">
                                                            <table id="FHTable" width="50%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr id="tr3">
                                                                    <td align="center" class="dvtCellLabel">名称
                                                                    </td>
                                                                    <td align="center" class="dvtCellLabel">发货说明
                                                                    </td>
                                                                    <td align="center" class="dvtCellLabel">删除
                                                                    </td>
                                                                </tr>
                                                                <%=s_Fh_Detail %>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" class="dvtCellLabel">电子邮箱:
                                                        </td>
                                                        <td align="left" class="dvtCellInfo">
                                                    ...
                                                    <asp:Panel runat="server" ID="Pan_Other">
                                                        <tr>
                                                            <td align="right" class="dvtCellLabel" style="height: 24px">联系QQ号:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo" style="height: 24px">
                                                            ...
                                                            <td align="right" class="dvtCellLabel" style="height: 24px">联系Msn号:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo" style="height: 24px">
                                                        ...
                                                        <tr>
                                                            <td width="16%" align="right" class="dvtCellLabel" style="height: 24px">开户行:
                                                            </td>
                                                            <td width="35%" align="left" class="dvtCellInfo" style="height: 24px">
                                                            ...
                                                            <td width="16%" align="right" class="dvtCellLabel" style="height: 24px">银行账户:
                                                            </td>
                                                            <td width="35%" align="left" class="dvtCellInfo" style="height: 24px">
                                                        ...
                                                        <tr>
                                                            <td width="16%" align="right" class="dvtCellLabel" style="height: 24px">税务登记号:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="right" class="dvtCellLabel">传真:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo">
                                                            ...
                                                            <td align="right" class="dvtCellLabel" style="height: 24px">邮政编码:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo" style="height: 24px">
                                                        ...
                                                        <tr>
                                                            <td height="25" align="right" class="dvtCellLabel">默认积分:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo">
                                                        ...
                                                        <tr>
                                                            <td height="25" align="right" class="dvtCellLabel">客户简介:
                                                            </td>
                                                            <td colspan="3" align="left" class="dvtCellInfo">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            height="25" align="right" class="dvtCellLabel" rowspan="2">选择销售产品:
                                                        </td>
                                                        <td align="left" class="dvtCellInfo" style="text-align: left" colspan="3">
                                                            <table id="myTable" width="50%" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                <tr id="tr1">
                                                                    <td align="center" class="dvtCellLabel">产品编码
                                                                    </td>
                                                                    <td align="center" class="dvtCellLabel">产品名称
                                                                    </td>
                                                                    <td align="center" class="dvtCellLabel">产品型号
                                                                    </td>
                                                                    <td align="center" class="dvtCellLabel">删除
                                                                    </td>
                                                                </tr>
