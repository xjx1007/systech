<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 KNet_Sales_ClientList_View.aspx.cs"
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>客户 > <a class="hdrLink" href="KNet_Sales_ClientList_Manger.aspx">客户</a>
                </td>
                <td width="100%" nowrap>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                                <tr>
                                                    ...
                                                    <td <%=s_DetailsStyle%> align="center" nowrap>
                                                        <a href="KNet_Sales_ClientList_View.aspx?Type=1&CustomerValue=<%= Request.QueryString["CustomerValue"].ToString() %>">相关信息</a>
                                                    </td>
                                                    <td class="dvtTabCache" style="width: 10px">&nbsp;
                                                    </td>
                                                    <td <%=s_StructureStyle%> align="center" nowrap>
                                                        <a href="KNet_Sales_ClientList_View.aspx?Type=2&CustomerValue=<%= Request.QueryString["CustomerValue"].ToString() %>">组织架构</a>
                                                    </td>
                                        </td>
                                ...
                                <table border="0" cellspacing="3" cellpadding="3" width="100%" class="dvtContentSpace">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <mytab:TabStrip ID="Tabstrip1" Style="FONT-WEIGHT: bold" runat="server" TabSelectedStyle="border:solid 1px black;border-bottom:none;background:#EEF2F7;padding-left:5px;padding-right:5px;"
                                                TabHoverStyle="color:red" TabDefaultStyle="border:solid 1px black;background:#dddddd;padding-left:5px;padding-right:5px;"
                                                TargetID="Mul_Plan" SepDefaultStyle="border-bottom:solid 1px #000000;">
                                                <mytab:Tab Text="客户信息" />
                                                <mytab:TabSeparator />
                                                <mytab:Tab Text="相关信息" />
                                                <mytab:TabSeparator />
                                            ...
                                            <mytab:MultiPage ID="Mul_Plan" Style="BORDER-RIGHT: #000000 1px solid; PADDING-RIGHT: 5px; BORDER-TOP: medium none; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; BORDER-LEFT: #000000 1px solid; PADDING-TOP: 5px; BORDER-BOTTOM: #000000 1px solid"
                                                runat="server">
                                                <mytab:PageView>
                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td width="17%" align="right" class="dvtCellLabel">发货要求:
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="25" align="right" class="dvtCellLabel">销售产品:
                                                            </td>
                                                            <td align="left" class="dvtCellInfo" style="text-align: left" colspan="3">
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <cc1:MyGridView ID="GridView_LinkMan" runat="server" AllowPaging="True" AllowSorting="True"
