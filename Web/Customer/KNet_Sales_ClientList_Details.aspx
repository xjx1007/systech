            ...
            <table width="98%" height="261" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td colspan="3" style="border-bottom: #333333 1px solid;">
                        <asp:Label ID="CustomerIntroduction" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                    <td height="30" align="right">&nbsp;</td>
                    <td align="left">&nbsp;</td>
                    <td colspan="2" align="left">制表人:
          <asp:Label ID="makeMan" runat="server" Text="" Width="100px" CssClass="Boxx"></asp:Label>
                        &nbsp;&nbsp;&nbsp;制表时间:
        <asp:Label ID="makeTime" runat="server" Text="" Width="100px" CssClass="Boxx"></asp:Label>
                        &nbsp;</td>
                </tr>
            </table>
            <!--endprint-->
