    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                联系人 > <a class="hdrLink" href="KNet_Sales_LinkMan_List.aspx">联系人</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="dvtContentSpace">
                                    ...
                                    <tr>
                                        ...
                                        <td class="dvtCellInfo">
                                            <asp:TextBox ID="txtXOL_Name" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'"
                                                OnBlur="this.className='detailedViewTextBox'" Width="150px"></asp:TextBox>(<font
                                                    color="red">*</font>)
                                    ...
                                    <tr>
                                        ...
                                        <td class="dvtCellInfo">
                                            <img border="0" src="../../themes/softed/images/qq.gif" align="middle"><asp:TextBox
                                    ...
                                    <tr>
                                        ...
                                        <td class="dvtCellInfo">
                                            <asp:TextBox ID="DdlXOL_Duty" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'"
                                                OnBlur="this.className='detailedViewTextBox'" runat="server" Width="150px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="dvtCellLabel">
