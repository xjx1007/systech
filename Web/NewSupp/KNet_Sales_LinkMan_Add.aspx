...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="KNet_Sales_LinkMan_List.aspx">联系人</a>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请选择负责人" ControlToValidate="Ddl_DutyPerson" Display="Dynamic"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            <td class="dvtCellLabel">Email:</td>
                                            <td class="dvtCellInfo">
                                        ...
                                        <tr>
                                            <td class="dvtCellLabel">是否启用:</td>
                                            <td valign="top" class="dvtCellInfo"></td>

                                            <td class="dvtCellLabel">登录名:</td>
                                            <td valign="top" class="dvtCellInfo"></td>
                                        </tr>
                                        <tr>
                                            <td class="dvtCellLabel">秘密:</td>
                                            <td valign="top" class="dvtCellInfo"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_Hobby" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>

                                            <td class="dvtCellLabel">地址:</td>
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_Address" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td class="dvtCellLabel">物流地址:</td>
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_LogisticsAddress" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>
                                            <td class="dvtCellLabel">评价:</td>
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_Evaluation" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>

                                        </tr>
                                        <tr>
                                            <td class="dvtCellLabel">工作履历:</td>
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_Experience" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>

                                            <td class="dvtCellLabel">备注说明:</td>
                                            <td valign="top" class="dvtCellInfo">
                                                <asp:TextBox ID="txtXOL_Remark" TextMode="MultiLine" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'" Width="300px" Height="40px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
