                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 0px;">
                                                        <asp:ImageButton runat="server" ID="Btn_Del" OnClick="Btn_Del_Click" ImageUrl="../../themes/softed/images/btnL3Delete.gif" /></td>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="供应商名称" SortExpression="XOL_Compy" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <%# base.Base_GetSupplierName(DataBinder.Eval(Container.DataItem, "XOL_Compy").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField HeaderText="电话" DataField="XOL_Officephone" SortExpression="XOL_Officephone">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="传真" DataField="XOL_Fax" SortExpression="XOL_Fax">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
