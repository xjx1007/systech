...
public partial class Web_Sales_Knet_Procure_Suppliers_Add : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            base.Base_DropBindFlow(this.Ddl_Flow, "112");
            ...
            this.Tbx_Code1.Text = base.GetNewID("Knet_Procure_Suppliers", 0);

            this.CommentList2.CommentFID = this.Tbx_Code1.Text;
            this.CommentList2.CommentType = "Supp";
