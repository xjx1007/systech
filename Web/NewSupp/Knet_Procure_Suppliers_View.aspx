...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="Knet_Procure_Suppliers_List.aspx">查看新供应商评审</a>
                </td>
                <td width="100%" nowrap>
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input title="" class="crmbutton small edit" onclick="PageGo('Knet_Procure_Suppliers_List.aspx')" type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;
                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                    ...
                                                    <asp:Panel ID="Pan_Sp" runat="server">
                                                        ...
                                                        <tr>
                                                            <td width="36%" height="30" align="right" class="dvtCellLabel">合同审核选择：</td>
                                                            <td width="64%" class="dvtCellInfo" colspan="3">&nbsp;
  ...
  <br />
                                                                ...
                                                                <asp:Button ID="Button1" runat="server" Text="取 消" AccessKey="C" title="取 消 [Alt+C]" class="crmbutton small cancel" Style="width: 55px; height: 33px;" OnClick="Button1_Click" />
                                                            </td>
