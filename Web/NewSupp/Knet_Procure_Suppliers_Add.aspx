...
<%@ Register Src="../../Web/Control/UploadList.ascx" TagName="CommentList" TagPrefix="uc2" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="Knet_Procure_Suppliers_List.aspx">新供应商评审</a>
                </td>
                <td width="100%" nowrap>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo">
                                                            ...
                                                            (<font color="red">*</font>)
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="选择供应商类型" ControlToValidate="Ddl_Type" Display="Dynamic"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
