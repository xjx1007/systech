...
/// 销售管理-----发货单 管理
/// </summary>
public partial class CK_StoreWw_Manage : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            base.Base_DropBatchBind(this.Ddl_Batch, "Sc_Expend_Manage_MaterDetails", "DutyPerson");
            base.Base_DropBindSearch(this.bas_searchfield, "Sc_Expend_Manage_MaterDetails");
            base.Base_DropBindSearch(this.Fields, "Sc_Expend_Manage_MaterDetails");
            this.DataShows();   
        }
    ...
    protected void DataShows()
    {
        ...
        SqlWhere = SqlWhere + " order by SED_RKTIme desc";

        DataSet ds = bll.GetList(SqlWhere);
       
        GridView1.DataSource = ds;
        GridView1.DataKeyNames = new string[] { "SED_ID" };
        GridView1.DataBind();
    }
