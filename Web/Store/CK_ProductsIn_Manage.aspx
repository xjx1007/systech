<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="CK_ProductsIn_Manage.aspx.cs"
    Inherits="CK_ProductsIn_Manage" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                成品入库单 > <a class="hdrLink" href="CK_ProductsIn_Manage.aspx">成品入库单</a>
            </td>
            <td width="100%" nowrap>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindView("Sc_Expend_Manage", "CK_ProductsIn_Manage.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="入库单号" SortExpression="SEM_ID" HeaderStyle-Font-Size="12px"
                                        ...
                                        <ItemTemplate>
                                            <a href="CK_Store_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_ID")%>">
                                    ...
                                    <asp:TemplateField HeaderText="出库单号" SortExpression="SEM_DirectOutNo" HeaderStyle-Font-Size="12px"
                                        ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="../SalesOut/Sales_ShipWareOut_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>"
                                                target="_self">
                                    ...
                                    <asp:TemplateField HeaderText="成品入库单" SortExpression="SEM_Creator" HeaderStyle-Font-Size="12px"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="../Report_Bill/Procure_RC_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>" target="_blank">
                                            <asp:Image ID="Image1" runat="server"  ImageUrl="../images/Printer.gif" border="0"   ToolTip="打印" /></a>
                                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="委外加工耗料单" SortExpression="SEM_Creator" HeaderStyle-Font-Size="12px"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="../Report_Bill/Procure_Xh_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "SEM_DirectOutNo")%>" target="_blank">
                                            <asp:Image ID="Image3" runat="server"  ImageUrl="../images/Printer.gif" border="0"   ToolTip="打印" /></a>
                                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
