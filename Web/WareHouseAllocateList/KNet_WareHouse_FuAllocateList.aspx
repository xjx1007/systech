<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_WareHouse_FuAllocateList.aspx.cs" Inherits="Web_WareHouseAllocateList_KNet_WareHouse_FuAllocateList" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="KNet_WareHouse_AllocateList_Manage.aspx">入库申请</a>
                </td>
                <td width="100%" nowrap>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
            ...
            <tr>
                <td>
                    <%=base.Base_BindView("KNet_WareHouse_FuAllocateList.aspx", "KNet_WareHouse_FuAllocateList.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                            ...
                            <tr>
                                <td align="left" width="40%">
                                    <input type="button" name="more" value=" 增加条件 " onclick="fnAddSrch('<%=Base_GetBindSearch("Knet_Procure_FuWareHouseList")%>    ','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
            ...
            <tr>
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        ...
                        <tr>
                            <td>
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="true" pagesize="15" AllowSorting="True" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关记录，或没有受权使用相关仓库</B><br/><br/></font></div>" GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false" ShowHeader="true" HeaderStyle-Height="25px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="调拨单号" SortExpression="AllocateNo" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a  href="KNet_WareHouse_FuWareCheck_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "AllocateNo") %>" target="_blank"><%# DataBinder.Eval(Container.DataItem, "AllocateNo").ToString()%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="状态" SortExpression="AllocateNo" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
