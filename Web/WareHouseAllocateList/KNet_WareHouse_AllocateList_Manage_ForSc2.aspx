<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_WareHouse_AllocateList_Manage_ForSc2.aspx.cs" Inherits="KNet_WareHouse_AllocateList_Manage_ForSc2" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
	...
	<a class="hdrLink" href="KNet_WareHouse_AllocateList_Manage_ForSc2.aspx">维修品库间调拨</a>
                </td>
                <td width="100%" nowrap>
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;"><a href="javascript:;" onclick="PageGo('KNet_WareHouse_AllocateList_Add.aspx?Type=<%= Request.QueryString["Type"]==null?"":Request.QueryString["Type"].ToString() %>')">
                                                        <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 维修品库间调拨..." title="创建 维修品库间调拨..." border="0"></a></td>
                                                    ...
                                                    <td style="padding-right: 10px"><a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 维修品库间调拨..." title="查找 维修品库间调拨..." border="0"></a></td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 维修品库间调拨" title="*导入 维修品库间调拨" border="0"></td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 维修品库间调拨" title="*导出 维修品库间调拨" border="0"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
                                            ...
                                            <tr>
                    <td>      <%=base.Base_BindViewByTitle("月份","Cg_Order_MaterialDbIN", "KNet_WareHouse_AllocateList_Manage_ForSc2.aspx","and PBW_Order  in ('0')","WhereID", this.Tbx_WhereID.Text,"&WhereID1="+this.Tbx_WhereID1.Text)%>
                  
                    </td>
                </tr>
                                    <tr>
                    <td>
                        <%=base.Base_BindViewByTitle("其他","Cg_Order_MaterialDbIN", "KNet_WareHouse_AllocateList_Manage_ForSc2.aspx","and PBW_Order not in ('0')","WhereID1", this.Tbx_WhereID1.Text,"&WhereID="+this.Tbx_WhereID.Text)%>
                    </td>
                </tr>
