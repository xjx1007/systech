...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>库存调拨 > 
                                ...
                                <td style="height: 44px">
                                    ...
                                    <td class="dvtTabCache" style="width:10px" nowrap>&nbsp;</td>
                                                ...
                                                <td <%=s_OrderStyle%> align="center" nowrap>
                                                    <a href="KNet_WareHouse_WareCheck_View.aspx?Type=0&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                        发货出库单信息</a>
                                                </td>
                                    <td class="dvtTabCache" style="width:10px">&nbsp;</td>			
                                                <td <%=s_DetailsStyle%> align="center" nowrap>
                                                    <a href="KNet_WareHouse_WareCheck_View.aspx?Type=1&ID=<%= Request.QueryString["ID"].ToString() %>">
                                                        相关信息</a>
