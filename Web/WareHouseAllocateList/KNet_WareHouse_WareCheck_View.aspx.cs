...
public partial class Web_KNet_WareHouse_WareCheck_View : BasePage
{
    ...
    private void ShowInfo(string s_ID)
    {
        ...
        try
        {
            ...
            DataSet Dts_Details = BLL_Details.GetList(" AllocateNo='" + model.AllocateNo + "'");
            if (Dts_Details.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < Dts_Details.Tables[0].Rows.Count; i++)
                {
                    ...
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + base.Base_GetProdutsName(Dts_Details.Tables[0].Rows[i]["ProductsBarCode"].ToString()) + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + base.Base_GetProductsCode(Dts_Details.Tables[0].Rows[i]["ProductsBarCode"].ToString()) + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + base.Base_GetProductsEdition(Dts_Details.Tables[0].Rows[i]["ProductsBarCode"].ToString()) + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + Dts_Details.Tables[0].Rows[i]["AllocateAmount"].ToString() + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + Dts_Details.Tables[0].Rows[i]["AllocateUnitPrice"].ToString() + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + Dts_Details.Tables[0].Rows[i]["AllocateTotalNet"].ToString() + "</td>";
                    Lbl_Details.Text += "<td class=\"ListHeadDetails\">" + Dts_Details.Tables[0].Rows[i]["AllocateRemarks"].ToString() + "&nbsp;</td>";
