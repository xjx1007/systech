<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zl_Project_Inspection_List.aspx.cs" Inherits="Zl_Project_Inspection_List" %>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                工作台 > <a class="hdrLink" href="Zl_Project_Inspection_List.aspx"><asp:Label runat="server" ID="Lbl_Title"></asp:Label></a>
            </td>
            <td width="100%" nowrap>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="5">
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Zl_Project_Inspection_Add.aspx')">
                                                        <img src="../../../themes/softed/images/btnL3Add.gif" alt="创建 检验记录..." title="创建 检验记录..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="../../../themes/softed/images/btnL3Search.gif" alt="查找 检验记录..." title="查找 检验记录..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="../../../themes/softed/images/tbarImport.gif" alt="*导入 检验记录" title="*导入 检验记录"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../../themes/softed/images/tbarExport.gif" alt="*导出 检验记录" title="*导出 检验记录"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <%=base.Base_BindView("Zl_Project_Inspection", "Zl_Project_Inspection_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
            </td>
        </tr>
        <tr>
            <td>
                    ...
                    <table cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv1 small" align="center"
                        ...
                        <tr>
                            ...
                            <td nowrap class="small">
                                <b>
                                    <input name="matchtype" id="matchtype1" type="radio" runat="server" value="all">&nbsp;匹配以下所有检验记录</b>
                            </td>
                            <td nowrap width="60%" class="small">
                                <b>
                                    <input name="matchtype" id="matchtype2" type="radio" value="any" runat="server" checked>&nbsp;匹配以下任意检验记录</b>
                            </td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="5" width="80%" class="searchUIAdv3 small"
                        ...
                        <tr>
                            <td align="left" width="40%">
                                <input type="button" name="more" value=" 增加检验记录 " onclick="fnAddSrch('<%=Base_GetBindSearch("Zl_Project_Inspection")%>','<option value=\'cts\'>包含</option><option value=\'dcts\'>不包含</option><option value=\'is\'>等于</option><option value=\'isn\'>不等于</option><option value=\'bwt\'>开始为</option><option value=\'grt\'>大于</option><option value=\'lst\'>小于</option><option value=\'grteq\'>大于等于</option><option value=\'lsteq\'>小于等于</option>')"
                                    class="crmbuttom small edit">
                                <input name="button" type="button" value=" 删除检验记录 " onclick="delRow()" class="crmbuttom small edit">
                            </td>
                            ...
                            <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                               ...
                               OnRowDataBound="GridView1_DataRowBinding">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="检验记录名称" SortExpression="ZPI_Title" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <a href="Zl_Project_Inspection_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPI_ID") %>">
                                                <%# DataBinder.Eval(Container.DataItem, "ZPI_Title")%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="记录编号" DataField="ZPI_Code" SortExpression="ZPI_Code" HtmlEncode="false">
                                    ...
                                    <asp:TemplateField HeaderText="样品主题" SortExpression="PPS_Name" ItemStyle-HorizontalAlign="Left"
                                        ...
                                        <ItemTemplate>
                                            <a href="../../ProductsSample/Pb_Products_Sample_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPI_SampleID") %>" target="_blank">
                                                <%# DataBinder.Eval(Container.DataItem, "ZPI_SampleName").ToString()%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="需求日期" DataField="ZPI_STime" SortExpression="ZPI_STime"
                                        DataFormatString="{0:yyyy-MM-dd}" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="center">
                                        <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                        <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="状态" SortExpression="ZPI_State" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("251",DataBinder.Eval(Container.DataItem, "ZPI_State").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="类型" SortExpression="ZPI_Type" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("252",DataBinder.Eval(Container.DataItem, "ZPI_Type").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="审核" SortExpression="ZPI_ID" ItemStyle-HorizontalAlign="center"
                                        HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <%# getShState(DataBinder.Eval(Container.DataItem, "ZPI_ID").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <a href="Zl_Project_Inspection_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ZPI_ID") %>">
