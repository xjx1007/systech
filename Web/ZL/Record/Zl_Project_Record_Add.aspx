<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Zl_Project_Record_Add.aspx.cs"
    Inherits="Zl_Project_Record_Add" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 ><a class="hdrLink" href="PB_Basic_Where_List.aspx">现场记录添加</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>现场记录
                                            </td>
