<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zl_Project_Record_View.aspx.cs"
    Inherits="Zl_Project_Record_View" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                工作台 > <a class="hdrLink" href="Zl_Project_Record_List.aspx">查看现场记录</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
