<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Zl_Quality_Cost_Add.aspx.cs"
    Inherits="Zl_Quality_Cost_Add" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 ><a class="hdrLink" href="Zl_Quality_Cost_List.aspx">品质成本添加</a>
                </td>
                                ...
                                <td>
                                    <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                        <tr>
                                            ...
                                            <td class="dvtSelectedCell" align="center" nowrap>质量成本
                                            </td>
                                                ...
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo" align="left">
                                                            ...
                                                            <asp:DropDownList runat="server" ID="ddl_ProjectType" AutoPostBack="true" OnSelectedIndexChanged="ddl_ProjectType_SelectedIndexChanged"></asp:DropDownList><font
                                                                    color="red">*</font>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="dvtCellInfo" align="left" >
                                                            <asp:DropDownList runat="server" ID="ddl_ContentType"></asp:DropDownList><font
                                                                    color="red">*</font>
                                                        </td>
