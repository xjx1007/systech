<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zl_Quality_Cost_View.aspx.cs"
    Inherits="Zl_Quality_Cost_View" %>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                工作台 > <a class="hdrLink" href="Zl_Project_Record_List.aspx">查看质量成本</a>
            </td>
            <td width="100%" nowrap>
            </td>
        </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input title="编辑 [Alt+E]" type="button" accesskey="E" class="crmbutton small edit"
                                                            onclick="PageGo('Zl_Project_Record_Add.aspx?ID=<%=Request.QueryString["ID"].ToString() %>')"
                                                            name="Edit" value="&nbsp;编辑&nbsp;">&nbsp;
                                                        <input title="共享" class="crmbutton small edit" onclick="" type="button" name="Share"
                                                            value="&nbsp;共享&nbsp;">&nbsp;
                                                        <input title="" class="crmbutton small edit" onclick="PageGo('Zl_Project_Record_List.aspx')"
                                                            type="button" name="ListView" value="&nbsp;返回列表&nbsp;">&nbsp;
                                                    </td>
                                                    <td align="right">
                                                        <input title="复制 [Alt+U]" type="button" accesskey="U" class="crmbutton small create"
                                                            onclick="PageGo('Zl_Project_Record_Add.aspx?ID=<%= Request.QueryString["ID"].ToString() %>&Type=1')"
                                            ...
                                            <td align="right" valign="top">
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">金额：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" >
                                                            <asp:Label ID="Tbx_Money"  runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">项目：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" >
                                                            <asp:Label runat="server" ID="Ddl_ProjectType"></asp:Label>
                                                        </td>
                                                        <td width="16%" height="25" align="right" class="dvtCellLabel">内容：
                                                        </td>
                                                        <td class="dvtCellInfo" align="left" >
                                                            <asp:Label runat="server" ID="Ddl_ContentType"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
