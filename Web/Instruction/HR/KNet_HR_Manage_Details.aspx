<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_HR_Manage_Details.aspx.cs" Inherits="Knet_Web_HR_KNet_HR_Manage_Details" %>
...
<table width="98%" height="241" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
      ...
      <tr>
        ...
        <td width="33%" style="border-bottom:#333333 1px solid;">&nbsp;<asp:Label ID="StaffName" runat="server" Text=""></asp:Label>  </td>
      </tr>
      ...
      <tr>
        ...
        <td colspan="3" style="border-bottom:#333333 1px solid;" ><asp:Label ID="StaffRemarks" runat="server" Text=""></asp:Label>&nbsp;</td>
      </tr>
      <tr>
