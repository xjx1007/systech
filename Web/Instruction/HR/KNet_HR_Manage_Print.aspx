<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_HR_Manage_Print.aspx.cs" Inherits="Knet_Web_KNet_HR_Manage_Print" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table width="98%" height="241" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="16%" height="25" align="right" style="border: 1px solid #000000;">出差人:</td>
                    <td align="left"
