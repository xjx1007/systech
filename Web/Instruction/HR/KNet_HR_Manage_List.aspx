<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_HR_Manage_List.aspx.cs" Inherits="KNet_HR_Manage_List" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 >
	<a class="hdrLink" href="KNet_HR_Manage_List.aspx">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="small">
            <tr>
                <td>
                    <%=base.Base_BindView("KNet_Resource_Staff", "KNet_HR_Manage_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" width="100%" class="small">
                        ...
                        <tr>
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关人员记录</B><br/><br/></font></div>"
                                    AutoGenerateColumns="False" CssClass="Custom_DgMain" Width="100%" AllowPaging="true" PageSize="15">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="StaffTel" ItemStyle-Font-Size="13px" HeaderText="联系电话" HeaderStyle-Font-Size="13px" SortExpression="StaffTel">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="13px" Height="18px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="13px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="StaffEmail" ItemStyle-Font-Size="13px" HeaderText="邮箱"  HeaderStyle-Font-Size="13px" SortExpression="StaffEmail">
