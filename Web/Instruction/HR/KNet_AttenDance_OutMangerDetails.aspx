...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td height="31" colspan="2" align="right" valign="bottom" style="border-bottom:#333333 2px solid;" >申请人:<asp:Label ID="StaffName" runat="server" Text=""></asp:Label> &nbsp;卡号:<asp:Label ID="StaffCard" runat="server" Text=""></asp:Label>&nbsp;&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr id="ADDsPart" runat="server" visible="false">
    ...
    <td style="border-bottom:#333333 1px solid;">&nbsp;</td>
      ...
      <tr>
    <td height="35" align="right"   style="border-bottom:#333333 1px solid;">
