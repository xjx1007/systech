<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZL_Task_InstructionYN.aspx.cs" Inherits="Knet_Web_Sales_pop_ContractListCheckYN" %>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <div>
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 >作业指导书审核
                    </td>
    ...
    <asp:Button ID="Button1" runat="server" Text="确定审核" class="crmbutton small save" OnClick="Button1_Click" Style="width: 70px; height: 33px;" />&nbsp;<input name="button2" type="button" value="关闭本窗口" class="crmbutton small cancel" onclick="closeWindow();" style="width: 70px; height: 33px;">
                    </td>
                </tr>
                <tr>
