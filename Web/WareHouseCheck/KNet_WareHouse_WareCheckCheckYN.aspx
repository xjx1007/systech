<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KNet_WareHouse_WareCheckCheckYN.aspx.cs" Inherits="Knet_Web_WaareHouse_pop_KNet_WareHouse_WareCheckCheckY" %>
...
<table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="150" background="../../images/ktxt1.gif" style="background-color:#F5F5F5; height:28px; width:130px;padding-left:20px;"><div class="TP2">盘点单审核</div></td>
...
<asp:Label ID="DirectInNotxt" runat="server" Text="" Visible="false"></asp:Label>


<table width="100%" height="102" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="36%" height="30" align="right" style="border-bottom:#A3B2CC 1px solid;">盘点审核选择：</td>
