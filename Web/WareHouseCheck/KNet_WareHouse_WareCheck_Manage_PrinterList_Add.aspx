<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  CodeFile="KNet_WareHouse_WareCheck_Manage_PrinterList_Add.aspx.cs" Inherits="Knet_Web_WareHouse_KNet_WareHouse_WareCheck_Manage_PrinterList_Add" %>
...
<tr>
	<td height="28" colspan="4">&nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="确定库存盘点单打印模板添加" CssClass="Btt" OnClick="Button2_Click1"  /></td>
	</tr>
</table>
