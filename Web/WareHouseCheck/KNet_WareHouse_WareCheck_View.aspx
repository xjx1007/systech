...
<tr>
	...
	<a class="hdrLink" href="KNet_WareHouse_WareCheck_Manage.aspx">库存盘点</a>
        </td>
	<td width=100% nowrap>
                ...
                <table width="95%" border="0" align="center"  cellpadding="0" cellspacing="0"   >
                            <tr valign="bottom">
                                <td style="height: 44px">
                                    ...
                                    <td class="dvtSelectedCell" align="center" nowrap>库存盘点信息</td>
                            ...
                            <tr>
                             ...
                             <tr>
                                 <td>
                                        ...
                                        <tr>
                                        <td  class="dvtCellLabel" >盘点单号:</td>
                                        <td class="dvtCellInfo">
                                        <asp:Label ID="Lbl_Code"  runat="server"  ></asp:Label>
                                        </td>
                                        <td  class="dvtCellLabel" >盘点日期:</td>
                                        <td  class="dvtCellInfo">
