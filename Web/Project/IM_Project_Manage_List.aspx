<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IM_Project_Manage_List.aspx.cs" Inherits="IM_Project_Manage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("IM_Project_Manage", "IM_Project_Manage_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="客户" SortExpression="IPM_CustomerValue" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                    <%# base.Base_GetCustomerName_Link(DataBinder.Eval(Container.DataItem, "IPM_CustomerValue").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="修改" HeaderStyle-HorizontalAlign="center" HeaderStyle-Width="30px">
                                            <ItemTemplate>
                                                <a href="IM_Project_Manage_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "IPM_ID")%>">
