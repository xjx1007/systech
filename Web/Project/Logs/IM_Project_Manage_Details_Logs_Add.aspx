<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="IM_Project_Manage_Details_Logs_Add.aspx.cs"
    Inherits="IM_Project_Manage_Details_Logs_Add" %>
...
<head>
    ...
    <script language="JavaScript" type="text/javascript" src="/Web/include/js/general.js"></script>
    <script language="javascript" type="text/javascript" src="/Web/include/scriptaculous/prototype.js"></script>
    <script language="javascript" type="text/javascript" src="/Web/include/scriptaculous/scriptaculous.js"></script>
    <script language="javascript" type="text/javascript" src="/Web/include/scriptaculous/dom-drag.js"></script>
    <title>添加日志</title>
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>研发 > <a class="hdrLink" href="Pb_Basic_Notice_List.aspx">添加日志</a>
                </td>
                    ...
                    <div class="small" style="padding: 20px">
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvtContentSpace">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <asp:DropDownList runat="server" ID="Ddl_Name" AllowSelect="false" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="Ddl_Name_SelectedIndexChanged"></asp:DropDownList>
                                            </td>

                                            <td width="16%" align="right" class="dvtCellLabel">状态：
                                            </td>
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PDropdownList runat="server" ID="Ddl_State" Enabled="false" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                            </td>
                                        </tr>
                                        <asp:Panel runat="server"  Enabled="false">
                                        <tr>

                                            <td width="16%" align="right" class="dvtCellLabel">上级任务：
                                            </td>
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PDropdownList runat="server" ID="Ddl_FIDDetials" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PDropdownList runat="server" ID="Ddl_Import" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="16%" align="right" class="dvtCellLabel">结束时间：
                                            </td>
                                            <td class="dvtCellInfo" align="left">
                                        ...
                                        <tr>
                                            <td height="25" align="right" class="dvtCellLabel">描述：
                                            </td>
                            ...
                            <tr>
                                ...
                                <td width="16%" align="right" class="dvtCellLabel">本期使用：
                                </td>
                                <td class="dvtCellInfo" align="left">
                                    <pc:PTextBox ID="Tbx_UseDays" Width="200px" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"></pc:PTextBox>

                                </td>
                                <td width="16%" align="right" class="dvtCellLabel">进度：
                                </td>
                                <td class="dvtCellInfo" align="left">
                                    <pc:PDropdownList runat="server" ID="Ddl_LogsPrecet" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                </td>
                            </tr>

                            <tr>
                                <td height="25" align="right" class="dvtCellLabel">进度说明：
                                </td>
                                <td colspan="3" align="left" class="dvtCellInfo">
                                    <asp:TextBox ID="Tbx_LogRemarks" runat="server" TextMode="MultiLine" Height="50px" Width="500px"></asp:TextBox>
                        ...
                        <asp:TextBox ID="Tbx_OldPrecent" runat="server" CssClass="Custom_Hidden" Text="0"></asp:TextBox>
                </td>
