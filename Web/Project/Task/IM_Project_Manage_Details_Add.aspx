                                ...
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvtContentSpace">
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PDropdownList runat="server" ID="Ddl_ProjectType" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                            </td>

                                            <td width="16%" align="right" class="dvtCellLabel">状态：
                                            </td>
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PDropdownList runat="server" ID="Ddl_State" AllowSelect="false" Width="200px"></pc:PDropdownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <pc:PTextBox ID="Tbx_Days" Width="100px" runat="server" CssClass="detailedViewTextBox" OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"></pc:PTextBox>
                                                (单位)
                                                <pc:PDropdownList runat="server" ID="Ddl_DayType" AllowSelect="false" Width="50px"></pc:PDropdownList>(<font color="red">*</font>)<asp:RequiredFieldValidator
                                            ...
                                            <td class="dvtCellInfo" align="left">
                                                <asp:RadioButtonList runat="server" ID="Rad_HolidayType" RepeatColumns="4"></asp:RadioButtonList>
                                            </td>
                                        </tr>
