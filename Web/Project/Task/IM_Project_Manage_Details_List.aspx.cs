...
public partial class IM_Project_Manage_Details_List : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            base.Base_DropBatchBind(this.Ddl_Batch, "IM_Project_Manage_Details", "IPM_DutyPerson");
            base.Base_DropBindSearch(this.bas_searchfield, "IM_Project_Manage_Details");
    ...
    {
        string sql = "Update IM_Project_Manage_Details set IPMD_Del='1' "; //删除
        sql +=" where";
