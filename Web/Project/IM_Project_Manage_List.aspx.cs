...
public partial class IM_Project_Manage : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            base.Base_DropBatchBind(this.Ddl_Batch, "IM_Project_Manage", "IPM_DutyPerson");
            base.Base_DropBindSearch(this.bas_searchfield, "IM_Project_Manage");
            base.Base_DropBindSearch(this.Fields, "IM_Project_Manage");
