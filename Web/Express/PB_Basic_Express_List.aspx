<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Basic_Express_List.aspx.cs" Inherits="PB_Basic_Express_List" %>
...
<body>
    ...
    <script>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>工作台 > <a class="hdrLink" href="PB_Basic_Express_List.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('PB_Basic_Express_Add.aspx')">
                                                            <img src="../../themes/softed/images/btnL3Add.gif" alt="创建 快递跟踪..." title="创建 快递跟踪..."
                                                                border="0"></a>
                                                    </td>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <a href="javascript:;" onclick="ShowDiv();">
                                                            <img src="../../themes/softed/images/btnL3Search.gif" alt="查找 快递跟踪..." title="查找 快递跟踪..."
                                                                border="0"></a>
                                                    </td>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <img src="../../themes/softed/images/tbarImport.gif" alt="*导入 快递跟踪" title="*导入 快递跟踪"
                                                            border="0">
                                                    </td>
                                                    <td style="padding-right: 10px">
                                                        <img src="../../themes/softed/images/tbarExport.gif" alt="*导出 快递跟踪" title="*导出 快递跟踪"
                                                            border="0">
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("PB_Basic_Express", "PB_Basic_Express_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="编号" SortExpression="PBE_Code" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <a href="PB_Basic_Express_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBE_ID") %>">
                                                    <%# DataBinder.Eval(Container.DataItem, "PBE_Code")%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="责任人" SortExpression="PBE_DutyPerson" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "PBE_DutyPerson").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="开始日期" DataField="PBE_STime" SortExpression="PBE_STime"
                                            DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="发件人" DataField="PBE_LinkManName" SortExpression="PBE_LinkManName"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="发件人手机" DataField="PBE_Phone" SortExpression="PBE_Phone"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="收件人" DataField="PBE_ReLinkManName" SortExpression="PBE_ReLinkManName"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="收件人手机" DataField="PBE_RePhone" SortExpression="PBE_RePhone"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="快递名称" DataField="PBE_KDName" SortExpression="PBE_KDName"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="快递单号" DataField="PBE_KDCode" SortExpression="PBE_KDCode"
                                            HtmlEncode="false">
                                            <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                            <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="快递状态" SortExpression="PBE_KDName" ItemStyle-HorizontalAlign="Left"
                                            HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# GetKDSateName(DataBinder.Eval(Container.DataItem, "PBE_ID").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="打印" HeaderStyle-HorizontalAlign="center">
                                            <ItemTemplate>
                                                <a target="_blank" href="PB_Basic_Express_Print.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "PBE_ID") %>">
