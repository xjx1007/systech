<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_DlCkList.aspx.cs" Inherits="Web_Report_Xs_List_CkList" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OutToFileMoreSheet() {
            ...
            LODOP.SET_SAVE_MODE("Caption", "代理费明细");
            LODOP.SET_SAVE_MODE("RETURN_FILE_NAME", 1);
            LODOP.SAVE_TO_FILE("代理费明细.xls");
        };
    </script>
