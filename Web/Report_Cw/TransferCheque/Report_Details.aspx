...
<head>
    ...
    <script language="JAVASCRIPT">
        ...
        function OnClick() {
            ...
            var Use = document.all('Tbx_Use').value;
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form2" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>单据报表 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">存货收发结存表</a>
                </td>
                                ...
                                <td align="right" valign="top">
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="16%" align="right" class="dvtCellLabel">用途:
                                            </td>
                                            <td class="dvtCellInfo" align="left" >
                                                <asp:TextBox ID="Tbx_Use" CssClass="detailedViewTextBox" Width="200px"
                                                    OnFocus="this.className='detailedViewTextBoxOn'" OnBlur="this.className='detailedViewTextBox'"
                                                    runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
