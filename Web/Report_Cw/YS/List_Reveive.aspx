<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Reveive.aspx.cs"
...
<body>
    ...
    <div>
        ...
        <asp:Button runat="server" ID="Button3" Text="包含核销" OnClick="Button3_Click" />
        <asp:Button runat="server" ID="Button5" Text="不包含核销" OnClick="Button5_Click" />
    ...
    <asp:TextBox  runat="server" ID="Tbx_Hx" CssClass="Custom_Hidden"></asp:TextBox>
    </form>
</body>
</html>
