<%@ Page Language="C#" AutoEventWireup="true" CodeFile="List_Bank.aspx.cs"
    Inherits="Web_List_Bank" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "票据往来结存表");
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("票据往来结存表.xls");
	};	       
    </script>
