<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_AttenDance_OutManger_List_View.aspx.cs"
    Inherits="KNet_AttenDance_OutManger_List_View" %>
...
.Custom_Hidden
{
	...
	function OutToFileMoreSheet() {
		...
		LODOP.SET_SAVE_MODE("Caption", "员工考勤报表");					
		LODOP.SET_SAVE_MODE("RETURN_FILE_NAME",1);
		LODOP.SAVE_TO_FILE("员工考勤报表.xls");		
	};	       
    </script>
