<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_HR_Manage.aspx.cs"
    Inherits="Knet_Web_HR_KNet_HR_Manage" %>
                            ...
                            <td>
                                ...
                                <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True" IsShowEmptyTemplate="true" EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关人员记录</B><br/><br/></font></div>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="负责销售" SortExpression="IsSale" HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("771",DataBinder.Eval(Container.DataItem, "IsSale").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="外网" SortExpression="KRS_IsWeb" HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <%# base.Base_GetBasicCodeName("771",DataBinder.Eval(Container.DataItem, "KRS_IsWeb").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
