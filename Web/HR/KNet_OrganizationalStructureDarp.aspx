<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_OrganizationalStructureDarp.aspx.cs"
    Inherits="KNet_Web_HR_OrganizationalStructureDarp" %>
...
<div style="height:480px; overflow:auto; background-color:#EEF3F9; border-right:#3399CC 1px solid;">
   <asp:TreeView ID="TreeView1" runat="server"  PopulateNodesFromClient="False"  ShowLines="true"  ExpandDepth=2  EnableClientScript="false"   Enabled="false"  ></asp:TreeView>
</div></td>
...
<table width="100%" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <asp:GridView ID="GridView1" runat="server" RowStyle-Height="25px" HeaderStyle-Height="25px" AllowSorting="True"  EmptyDataText="<div align=center><font color=red><br/><br/><B>没有找到相关记录</B><br/><br/></font></div>"  GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false"  ShowHeader="true" 
      ...
      <asp:TemplateField HeaderText="分部名称" HeaderStyle-Font-Size="12px"  ItemStyle-Width="30%"    SortExpression="StrucPID" ControlStyle-Width="120px"  ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
          <EditItemTemplate> 
              <asp:DropDownList ID="BigNoSelect" runat="server"></asp:DropDownList><asp:Label id="BigNOS"  runat="server"  Text='<%# Eval("StrucPID") %>' Visible="false"></asp:Label> 
          </EditItemTemplate>
          <ItemTemplate>
          <%# GetBigCateNane(DataBinder.Eval(Container.DataItem, "StrucPID"))%>
          </ItemTemplate>
      </asp:TemplateField>
      
      
      
        <asp:BoundField  DataField="StrucName"   HeaderText="部门名称" ControlStyle-CssClass="Boxx" ControlStyle-Width="150px" SortExpression="StrucName">
...
<table width="99%" border="0" align="center" height="25" cellpadding="0" cellspacing="0" style="border-bottom:#BAC5D9 1px solid;border-top:#BAC5D9 1px solid;border-left:#BAC5D9 1px solid;border-right:#BAC5D9 1px solid" >
  <tr >
    <td height="25" colspan="4" align="left" bgcolor="#EEF3F9" style="border-bottom:#cccccc 0px solid;">&nbsp;&nbsp;<font color="gray">分部部门列表，您可以任意给分部添加部门.</font></td>
    <td height="25" bgcolor="#EEF3F9" align="right">&nbsp;<asp:Button ID="Button2" runat="server" Text="添加部门" CssClass="Btt" OnClick="Button2_Click" /></td>
  </tr>
<tr id="AddNewsCompany" runat="server" visible="false">
    <td width="218" height="27" align="center">
        <asp:DropDownList ID="DropDownList1" runat="server">
</asp:DropDownList>(<font color="red">*</font>)<asp:RequiredFieldValidator
            ID="RequiredFieldValidator3" runat="server" ErrorMessage="非空！" ControlToValidate="DropDownList1" Display="Dynamic" ></asp:RequiredFieldValidator></td>
    <td width="301" align="left"><asp:TextBox ID="txtStrucName" Width="120px" runat="server" CssClass="Boxx"></asp:TextBox>(<font color="red">*</font>)<asp:RequiredFieldValidator
    ...
    <td width="142"  align="right">排序号：</td>
    <td width="130" align="left"><asp:TextBox ID="txtStrucPai" MaxLength=5 Text="10" Width="40px" runat="server" CssClass="Boxx"></asp:TextBox>(<font color="red">*</font>)<asp:RequiredFieldValidator
