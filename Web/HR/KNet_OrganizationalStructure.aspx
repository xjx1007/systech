<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_OrganizationalStructure.aspx.cs"
    Inherits="KNet_Web_HR_OrganizationalStructure" %>
                                ...
                                <table width="99%" border="0" align="center" height="25" cellpadding="0" cellspacing="0" style="border-bottom: #BAC5D9 1px solid; border-top: #BAC5D9 1px solid; border-left: #BAC5D9 1px solid; border-right: #BAC5D9 1px solid">
                                    ...
                                    <tr id="AddNewsCompany" runat="server" visible="false">
                                        ...
                                        <td width="332" align="left">
                                            <asp:TextBox ID="txtStrucName" Width="150px" runat="server" CssClass="Boxx"></asp:TextBox>(<font color="red">*</font>)<asp:RequiredFieldValidator
