<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="KNet_HR_Manage_Update.aspx.cs"
    Inherits="Knet_Web_HR_KNet_HR_Manage_Update" %>
        ...
        <table height="22" border="0" cellpadding="0" cellspacing="0" width="99%" align="center">
            <tr>
                <td width="78" align="center">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="KNet_HR_Manage.aspx" CssClass="Div11" Width="78px" Height="21px" Font-Size="14px">人员列表</asp:HyperLink></td>
                <td width="4" align="center"></td>
                <td width="78" align="center">
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="KNet_HR_Manage_Add.aspx" CssClass="Div11" Width="78px" Height="21px" Font-Size="14px">人员添加</asp:HyperLink></td>
                <td width="78" align="center">
                    <asp:HyperLink ID="HyperLink3" runat="server" CssClass="Div22" Width="78px" Height="21px" Font-Size="14px" Font-Bold="true" ForeColor="MintCream">人员修改</asp:HyperLink></td>
                <td width="4" align="center"></td>
                <td align="center">&nbsp;</td>
            </tr>
        </table>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablecss">
          ...
          <asp:TextBox ID="StaffCard1" runat="server" CssClass="Boxx2" Width="150px" MaxLength="20" ReadOnly="true"></asp:TextBox>(<font color="red">*</font>)<asp:RequiredFieldValidator
              ID="RequiredFieldValidator1" runat="server" ErrorMessage="不能为空！" ControlToValidate="StaffCard1" Display="Dynamic"></asp:RequiredFieldValidator>
                                        ...
                                        <td width="32%" align="left" class="tdcss">
                                            <asp:TextBox ID="StaffName1" runat="server" MaxLength="30" CssClass="Boxx2" Width="150px" ReadOnly="true"></asp:TextBox>(<font color="red">*</font>)<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="员工姓名必填" ControlToValidate="StaffName1" Display="Dynamic"></asp:RequiredFieldValidator></td>
                                    </tr>
          ...
          <asp:TextBox ID="StaffPassword1" TextMode="Password" runat="server" MaxLength="30" CssClass="Boxx" Width="150px"></asp:TextBox><font color="gray">(如不修改,请留空)</font><asp:RegularExpressionValidator
              ID="RegularExpressionValidator2" runat="server" ErrorMessage="密码长度在5-18之间的数字与字母组合！" ControlToValidate="StaffPassword1" ValidationExpression="^\w{5,17}$" Display="Dynamic"></asp:RegularExpressionValidator>
                                        ...
                                        <td align="left" class="tdcss">
                                            <asp:TextBox ID="StaffPassword2" TextMode="Password" MaxLength="30" runat="server" CssClass="Boxx" Width="150px"></asp:TextBox><asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="确认不正确" ControlToCompare="StaffPassword1" ControlToValidate="StaffPassword2" Display="Dynamic"></asp:CompareValidator></td>
                                    </tr>
          ...
          <asp:TextBox ID="StaffTel1" runat="server" MaxLength="20" CssClass="Boxx" Width="150px"></asp:TextBox><asp:RegularExpressionValidator
              ID="RegularExpressionValidator4" runat="server" ErrorMessage="电话号码不正确!" ControlToValidate="StaffTel1" ValidationExpression="^(\(\d{3,4}\)|\d{3,4}-)?\d{7,11}$" Display="Dynamic"></asp:RegularExpressionValidator></td>
                                        ...
                                        <td align="left" class="tdcss">
                                            <asp:TextBox ID="StaffEmail1" runat="server" MaxLength="60" CssClass="Boxx" Width="150px"></asp:TextBox><asp:RegularExpressionValidator
          ...
          <asp:TextBox ID="StaffIDCard1" MaxLength="30" runat="server" CssClass="Boxx" Width="150px"></asp:TextBox><asp:RegularExpressionValidator
              ID="RegularExpressionValidator5" runat="server" ErrorMessage="身份证号码不正确" ControlToValidate="StaffIDCard1" ValidationExpression="\d{17}[\d|X]|\d{15}" Display="Dynamic"></asp:RegularExpressionValidator></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" align="left" class="tdcss">
