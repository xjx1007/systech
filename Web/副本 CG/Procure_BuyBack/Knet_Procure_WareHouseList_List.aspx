    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                不良品退货 > <a class="hdrLink" href="Knet_Procure_WareHouseList_List.aspx">不良品退货</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Knet_Procure_WareHouseList_Add.aspx')">
                                                        <img src="../../../themes/softed/images/btnL3Add.gif" alt="创建 不良品退货..." title="创建 不良品退货..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv()">
                                                        <img src="../../../themes/softed/images/btnL3Search.gif" alt="查找 不良品退货..." title="查找 不良品退货..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="Knet_Procure_WareHouseList_ExcelAdd.aspx"><img src="../../../themes/softed/images/tbarImport.gif" alt="*导入 不良品退货" title="*导入 不良品退货"
                                                        border="0"> </a>
                                                    
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="../../../themes/softed/images/tbarExport.gif" alt="*导出 不良品退货" title="*导出 不良品退货"
                                                        border="0">
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <td>
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="不良品退货编号" SortExpression="WareHouseNo" ItemStyle-HorizontalAlign="Left"
...
●<a style="color: rgb(153, 102, 51);" href="javascript:;" onclick="PageGo('../../Report_Cg/OrderIn/Report_OrderIn.aspx')">不良品退货明细</a>
      </td>       
    </tr>
