...
public partial class Web_Sales_Knet_Procure_OpenBilling_Print : BasePage
{
    ...
    private void ShowInfo(string s_ID)
    {
        ...
        this.Lbl_SuppNo.Text = Model_Supp.SuppName + "  " + Model_Supp.SuppPeople;
        this.Lbl_Person.Text =" "+Model_Supp.SuppPeople;
        ...
        this.Lbl_FromDetails.Text = base.Base_GeDept(Model_STaff.StaffBranch) + "  " + Model_STaff.StaffName;
