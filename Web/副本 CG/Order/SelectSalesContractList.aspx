    ...
    <form id="form1" runat="server">
        <div>
            <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                ...
                <tr>
                    <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>选择合同单 >选择合同单
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="small">
                            <tr>
                                <td class="dvtCellLabel" width="10%" style="height: 30px; text-align: right">日期：</td>
                                <td class="dvtCellInfo" width="50%" style="height: 30px; text-align: left" >
                                    <asp:TextBox ID="StartDate" runat="server" CssClass="Wdate" onFocus="var EndDate=$dp.$('EndDate');WdatePicker({maxDate:'#F{$dp.$D(\'EndDate\')}'})"></asp:TextBox>&nbsp;到<asp:TextBox ID="EndDate" runat="server" CssClass="Wdate" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'StartDate\')}'})"></asp:TextBox></td>
                                
                                <td class="dvtCellLabel" width="15%" style="height: 30px; text-align: right">订单编号：</td>
                                <td class="dvtCellInfo" width="25%" style="height: 30px; text-align: left">
                                    <asp:TextBox ID="Tbx_ContractNo" runat="server" CssClass="detailedViewTextBox" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="dvtCellLabel" width="10%" style="height: 30px; text-align: right">采购状态：</td>
                                <td class="dvtCellInfo" width="50%" style="height: 30px; text-align: left">
                                ...
                                <td class="dvtCellLabel" width="15%" style="height: 30px; text-align: right">客户名称：</td>
                                <td class="dvtCellInfo" width="25%" style="height: 30px; text-align: left">
                                    <asp:TextBox ID="Tbx_Name" runat="server" CssClass="Boxx" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="dvtCellLabel" width="10%" style="height: 30px; text-align: right">合同状态：</td>
                                <td class="dvtCellInfo" width="50%" style="height: 30px; text-align: left" colspan="3">
                                    ...
                                    <asp:Button ID="Button4" runat="server" Text="合同单检索" CssClass="crmbutton small save" OnClick="Button4_Click" /></td>
                            </tr>
                        ...
                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" EmptyDataText="<div align=center><font color=red><br/><br/><B>暂没有找到相关可发货的合同记录，请先确认审核合同可发货.</B><br/><br/></font></div>" GridLines="None" Width="100%" HorizontalAlign="center" AutoGenerateColumns="false" ShowHeader="true" HeaderStyle-Height="25px">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="合同编号" SortExpression="ContractNo" HeaderStyle-Font-Size="12px" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <a href="#" onclick="javascript:window.open('/Web/Xs/SalesContract/KNet_Sales_ContractList_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ContractNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');"><%# DataBinder.Eval(Container.DataItem, "ContractNo").ToString()%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="订单分类" SortExpression="ContractClass" HeaderStyle-Font-Size="12px"
                                ...
                                <asp:BoundField HeaderText="电池" DataField="v_ContractBatteryAmount" SortExpression="v_ContractBatteryAmount"
                                    HtmlEncode="false">
                                    <ItemStyle HorizontalAlign="Left" Font-Size="12px" />
                                    <HeaderStyle HorizontalAlign="Left" Font-Size="12px" />
                                </asp:BoundField>

                                <asp:TemplateField HeaderText="产品类型" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="160px"
                                ...
                                <asp:TemplateField HeaderText="查看" HeaderStyle-Font-Size="12px" ItemStyle-Width="28px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        <a href="#" onclick="javascript:window.open('../SalesContract/Xs_ContractList_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "ContractNo")%>','查看详细','top=120,left=150,toolbar=no, menubar=no,scrollbars=yes, resizable=no, location=no, status=no, width=780,height=500');">
                                            <asp:Image ID="Image2" runat="server" ImageUrl="../../../images/View.gif" border="0" ToolTip="查看合同详细信息" /></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top: 1px solid #A3B2CC;">
                            <tr>
                                <td height="30" width="58%">
                                    <asp:TextBox runat="server" ID="Tbx_ID" CssClass="Custom_Hidden"></asp:TextBox>&nbsp;<asp:Button ID="Button2" runat="server" CssClass="crmbutton small save" Text="确定选择" OnClick="Button1_Click" Style="width: 70px; height: 33px;" />
                                    <input name="button2" type="button" value="关闭窗口" class="crmbutton small create" onclick="closeWindow();" style="width: 70px; height: 33px;">
                                </td>
                                <td width="42%" align="right">&nbsp;<asp:Button ID="Button1" runat="server" CssClass="crmbutton small save" Text="更改为已采购" OnClick="Button1_Click1" Style="width: 100px; height: 33px;" /><asp:Button ID="Button3" runat="server" CssClass="crmbutton small create" Text="更改为未采购" OnClick="Button3_Click1" Style="width: 100px; height: 33px;" /></td>
                            </tr>
                        </table>
                        <!--底部功能栏-->
                    </td>
