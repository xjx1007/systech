        ...
        function btnGetProducts_onclick() {
            ...
            if (tempd != undefined) {
                ...
                if (v_SuppNo != "")
                {
                    ...
                    var response = Knet_Web_Procure_Knet_Procure_OrderList.KNetOddNumbers(v_SuppNo);
...
<body topmargin="0" leftmargin="0" rightmargin="0">
    <form id="form1" runat="server">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>采购订单 > <a class="hdrLink" href="Knet_Procure_OpenBilling_Manage.aspx">采购订单</a>
                </td>
