...
public partial class Knet_Common_SelectSuppliersPrice : BasePage
{
    ...
    public string GetNumber(string s_ProductsBarCode)
    {
        ...
        {
                string s_ContractNo1 = Request["Contract"].ToString();
                this.BeginQuery("Select Sum(ContractAmount+isnull(KSC_BNumber,0)-isnull(KSC_OrderBNumber,0)) From KNet_Sales_ContractList_Details Where ContractNo in ('" + s_ContractNo1.Replace(",", "','") + "') and ProductsBarCode='" + s_ProductsBarCode + "'");
