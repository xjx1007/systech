<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calendar.aspx.cs" Inherits="Web_Ktools_DefaultCalendar" %>
...
<table width="99%" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="150" background="../../images/ktxt1.gif" style="background-color:#F5F5F5; height:28px; width:130px;padding-left:20px;"><div class="TP2">万年历</div></td>
      ...
      <TABLE border=0 width="100%">
        <TR>
          ...
          &nbsp;
            ...
            &nbsp;
            <FONT id=GZ face=标楷体 color=#000000 style="FONT-SIZE:15px;"></FONT><BR>
          </TD>
        </TR>
