    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>
                物流 > <a class="hdrLink" href="Procure_ShipCheck_List.aspx">物流对账</a>
            </td>
            <td width="100%" nowrap>
                                            ...
                                            <tr>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <a href="javascript:;" onclick="PageGo('Procure_ShipCheck_Add.aspx')">
                                                        <img src="/themes/softed/images/btnL3Add.gif" alt="创建 运费对账单..." title="创建 运费对账单..."
                                                            border="0"></a>
                                                </td>
                                                ...
                                                <td style="padding-right: 10px">
                                                    <a href="javascript:;" onclick="ShowDiv();">
                                                        <img src="/themes/softed/images/btnL3Search.gif" alt="查找 运费对账单..." title="查找 运费对账单..."
                                                            border="0"></a>
                                                </td>
                                                <td style="padding-right: 0px; padding-left: 10px;">
                                                    <img src="/themes/softed/images/tbarImport.gif" alt="*导入 运费对账单" title="*导入 运费对账单"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                                                    <img src="/themes/softed/images/tbarExport.gif" alt="*导出 运费对账单" title="*导出 运费对账单"
                                                        border="0">
                                                </td>
                                                <td style="padding-right: 10px">
                            ...
                            <cc1:MyGridView ID="MyGridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="查看" HeaderStyle-Font-Size="12px" ItemStyle-Width="28px"
                                        ...
                                        <ItemTemplate>
                                            <a href="#" onclick="javascript:window.open('Procure_ShipCheck_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "COC_Code")%>&PrinterModel=128898695453437500','查看详细','top=120,left=150,menubar=no,scrollbars=yes, resizable=yes, location=no, status=no, width=700,height=450');">
