<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Wl_Customer_Price_List.aspx.cs" Inherits="Wl_Customer_Price_List" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            ...
            <tr>
                <td style="padding-left: 10px; padding-right: 50px" class="moduleName" nowrap>物流管理 > <a class="hdrLink" href="Wl_Customer_Price_List.aspx">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="5">
                                                <tr>
                                                    <td style="padding-right: 0px; padding-left: 10px;">
                                                        <a href="javascript:;" onclick="PageGo('Wl_Customer_Price_Add.aspx')">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <%=base.Base_BindView("Wl_Customer_Price", "Wl_Customer_Price_List.aspx", Request.QueryString["WhereID"] == null ? "" : Request.QueryString["WhereID"].ToString())%>
                </td>
            </tr>
            <tr>
                <td>
                                    ...
                                    <ContentTemplate>
                                        <cc1:MyGridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="Custom_DgMain" EmptyDataText="&lt;div style='border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 45%; position: relative; z-index: 10000000;'&gt; &lt;table border='0' cellpadding='5' cellspacing='0' width='98%'&gt;&lt;tr&gt; &lt;td rowspan='2' width='25%'&gt;&lt;img src='/themes/softed/images/empty.jpg' height='60' width='61'&gt;&lt;/td&gt; &lt;td style='border-bottom: 1px solid rgb(204, 204, 204);' nowrap='nowrap' width='75%'&gt;&lt;span class='genHeaderSmall'&gt;记录为空&lt;/span&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt; &lt;/div&gt;" IsShowEmptyTemplate="true" PageSize="10" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="编号" ItemStyle-HorizontalAlign="Left" SortExpression="WCP_Code">
                                                    <ItemTemplate>
                                                        <a href='Wl_Customer_Price_View.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "WCP_ID") %>'>
                                                            <%# DataBinder.Eval(Container.DataItem, "WCP_Code")%></a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="WCP_Stime" DataFormatString="{0:yyyy-MM-dd}" HeaderText="日期" HtmlEncode="false" SortExpression="WCP_Stime">
                                                ...
                                                <asp:TemplateField HeaderText="供应商" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left"
                                                    ...
                                                    <ItemTemplate>
                                                        <%#base.Base_GetSupplierName_Link(DataBinder.Eval(Container.DataItem, "WCP_SuppNo").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="物流供应商" HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%#base.Base_GetSupplierName_Link(DataBinder.Eval(Container.DataItem, "WCP_WuliuSuppNo").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="责任人" HeaderStyle-Font-Size="12px"  ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <%#base.Base_GetUserName(DataBinder.Eval(Container.DataItem, "WCP_DutyPerson").ToString())%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="center" HeaderText="修改">
                                                    <ItemTemplate>
                                                        <a href='Wl_Customer_Price_Add.aspx?ID=<%# DataBinder.Eval(Container.DataItem, "WCP_ID") %>'>
