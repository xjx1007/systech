...
<body topmargin="0" leftmargin="0" rightmargin="0">
    ...
    <form id="form2" runat="server">
       ...
       <asp:BoundField  DataField="WareHouseAmount"   HeaderText="库存"  SortExpression="WareHouseAmount" DataFormatString="{0:F0}" >
        ...
        <asp:BoundField  DataField="Init"   HeaderText="初始化"  SortExpression="Init" DataFormatString="{0:F0}" >
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  Width="60px" />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
       </asp:BoundField>
        ...
        <asp:BoundField  DataField="FlQuantity"   HeaderText="发料"  SortExpression="FlQuantity" DataFormatString="{0:F0}" >
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  Width="60px" />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
       </asp:BoundField>
        ...
        <asp:BoundField  DataField="ScQuantity"   HeaderText="生产领用"  SortExpression="ScQuantity" DataFormatString="{0:F0}" >
            <ItemStyle HorizontalAlign="Left"  Font-Size="12px"  Width="60px" />
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
       </asp:BoundField>
        ...
        <asp:BoundField  DataField="PdQuantity"   HeaderText="盘点数"  SortExpression="PdQuantity" DataFormatString="{0:F0}">
            ...
            <HeaderStyle HorizontalAlign="Left" Font-Size="12px"  />
                                                ...
                                                <asp:TemplateField HeaderText="库存均价" SortExpression="WareHouseTotalNet" HeaderStyle-Font-Size="12px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
