	...
	$.addGrid = function(t,p)
	{
		...
		if (p.usepager)
		{
			...
			if (p.useRp)
			{
			    ...
			    */
			    //可输入每页显示数量
			    $('.pDiv2',g.pDiv).prepend("<div class='pGroup'><span class='pcount'>每页 <input type='text' name='rp' value='"+p.rp+"' size=3> 条</span></div> <div class='btnseparator'></div>");
			    $('input',g.pDiv).bind("keydown blur",
			    		function ()
			    		{
			    			if (p.onRpChange) 
