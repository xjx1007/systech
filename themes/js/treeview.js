...
MzTreeView.prototype.initAll = function(nodes)
{
  for(var i=0;i<nodes.length;i++)
  {
     ...
     span.innerHTML="&nbsp;<a href=javascript:parent.send_sms('"+ user_id +"','"+ (nodes[i].text) +"') title='发短信' style='padding:0px;'><img src='web/images/msg.png'></a>";
     span.innerHTML+="<a href=javascript:parent.send_email('"+ user_id +"','"+ (nodes[i].text) +"') title='发邮件' style='padding:0px;'><img src='web/images/email.png'></a>";
