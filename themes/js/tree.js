...
function Tree(id, XmlSrc)
{
   ...
   this.Xml = {};
   this.icons = {
      'plus'         : 'Web/images/collapsed.gif',
      'minus': 'Web/images/expanded.gif',
      'transparent': 'Web/images/transparent.gif',
      'loading': 'Web/images/endnode.gif',
      'msg': 'Web/images/msg.png',
      'email': 'Web/images/email.png'
   };
