...
///  帮助中心 -----如何使用 
/// </summary>
public partial class Knet_Help_HowtoUserContactUs : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                KNet.BLL.AKNnet_coms BLL = new KNet.BLL.AKNnet_coms();
                KNet.Model.AKNnet_coms model = BLL.GetModel("C2DEDD32-E788-4D30-87ED-0EB2513842DA");

                this.Label1.Text = model.Coms;
