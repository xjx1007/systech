...
{
    /// <summary>
    /// 数据访问类Knet_Procure_OpenBillingPrinter_Setup。
    /// </summary>
    public class Knet_Procure_OpenBillingPrinter_Setup
    {
        ...
        public bool Exists(string PrinterTitle)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public void Add(KNet.Model.Knet_Procure_OpenBillingPrinter_Setup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_ADD", parameters, out rowsAffected);
        }

        /// <summary>
        ///  更新一条数据
        /// </summary>
        public void Update(KNet.Model.Knet_Procure_OpenBillingPrinter_Setup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_Update", parameters, out rowsAffected);
        }
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_Delete", parameters, out rowsAffected);
        }
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.Knet_Procure_OpenBillingPrinter_Setup GetModel(string ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.NVarChar,50)};
            parameters[0].Value = ID;

            KNet.Model.Knet_Procure_OpenBillingPrinter_Setup model = new KNet.Model.Knet_Procure_OpenBillingPrinter_Setup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_GetModelByID", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.Knet_Procure_OpenBillingPrinter_Setup GetModelB(string Tex_ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@Tex_ID", SqlDbType.NVarChar,50)};
            ...
            KNet.Model.Knet_Procure_OpenBillingPrinter_Setup model = new KNet.Model.Knet_Procure_OpenBillingPrinter_Setup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_Knet_Procure_OpenBillingPrinter_Setup_GetModelByNo", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.Tex_ID = ds.Tables[0].Rows[0]["Tex_ID"].ToString();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM Knet_Procure_OpenBillingPrinter_Setup ");
            if (strWhere.Trim() != "")
            {
