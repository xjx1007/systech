...
{
    /// <summary>
    /// 数据访问类KNet_Sales_OutWareList_Printersetup。
    /// </summary>
    public class KNet_Sales_OutWareList_Printersetup
    {
        public KNet_Sales_OutWareList_Printersetup()
        { }
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(string PrinterTitle)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public void Add(KNet.Model.KNet_Sales_OutWareList_Printersetup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_ADD", parameters, out rowsAffected);
        }

        /// <summary>
        ///  更新一条数据
        /// </summary>
        public void Update(KNet.Model.KNet_Sales_OutWareList_Printersetup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_Update", parameters, out rowsAffected);
        }
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_Delete", parameters, out rowsAffected);
        }

        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_Sales_OutWareList_Printersetup GetModel(string ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.NVarChar,50)};
            parameters[0].Value = ID;

            KNet.Model.KNet_Sales_OutWareList_Printersetup model = new KNet.Model.KNet_Sales_OutWareList_Printersetup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_GetModelByID", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_Sales_OutWareList_Printersetup GetModelB(string Tex_ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@Tex_ID", SqlDbType.NVarChar,50)};
            ...
            KNet.Model.KNet_Sales_OutWareList_Printersetup model = new KNet.Model.KNet_Sales_OutWareList_Printersetup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_Sales_OutWareList_Printersetup_GetModelByNo", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.Tex_ID = ds.Tables[0].Rows[0]["Tex_ID"].ToString();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_Sales_OutWareList_Printersetup ");
            if (strWhere.Trim() != "")
            {
