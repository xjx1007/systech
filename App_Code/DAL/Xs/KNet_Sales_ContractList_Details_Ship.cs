...
{
    /// <summary>
    /// 数据访问类KNet_Sales_ContractList_Details_Ship。
    /// </summary>
    public class KNet_Sales_ContractList_Details_Ship
    {
        ...
        public bool Exists(string ContractNo, string ProductsBarCode, string OwnallPID)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_Sales_ContractList_Details_Ship_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        public void Add(KNet.Model.KNet_Sales_ContractList_Details_Ship model)
        {
            ...
            strSql.Append("insert into KNet_Sales_ContractList_Details_Ship(");
            strSql.Append("ContractNo,ProductsName,ProductsBarCode,ProductsPattern,ProductsUnits,ContractAmount,ContractUnitPrice,ContractDiscount,ContractTotalNet,Contract_SalesUnitPrice,Contract_SalesDiscount,Contract_SalesTotalNet,ContractRemarks,OwnallPID,KSD_OrderNumber,KSD_MaterNumber,KSC_BNumber,KSC_OrderBNumber,KSD_IsFollow,KSD_PlanNumber,KSD_MaterPattern,ID)");
        ...
        public void Update(KNet.Model.KNet_Sales_ContractList_Details_Ship model)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update KNet_Sales_ContractList_Details_Ship set ");
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_Sales_ContractList_Details_Ship_Delete", parameters, out rowsAffected);
        }
        ...
        public bool DeleteByContractNo(string ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from KNet_Sales_ContractList_Details_Ship ");
        ...
        public KNet.Model.KNet_Sales_ContractList_Details_Ship GetModel(string ID)
        {
            ...
            KNet.Model.KNet_Sales_ContractList_Details_Ship model = new KNet.Model.KNet_Sales_ContractList_Details_Ship();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_Sales_ContractList_Details_Ship_GetModelByID", parameters, "ds");
        ...
        public KNet.Model.KNet_Sales_ContractList_Details_Ship GetModelB(string ContractNo, string ProductsBarCode, string OwnallPID)
        {
            ...
            KNet.Model.KNet_Sales_ContractList_Details_Ship model = new KNet.Model.KNet_Sales_ContractList_Details_Ship();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_Sales_ContractList_Details_Ship_GetModelByNo", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.OwnallPID = ds.Tables[0].Rows[0]["OwnallPID"].ToString();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *,(ContractAmount-ContractReceiving) as thisNowAmount,(Select isnull(Sum(WareHouseAmount),0) from Knet_Procure_WareHouseList_Details a join Knet_Procure_WareHouseList b on a.WareHouseNo=b.WareHouseNo join Knet_Procure_OrdersList c on c.OrderNo=b.OrderNo where c.ContractNo=KNet_Sales_ContractList_Details_Ship.ContractNo and a.ProductsBarCode=KNet_Sales_ContractList_Details_Ship.ProductsBarCode) as WareHouseAmount,KSC_OrderBNumber ");
            strSql.Append(" FROM KNet_Sales_ContractList_Details_Ship  ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetTotalListDetails(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_Sales_ContractList_Details_Ship  a ");
        ...
        public DataSet GetList1(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_Sales_ContractList_Details_Ship a join KNet_Sys_Products b on a.ProductsBarCode=b.ProductsBarCode left join KNet_Sys_Products c On c.ProductsBarCode=a.KSD_OrderNumber left join Pb_Basic_Code d on d.PBC_Code=a.KSD_MaterNumber and d.PBC_ID='134' left join v_Contract_OutWare_Details_Sum e on e.vs_ID=a.ID ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
