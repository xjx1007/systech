...
namespace KNet.DAL
{
    ...
    public class KNet_WareHouse_FuAllocateList
    {
        ...
        public bool Exists(string AllocateNo)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        public void Add(KNet.Model.KNet_WareHouse_FuAllocateList model)
        {
            ...
            strSql.Append("insert into KNet_WareHouse_FuAllocateList(");
            strSql.Append("AllocateNo,AllocateTopic,AllocateCause,AllocateDateTime,HouseNo,HouseNo_int,AllocateStaffBranch,AllocateStaffDepart,AllocateStaffNo,AllocateRemarks,AllocateCheckYN,KWA_OrderNo,KWA_Type,KWA_DBType,KWA_UploadUrl,KWA_UploadName,KSP_SID,KWA_IsEntity)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@KSP_SID", SqlDbType.NVarChar,100),
            ...
            parameters[16].Value = model.KSP_SID;
            parameters[17].Value = model.KWA_IsEntity;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update KNet_WareHouse_FuAllocateList set ");
        ...
        public void Delete(string AllocateNo)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Delete", parameters, out rowsAffected);
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 * from KNet_WareHouse_FuAllocateList ");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["KSP_SID"] != null && ds.Tables[0].Rows[0]["KSP_SID"].ToString() != "")
                {
                    model.KSP_SID = ds.Tables[0].Rows[0]["KSP_SID"].ToString();
                }
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_WareHouse_FuAllocateList ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetDetailsList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_WareHouse_FuAllocateList a join KNet_WareHouse_FuAllocateList_Details b on a.AllocateNo=b.AllocateNo  join dbo.KNet_Sys_WareHouse AS c ON c.HouseNo = a.HouseNo_int  join dbo.KNet_Sys_WareHouse AS d ON d.HouseNo = a.HouseNo join KNET_sys_Products e on e.ProductsBarCode=b.ProductsBarCode ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
