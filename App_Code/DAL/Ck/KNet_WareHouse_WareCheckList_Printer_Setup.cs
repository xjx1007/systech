...
namespace KNet.DAL
{
    ...
    public class KNet_WareHouse_WareCheckList_Printer_Setup
    {
        ...
        public bool Exists(string PrinterTitle)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        public void Add(KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup model)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_ADD", parameters, out rowsAffected);
        }
        ...
        public void Update(KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup model)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_Update", parameters, out rowsAffected);
        }
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_Delete", parameters, out rowsAffected);
        }
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup GetModel(string ID)
        {
            ...
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_GetModelByID", parameters, "ds");
        ...
        public KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup GetModelB(string Tex_ID)
        {
            ...
            KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup model = new KNet.Model.KNet_WareHouse_WareCheckList_Printer_Setup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_WareCheckList_Printer_Setup_GetModelByNo", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.Tex_ID = ds.Tables[0].Rows[0]["Tex_ID"].ToString();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_WareHouse_WareCheckList_Printer_Setup ");
            if (strWhere.Trim() != "")
            {
