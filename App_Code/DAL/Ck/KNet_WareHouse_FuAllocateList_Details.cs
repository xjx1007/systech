...
namespace KNet.DAL
{
    ...
    public class KNet_WareHouse_FuAllocateList_Details
    {
        ...
        public bool Exists(string AllocateNo, string ProductsBarCode, string OwnallPID)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Details_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public void Add(KNet.Model.KNet_WareHouse_FuAllocateList_Details model)
        {
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@KWAD_BFNumber", SqlDbType.Int,4),
                     new SqlParameter("@KWAD_BLNumber", SqlDbType.Int,4)
        ...
        ///  更新一条数据 如果存在记录时更新数据
        /// </summary>
        public void Update(KNet.Model.KNet_WareHouse_FuAllocateList_Details model)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("update KNet_WareHouse_FuAllocateList_Details set ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool UpdateWwPrice(KNet.Model.KNet_WareHouse_FuAllocateList_Details model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update KNet_WareHouse_FuAllocateList_Details set ");
        ...
        ///  更新一条数据 如果存在记录时更新数据
        /// </summary>
        public void UpdateB(KNet.Model.KNet_WareHouse_FuAllocateList_Details model)
        {
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Details_Delete", parameters, out rowsAffected);
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from KNet_WareHouse_FuAllocateList_Details ");
            strSql.Append(" where AllocateNo=@AllocateNo ");
            SqlParameter[] parameters = {
                    new SqlParameter("@AllocateNo", SqlDbType.NVarChar,50)};
            parameters[0].Value = AllocateNo;
        ...
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_WareHouse_FuAllocateList_Details GetModel(string ID)
        {
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.NVarChar,50)};
            parameters[0].Value = ID;

            KNet.Model.KNet_WareHouse_FuAllocateList_Details model = new KNet.Model.KNet_WareHouse_FuAllocateList_Details();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Details_GetModelByID", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_WareHouse_FuAllocateList_Details GetModelB(string AllocateNo, string ProductsBarCode, string OwnallPID)
        {
            SqlParameter[] parameters = {
                    new SqlParameter("@AllocateNo", SqlDbType.NVarChar,50),
                    new SqlParameter("@ProductsBarCode", SqlDbType.NVarChar,50),
            ...
            KNet.Model.KNet_WareHouse_FuAllocateList_Details model = new KNet.Model.KNet_WareHouse_FuAllocateList_Details();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_FuAllocateList_Details_GetModel", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.AllocateNo = ds.Tables[0].Rows[0]["AllocateNo"].ToString();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_WareHouse_FuAllocateList_Details  a  join KNet_WareHouse_FuAllocateList b on a.AllocateNo=b.AllocateNo ");
