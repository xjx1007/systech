...
{
    /// <summary>
    /// 数据访问类KNet_WareHouse_DirectOutList_Printer_Setup。
    /// </summary>
    public class KNet_WareHouse_DirectOutList_Printer_Setup
    {
        public KNet_WareHouse_DirectOutList_Printer_Setup()
        { }
        #region  成员方法
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(string PrinterTitle)
        {
            ...
            int result = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        ///  增加一条数据
        /// </summary>
        public void Add(KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_ADD", parameters, out rowsAffected);
        }

        /// <summary>
        ///  更新一条数据
        /// </summary>
        public void Update(KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup model)
        {
            int rowsAffected;
            SqlParameter[] parameters = {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_Update", parameters, out rowsAffected);
        }
        ...
        public void Delete(string ID)
        {
            ...
            DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_Delete", parameters, out rowsAffected);
        }
        /// <summary>
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup GetModel(string ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.NVarChar,50)};
            parameters[0].Value = ID;

            KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup model = new KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_GetModelByID", parameters, "ds");
        ...
        /// 得到一个对象实体
        /// </summary>
        public KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup GetModelB(string Tex_ID)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@Tex_ID", SqlDbType.NVarChar,50)};
            ...
            KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup model = new KNet.Model.KNet_WareHouse_DirectOutList_Printer_Setup();
            DataSet ds = DbHelperSQL.RunProcedure("Proc_KNet_WareHouse_DirectOutList_Printer_Setup_GetModelByNo", parameters, "ds");
            if (ds.Tables[0].Rows.Count > 0)
            {
                model.ID = ds.Tables[0].Rows[0]["ID"].ToString();
                model.Tex_ID = ds.Tables[0].Rows[0]["Tex_ID"].ToString();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KNet_WareHouse_DirectOutList_Printer_Setup ");
            if (strWhere.Trim() != "")
            {
