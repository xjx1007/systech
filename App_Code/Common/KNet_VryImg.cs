...
namespace KNet.Common
{
    ...
    /// <summary>
    /// </summary>
    public class KNet_VryImg
        {
           // public static string ChineseChars = String.Empty;
              public static string ChineseChars = "KNetWkcn";
              public static string ChineseCode = "KNet8626";

            /// <summary>
            /// 英文与数字串
            /// </summary>
            protected static readonly string EnglishOrNumChars = "3456789abcdefghkmnpqrstuvwxyzABCDEFGHKMNPQRSTUVWXYZ";
            ...
            public Bitmap CreateImage(string code)
            {
                ...
                //画一个边框 边框颜色为Color.Gainsboro,DarkGray
