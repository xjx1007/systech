...
{
    /// <summary>
    /// 业务逻辑类Knet_Procure_ReturnList_Printer_Setup 
    /// </summary>
    public class Knet_Procure_ReturnList_Printer_Setup
    {
        private readonly KNet.DAL.Knet_Procure_ReturnList_Printer_Setup dal = new KNet.DAL.Knet_Procure_ReturnList_Printer_Setup();
